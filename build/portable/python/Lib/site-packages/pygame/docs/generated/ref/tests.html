...
<html lang="en" data-content_root="../">
  <head>
    ...
    <title>pygame.tests &#8212; pygame-ce v2.5.8 documentation</title>
    ...
    <link rel="prev" title="pygame.system" href="system.html" /> 
  </head><body>  
...
useful if the test is interactive.</p>
...
<code class="docutils literal notranslate"><span class="pre">controller_test.py</span></code> has a tag variable containing a tags list that
has the 'interactive' string. The 'interactive' tag indicates <code class="docutils literal notranslate"><span class="pre">controller_test.py</span></code>
...
<span class="n">exclude</span> <span class="o">-</span> <span class="n">A</span> <span class="nb">list</span> <span class="n">of</span> <span class="n">TAG</span> <span class="n">names</span> <span class="n">to</span> <span class="n">exclude</span> <span class="kn">from</span><span class="w"> </span><span class="nn">the</span> <span class="n">run</span>
