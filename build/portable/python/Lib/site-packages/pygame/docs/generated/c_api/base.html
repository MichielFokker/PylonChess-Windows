...
<html lang="en" data-content_root="../">
  <head>
    ...
    <title>High level API exported by pygame.base &#8212; pygame-ce v2.5.8 documentation</title>
...
<dd><p>You probably want to use the <a class="reference internal" href="color.html#c.pg_RGBAFromObjEx" title="pg_RGBAFromObjEx"><code class="xref c c-func docutils literal notranslate"><span class="pre">pg_RGBAFromObjEx()</span></code></a> function instead of this.</p>
<p>Convert the color represented by object <em>obj</em> into a red, green, blue, alpha
...
<dl class="c function">
<dt class="sig sig-object c" id="c.pgObject_getRectHelper">
<span class="n"><span class="pre">PyObject</span></span><span class="w"> </span><span class="p"><span class="pre">*</span></span><span class="sig-name descname"><span class="n"><span class="pre">pgObject_getRectHelper</span></span></span><span class="sig-paren">(</span><span class="n"><span class="pre">PyObject</span></span><span class="w"> </span><span class="p"><span class="pre">*</span></span><span class="n"><span class="pre">rect</span></span>, <span class="n"><span class="pre">PyObject</span></span><span class="w"> </span><span class="p"><span class="pre">*</span></span><span class="k"><span class="pre">const</span></span><span class="w"> </span><span class="p"><span class="pre">*</span></span><span class="n"><span class="pre">args</span></span>, <span class="n"><span class="pre">Py_ssize_t</span></span><span class="w"> </span><span class="n"><span class="pre">nargs</span></span>, <span class="n"><span class="pre">PyObject</span></span><span class="w"> </span><span class="p"><span class="pre">*</span></span><span class="n"><span class="pre">kwnames</span></span>, <span class="kt"><span class="pre">char</span></span><span class="w"> </span><span class="p"><span class="pre">*</span></span><span class="n"><span class="pre">type</span></span><span class="sig-paren">)</span><a class="headerlink" href="#c.pgObject_getRectHelper" title="Link to this definition">¶</a><br /></dt>
<dd><p>Return a rectangle covering the entire object. Rectangle will start at (0, 0)
with a width and height the same size as the object. You can pass keyword
arguments to be applied to the attributes of the rect before it is returned.</p>
</dd></dl>
