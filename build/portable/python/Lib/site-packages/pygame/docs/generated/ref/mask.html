...
<html lang="en" data-content_root="../">
  <head>
    ...
    <title>pygame.mask &#8212; pygame-ce v2.5.8 documentation</title>
...
<dd class="field-odd"><ul class="simple">
<li><p><strong>surface</strong> (<a class="reference internal" href="surface.html#pygame.Surface" title="pygame.Surface"><em>Surface</em></a>) -- the surface to create the mask from</p></li>
<li><p><strong>color</strong> (<a class="reference internal" href="typing.html#pygame.typing.ColorLike" title="pygame.typing.ColorLike"><code class="xref py py-data docutils literal notranslate"><span class="pre">pygame.typing.ColorLike</span></code></a>) -- color used to check if the surface's pixels are within the
...
<li><p><strong>threshold</strong> (<a class="reference internal" href="typing.html#pygame.typing.ColorLike" title="pygame.typing.ColorLike"><code class="xref py py-data docutils literal notranslate"><span class="pre">pygame.typing.ColorLike</span></code></a>) -- (optional) the threshold range used to check the difference
...
<div class="line"><span class="signature">Mask(size, fill=False) -&gt; Mask</span></div>
</div>
<table class="toc docutils align-default">
<tbody>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="k">class</span><span class="w"> </span><span class="nc">SubMask</span><span class="p">(</span><span class="n">pygame</span><span class="o">.</span><span class="n">mask</span><span class="o">.</span><span class="n">Mask</span><span class="p">):</span>
...
<p>Returns a new <a class="tooltip reference internal" href="rect.html#pygame.Rect" title=""><code class="xref py py-class docutils literal notranslate"><span class="pre">pygame.Rect</span></code><span class="tooltip-content">pygame object for storing rectangular coordinates</span></a> object based on the size of this mask.
...
altered via <a class="tooltip reference internal" href="rect.html#pygame.Rect" title=""><code class="xref py py-class docutils literal notranslate"><span class="pre">pygame.Rect</span></code><span class="tooltip-content">pygame object for storing rectangular coordinates</span></a> attribute keyword arguments/values passed
...
create a <a class="tooltip reference internal" href="rect.html#pygame.Rect" title=""><code class="xref py py-class docutils literal notranslate"><span class="pre">pygame.Rect</span></code><span class="tooltip-content">pygame object for storing rectangular coordinates</span></a> based on the mask's size centered at the
given position.</p>
<dl class="field-list simple">
<dt class="field-odd">Parameters<span class="colon">:</span></dt>
<dd class="field-odd"><p><strong>kwargs</strong> (<em>dict</em>) -- <a class="tooltip reference internal" href="rect.html#pygame.Rect" title=""><code class="xref py py-class docutils literal notranslate"><span class="pre">pygame.Rect</span></code><span class="tooltip-content">pygame object for storing rectangular coordinates</span></a> attribute keyword arguments/values
that will be applied to the rect</p>
</dd>
<dt class="field-even">Returns<span class="colon">:</span></dt>
<dd class="field-even"><p>A new <a class="tooltip reference internal" href="rect.html#pygame.Rect" title=""><code class="xref py py-class docutils literal notranslate"><span class="pre">pygame.Rect</span></code><span class="tooltip-content">pygame object for storing rectangular coordinates</span></a> object based on the size of this mask
with any <a class="tooltip reference internal" href="rect.html#pygame.Rect" title=""><code class="xref py py-class docutils literal notranslate"><span class="pre">pygame.Rect</span></code><span class="tooltip-content">pygame object for storing rectangular coordinates</span></a> attribute keyword arguments/values applied
to it</p>
</dd>
<dt class="field-odd">Return type<span class="colon">:</span></dt>
...
<div class="line"><span class="signature">overlap(other, offset) -&gt; tuple[int, int] | None</span></div>
</div>
...
<div class="line"><span class="signature">overlap_area(other, offset) -&gt; int</span></div>
</div>
<p>Returns the number of overlapping set bits between this mask and
...
<div class="line"><span class="signature">scale(scale) -&gt; Mask</span></div>
</div>
...
<dl class="field-list simple">
<dt class="field-odd">Parameters<span class="colon">:</span></dt>
<dd class="field-odd"><p><strong>scale</strong> -- the width and height (size) of the mask to create</p>
</dd>
<dt class="field-even">Returns<span class="colon">:</span></dt>
...
<p>Performs a bitwise OR, drawing <code class="docutils literal notranslate"><span class="pre">other</span></code> onto this mask.</p>
<dl class="field-list simple">
<dt class="field-odd">Parameters<span class="colon">:</span></dt>
<dd class="field-odd"><ul class="simple">
...
<div class="line"><span class="signature">count() -&gt; int</span></div>
</div>
<dl class="field-list simple">
<dt class="field-odd">Returns<span class="colon">:</span></dt>
...
<div class="line"><span class="signature">centroid() -&gt; tuple[int, int]</span></div>
</div>
...
<div class="line"><span class="signature">outline(every=1) -&gt; list[tuple[int, int]]</span></div>
</div>
...
<div class="line"><span class="signature">connected_components(minimum=0) -&gt; list[Mask]</span></div>
</div>
...
<div class="line"><span class="signature">get_bounding_rects() -&gt; list[Rect]</span></div>
</div>
...
<div class="line"><span class="signature">to_surface(surface=None, setsurface=None, unsetsurface=None, setcolor=(255, 255, 255, 255), unsetcolor=(0, 0, 0, 255), dest=(0, 0), area=None) -&gt; Surface</span></div>
</div>
...
<li><p><strong>setcolor</strong> (<a class="reference internal" href="typing.html#pygame.typing.ColorLike" title="pygame.typing.ColorLike"><code class="xref py py-data docutils literal notranslate"><span class="pre">pygame.typing.ColorLike</span></code></a> or <code class="docutils literal notranslate"><span class="pre">None</span></code>) -- (optional) color to draw set bits (default is
...
this parameter</p></li>
<li><p><strong>unsetcolor</strong> (<a class="reference internal" href="typing.html#pygame.typing.ColorLike" title="pygame.typing.ColorLike"><code class="xref py py-data docutils literal notranslate"><span class="pre">pygame.typing.ColorLike</span></code></a> or <code class="docutils literal notranslate"><span class="pre">None</span></code>) -- (optional) color to draw unset bits (default is
...
<li><p><strong>area</strong> (<a class="reference internal" href="rect.html#pygame.Rect" title="pygame.Rect"><em>Rect</em></a><em> or </em><em>rect-like object</em>) -- (optional) rectangular portion of the mask to draw. It can be a
...
by <a class="reference internal" href="#pygame.mask.Mask.get_rect" title="pygame.mask.Mask.get_rect"><code class="xref py py-meth docutils literal notranslate"><span class="pre">get_rect()</span></code></a>), it will get clipped to fit those boundaries. If the final rect
is smaller than the mask and no destination <code class="docutils literal notranslate"><span class="pre">surface</span></code> is given, the returned surface
will have the same size as this final rect.</p></li>
</ul>
</dd>
<dt class="field-even">Returns<span class="colon">:</span></dt>
...
<p><span class="versionmodified changed">Changed in pygame-ce 2.5.6: </span>Added the area keyword argument.</p>
</div>
</dd></dl>
