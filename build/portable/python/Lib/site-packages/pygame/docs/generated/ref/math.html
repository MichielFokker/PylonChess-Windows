...
<html lang="en" data-content_root="../">
  <head>
    ...
    <title>pygame.math &#8212; pygame-ce v2.5.8 documentation</title>
...
<td>—</td>
<td>Returns value linearly interpolated between a and b.</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="math.html#pygame.math.invlerp">pygame.math.invlerp</a></div>
</td>
<td>—</td>
<td>Returns value inverse interpolated between a and b.</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="math.html#pygame.math.smoothstep">pygame.math.smoothstep</a></div>
</td>
<td>—</td>
<td>Returns value smoothly interpolated between a and b.</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="math.html#pygame.math.remap">pygame.math.remap</a></div>
</td>
<td>—</td>
<td>Remaps value from given input range to given output range.</td>
</tr>
...
<p>Multiple coordinates can be set and retrieved using slices or swizzling.</p>
...
<span class="nb">print</span><span class="p">(</span><span class="n">v</span><span class="p">)</span>  <span class="c1"># Vector2(1, 2)</span>
<span class="nb">print</span><span class="p">(</span><span class="n">v</span><span class="o">.</span><span class="n">x</span><span class="p">)</span>  <span class="c1"># 1.0</span>
<span class="nb">print</span><span class="p">(</span><span class="n">v</span><span class="o">.</span><span class="n">y</span><span class="p">)</span>  <span class="c1"># 2.0</span>
<span class="nb">print</span><span class="p">(</span><span class="n">v</span><span class="o">.</span><span class="n">xy</span><span class="p">)</span>  <span class="c1"># Vector2(1, 2)</span>
<span class="nb">print</span><span class="p">(</span><span class="n">v</span><span class="o">.</span><span class="n">yx</span><span class="p">)</span>  <span class="c1"># Vector2(2, 1)</span>
<span class="nb">print</span><span class="p">(</span><span class="n">v</span><span class="o">.</span><span class="n">xyyx</span><span class="p">)</span>  <span class="c1"># (1.0, 2.0, 2.0, 1.0)</span>
</pre></div>
</div>
<p>Note above, that swizzling with 2 components will return a Vector2 instance,
...
iterator protocol, they can be unpacked, or converted to lists or tuples.</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">v</span> <span class="o">=</span> <span class="n">Vector2</span><span class="p">(</span><span class="mi">1</span><span class="p">,</span> <span class="mi">2</span><span class="p">)</span>
<span class="nb">print</span><span class="p">(</span><span class="o">*</span><span class="n">v</span><span class="p">)</span>  <span class="c1"># 1.0 2.0</span>
<span class="nb">print</span><span class="p">(</span><span class="nb">tuple</span><span class="p">(</span><span class="n">v</span><span class="p">))</span>  <span class="c1"># (1.0, 2.0)</span>
<span class="nb">print</span><span class="p">(</span><span class="nb">tuple</span><span class="p">(</span><span class="n">v</span><span class="o">.</span><span class="n">yx</span><span class="p">))</span>  <span class="c1"># (2.0, 1.0)</span>
</pre></div>
</div>
<p>A vector can be converted to other data types using the built-in constructors</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">v</span> <span class="o">=</span> <span class="n">pygame</span><span class="o">.</span><span class="n">Vector2</span><span class="p">(</span><span class="mi">1</span><span class="p">,</span> <span class="mi">2</span><span class="p">)</span>

<span class="nb">list</span><span class="p">(</span><span class="n">v</span><span class="p">)</span> <span class="o">==</span> <span class="p">[</span><span class="mf">1.0</span><span class="p">,</span> <span class="mf">2.0</span><span class="p">]</span>
<span class="nb">tuple</span><span class="p">(</span><span class="n">v</span><span class="p">)</span> <span class="o">==</span> <span class="p">(</span><span class="mf">1.0</span><span class="p">,</span> <span class="mf">2.0</span><span class="p">)</span>
<span class="nb">set</span><span class="p">(</span><span class="n">v</span><span class="p">)</span> <span class="o">==</span> <span class="p">{</span><span class="mf">1.0</span><span class="p">,</span> <span class="mf">2.0</span><span class="p">}</span>
</pre></div>
</div>
<p>Conversion can be combined with swizzling or slicing to create a new order</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">v</span> <span class="o">=</span> <span class="n">pygame</span><span class="o">.</span><span class="n">Vector3</span><span class="p">(</span><span class="mi">1</span><span class="p">,</span> <span class="mi">2</span><span class="p">,</span> <span class="mi">3</span><span class="p">)</span>

<span class="nb">list</span><span class="p">(</span><span class="n">v</span><span class="o">.</span><span class="n">xz</span><span class="p">)</span> <span class="o">==</span> <span class="p">[</span><span class="mf">1.0</span><span class="p">,</span> <span class="mf">3.0</span><span class="p">]</span>
<span class="nb">list</span><span class="p">(</span><span class="n">v</span><span class="o">.</span><span class="n">zyx</span><span class="p">)</span> <span class="o">==</span> <span class="p">[</span><span class="mf">3.0</span><span class="p">,</span> <span class="mf">2.0</span><span class="p">,</span> <span class="mf">1.0</span><span class="p">]</span>
<span class="nb">list</span><span class="p">(</span><span class="n">v</span><span class="o">.</span><span class="n">yyy</span><span class="p">)</span> <span class="o">==</span> <span class="p">[</span><span class="mf">2.0</span><span class="p">,</span> <span class="mf">2.0</span><span class="p">,</span> <span class="mf">2.0</span><span class="p">]</span>
<span class="nb">tuple</span><span class="p">(</span><span class="n">v</span><span class="o">.</span><span class="n">xyyzzz</span><span class="p">)</span> <span class="o">==</span> <span class="p">(</span><span class="mf">1.0</span><span class="p">,</span> <span class="mf">2.0</span><span class="p">,</span> <span class="mf">2.0</span><span class="p">,</span> <span class="mf">3.0</span><span class="p">,</span> <span class="mf">3.0</span><span class="p">,</span> <span class="mf">3.0</span><span class="p">)</span>
<span class="nb">tuple</span><span class="p">(</span><span class="n">v</span><span class="o">.</span><span class="n">zxyxzzyx</span><span class="p">)</span> <span class="o">==</span> <span class="p">(</span><span class="mf">3.0</span><span class="p">,</span> <span class="mf">1.0</span><span class="p">,</span> <span class="mf">2.0</span><span class="p">,</span> <span class="mf">1.0</span><span class="p">,</span> <span class="mf">3.0</span><span class="p">,</span> <span class="mf">3.0</span><span class="p">,</span> <span class="mf">2.0</span><span class="p">,</span> <span class="mf">1.0</span><span class="p">)</span>
<span class="nb">set</span><span class="p">(</span><span class="n">v</span><span class="o">.</span><span class="n">yxzxzyzxyx</span><span class="p">)</span> <span class="o">==</span> <span class="p">{</span><span class="mf">1.0</span><span class="p">,</span> <span class="mf">2.0</span><span class="p">,</span> <span class="mf">3.0</span><span class="p">}</span> <span class="c1"># sets remove duplicates</span>

<span class="nb">list</span><span class="p">(</span><span class="n">v</span><span class="p">[:])</span> <span class="o">==</span> <span class="p">[</span><span class="mf">1.0</span><span class="p">,</span> <span class="mf">2.0</span><span class="p">,</span> <span class="mf">3.0</span><span class="p">]</span>
<span class="nb">tuple</span><span class="p">(</span><span class="n">v</span><span class="p">[::</span><span class="o">-</span><span class="mi">1</span><span class="p">])</span> <span class="o">==</span> <span class="p">(</span><span class="mf">3.0</span><span class="p">,</span> <span class="mf">2.0</span><span class="p">,</span> <span class="mf">1.0</span><span class="p">)</span>
<span class="nb">set</span><span class="p">(</span><span class="n">v</span><span class="p">[</span><span class="mi">1</span><span class="p">:</span><span class="mi">3</span><span class="p">])</span> <span class="o">==</span> <span class="p">{</span><span class="mf">2.0</span><span class="p">,</span> <span class="mf">3.0</span><span class="p">}</span>
</pre></div>
</div>
...
<p><span class="versionmodified changed">Changed in pygame-ce 2.1.4: </span><cite>round</cite> returns a new vector with components rounded to the specified digits.</p>
</div>
...
<p><span class="versionmodified added">New in pygame-ce 2.1.3.</span></p>
</div>
</dd></dl>
...
<dd><div class="line-block">
<div class="line"><span class="summaryline">Returns value linearly interpolated between a and b.</span></div>
<div class="line"><span class="signature">lerp(a, b, value, do_clamp=True, /) -&gt; float</span></div>
</div>
<p>Returns a number which is a linear interpolation between <code class="docutils literal notranslate"><span class="pre">a</span></code>
and <code class="docutils literal notranslate"><span class="pre">b</span></code>. The third parameter determines how far between <code class="docutils literal notranslate"><span class="pre">a</span></code> and
<code class="docutils literal notranslate"><span class="pre">b</span></code> the result is going to be.
If <code class="docutils literal notranslate"><span class="pre">do_clamp</span></code> is false, <code class="docutils literal notranslate"><span class="pre">value</span></code> is not clamped to <code class="docutils literal notranslate"><span class="pre">[0,</span> <span class="pre">1]</span></code>,
allowing extrapolation outside the range <code class="docutils literal notranslate"><span class="pre">[a,</span> <span class="pre">b]</span></code>.</p>
<p>The formula is:</p>
<p><code class="docutils literal notranslate"><span class="pre">a</span> <span class="pre">+</span> <span class="pre">(b</span> <span class="pre">-</span> <span class="pre">a)</span> <span class="pre">*</span> <span class="pre">value</span></code>.</p>
<div class="versionadded">
...
<dl class="py function definition">
<dt class="sig sig-object py title" id="pygame.math.invlerp">
<span class="sig-prename descclassname"><span class="pre">pygame.math.</span></span><span class="sig-name descname"><span class="pre">invlerp</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#pygame.math.invlerp" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">Returns value inverse interpolated between a and b.</span></div>
<div class="line"><span class="signature">invlerp(a, b, value, /) -&gt; float</span></div>
</div>
<p>Returns a number which is an inverse interpolation between <code class="docutils literal notranslate"><span class="pre">a</span></code>
and <code class="docutils literal notranslate"><span class="pre">b</span></code>. The third parameter <code class="docutils literal notranslate"><span class="pre">value</span></code> is the result of the linear interpolation
between a and b with a certain coefficient. In other words, this coefficient
will be the result of this function.
If <code class="docutils literal notranslate"><span class="pre">b</span></code> and <code class="docutils literal notranslate"><span class="pre">a</span></code> are equal, it raises a <code class="docutils literal notranslate"><span class="pre">ValueError</span></code>.</p>
<p>The formula is:</p>
<p><code class="docutils literal notranslate"><span class="pre">(v</span> <span class="pre">-</span> <span class="pre">a)/(b</span> <span class="pre">-</span> <span class="pre">a)</span></code>.</p>
<p>This is an example explaining what is above :</p>
...
<span class="gp">&gt;&gt;&gt; </span><span class="n">pygame</span><span class="o">.</span><span class="n">math</span><span class="o">.</span><span class="n">invlerp</span><span class="p">(</span><span class="mi">10</span><span class="p">,</span> <span class="mi">20</span><span class="p">,</span> <span class="mf">11.5</span><span class="p">)</span>
<span class="go">0.15</span>
<span class="gp">&gt;&gt;&gt; </span><span class="n">pygame</span><span class="o">.</span><span class="n">math</span><span class="o">.</span><span class="n">lerp</span><span class="p">(</span><span class="mi">10</span><span class="p">,</span> <span class="mi">20</span><span class="p">,</span> <span class="mf">0.15</span><span class="p">)</span>
...
<dl class="py function definition">
<dt class="sig sig-object py title" id="pygame.math.smoothstep">
<span class="sig-prename descclassname"><span class="pre">pygame.math.</span></span><span class="sig-name descname"><span class="pre">smoothstep</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#pygame.math.smoothstep" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">Returns value smoothly interpolated between a and b.</span></div>
<div class="line"><span class="signature">smoothstep(a, b, value, /) -&gt; float</span></div>
</div>
<p>Returns a number which is a smooth interpolation between <code class="docutils literal notranslate"><span class="pre">a</span></code>
and <code class="docutils literal notranslate"><span class="pre">b</span></code>. This means that the interpolation follows an s-shaped curve, with
change happening more slowly near the limits (0.0 and 1.0) and faster in the middle.
The third parameter determines how far between <code class="docutils literal notranslate"><span class="pre">a</span></code> and
<code class="docutils literal notranslate"><span class="pre">b</span></code> the result is going to be. Value is clamped to <code class="docutils literal notranslate"><span class="pre">[0,</span> <span class="pre">1]</span></code>.</p>
<p>The formula is:</p>
<p><code class="docutils literal notranslate"><span class="pre">a</span> <span class="pre">*</span> <span class="pre">(1</span> <span class="pre">-</span> <span class="pre">interp)</span> <span class="pre">+</span> <span class="pre">b</span> <span class="pre">*</span> <span class="pre">interp</span></code></p>
<p>where:</p>
<p><code class="docutils literal notranslate"><span class="pre">interp</span> <span class="pre">=</span> <span class="pre">value</span> <span class="pre">*</span> <span class="pre">value</span> <span class="pre">*</span> <span class="pre">(3</span> <span class="pre">-</span> <span class="pre">2</span> <span class="pre">*</span> <span class="pre">value)</span></code></p>
<div class="versionadded">
<p><span class="versionmodified added">New in pygame-ce 2.4.0.</span></p>
</div>
</dd></dl>
...
<dl class="py function definition">
<dt class="sig sig-object py title" id="pygame.math.remap">
<span class="sig-prename descclassname"><span class="pre">pygame.math.</span></span><span class="sig-name descname"><span class="pre">remap</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#pygame.math.remap" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">Remaps value from given input range to given output range.</span></div>
<div class="line"><span class="signature">remap(i_min, i_max, o_min, o_max, value, /) -&gt; float</span></div>
</div>
<p>Returns a number which is the value remapped from <code class="docutils literal notranslate"><span class="pre">[i_min,</span> <span class="pre">i_max]</span></code> range to
<code class="docutils literal notranslate"><span class="pre">[o_min,</span> <span class="pre">o_max]</span></code> range.
If <code class="docutils literal notranslate"><span class="pre">i_min</span></code> and <code class="docutils literal notranslate"><span class="pre">i_max</span></code> are equal, it raises a <code class="docutils literal notranslate"><span class="pre">ValueError</span></code>.</p>
<p>Example:</p>
<div class="highlight-python notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">value</span> <span class="o">=</span> <span class="mi">50</span>
<span class="gp">&gt;&gt;&gt; </span><span class="n">pygame</span><span class="o">.</span><span class="n">math</span><span class="o">.</span><span class="n">remap</span><span class="p">(</span><span class="mi">0</span><span class="p">,</span> <span class="mi">100</span><span class="p">,</span> <span class="mi">0</span><span class="p">,</span> <span class="mi">200</span><span class="p">,</span> <span class="n">value</span><span class="p">)</span>
...
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="math.html#pygame.math.Vector2.smoothstep">pygame.math.Vector2.smoothstep</a></div>
</td>
<td>—</td>
<td>returns a smooth interpolation to the given vector.</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="math.html#pygame.math.Vector2.elementwise">pygame.math.Vector2.elementwise</a></div>
</td>
<td>—</td>
<td>The next operation will be performed elementwise.</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="math.html#pygame.math.Vector2.rotate">pygame.math.Vector2.rotate</a></div>
</td>
<td>—</td>
<td>rotates a vector by a given angle in degrees.</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="math.html#pygame.math.Vector2.rotate_rad">pygame.math.Vector2.rotate_rad</a></div>
</td>
<td>—</td>
<td>rotates a vector by a given angle in radians.</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="math.html#pygame.math.Vector2.rotate_ip">pygame.math.Vector2.rotate_ip</a></div>
</td>
<td>—</td>
<td>rotates the vector by a given angle in degrees in place.</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="math.html#pygame.math.Vector2.rotate_ip_rad">pygame.math.Vector2.rotate_ip_rad</a></div>
</td>
<td>—</td>
<td>rotates the vector by a given angle in radians in place.</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="math.html#pygame.math.Vector2.rotate_rad_ip">pygame.math.Vector2.rotate_rad_ip</a></div>
</td>
<td>—</td>
<td>rotates the vector by a given angle in radians in place.</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="math.html#pygame.math.Vector2.angle_to">pygame.math.Vector2.angle_to</a></div>
</td>
<td>—</td>
<td>calculates the angle to a given vector in degrees.</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="math.html#pygame.math.Vector2.as_polar">pygame.math.Vector2.as_polar</a></div>
</td>
<td>—</td>
<td>returns a tuple with radial distance and azimuthal angle.</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="math.html#pygame.math.Vector2.from_polar">pygame.math.Vector2.from_polar</a></div>
</td>
<td>—</td>
<td>Sets x and y from a polar coordinates tuple.</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="math.html#pygame.math.Vector2.project">pygame.math.Vector2.project</a></div>
</td>
<td>—</td>
<td>projects a vector onto another.</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="math.html#pygame.math.Vector2.copy">pygame.math.Vector2.copy</a></div>
</td>
<td>—</td>
<td>Returns a copy of itself.</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="math.html#pygame.math.Vector2.clamp_magnitude">pygame.math.Vector2.clamp_magnitude</a></div>
</td>
<td>—</td>
<td>Returns a copy of a vector with the magnitude clamped between max_length and min_length.</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="math.html#pygame.math.Vector2.clamp_magnitude_ip">pygame.math.Vector2.clamp_magnitude_ip</a></div>
</td>
<td>—</td>
<td>Clamps the vector's magnitude between max_length and min_length</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="math.html#pygame.math.Vector2.update">pygame.math.Vector2.update</a></div>
</td>
<td>—</td>
<td>Sets the coordinates of the vector.</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="math.html#pygame.math.Vector2.epsilon">pygame.math.Vector2.epsilon</a></div>
</td>
<td>—</td>
<td>Determines the tolerance of vector calculations.</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="math.html#pygame.math.Vector2.angle">pygame.math.Vector2.angle</a></div>
</td>
<td>—</td>
<td>Gives the angle of the vector in degrees, relative to the X-axis, normalized to the interval [-180, 180].</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="math.html#pygame.math.Vector2.angle_rad">pygame.math.Vector2.angle_rad</a></div>
</td>
<td>—</td>
<td>Gives the angle of the vector in radians, relative to the X-axis, normalized to the interval [-π, π].</td>
</tr>
</tbody>
</table>
<div class="versionchanged">
<p><span class="versionmodified changed">Changed in pygame-ce 2.1.3: </span>Inherited methods of vector subclasses now correctly return an instance of the
...
<code class="docutils literal notranslate"><span class="pre">0</span></code> thus no direction) a <code class="docutils literal notranslate"><span class="pre">ValueError</span></code> is raised.</p>
</dd></dl>
...
vector (i.e. has length <code class="docutils literal notranslate"><span class="pre">0</span></code> thus no direction) a <code class="docutils literal notranslate"><span class="pre">ValueError</span></code> is
raised.</p>
</dd></dl>
...
<dl class="py method definition">
<dt class="sig sig-object py title" id="pygame.math.Vector2.smoothstep">
<span class="sig-name descname"><span class="pre">smoothstep</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#pygame.math.Vector2.smoothstep" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">returns a smooth interpolation to the given vector.</span></div>
<div class="line"><span class="signature">smoothstep(Vector2, value, /) -&gt; Vector2</span></div>
</div>
<p>Returns a Vector which is a smooth interpolation between self and the
...
Value is clamped to <code class="docutils literal notranslate"><span class="pre">[0,</span> <span class="pre">1]</span></code>.</p>
<p>The formula is:</p>
<p><code class="docutils literal notranslate"><span class="pre">a</span> <span class="pre">*</span> <span class="pre">(1</span> <span class="pre">-</span> <span class="pre">interp)</span> <span class="pre">+</span> <span class="pre">b</span> <span class="pre">*</span> <span class="pre">interp</span></code></p>
<p>where:</p>
<p><code class="docutils literal notranslate"><span class="pre">interp</span> <span class="pre">=</span> <span class="pre">value</span> <span class="pre">*</span> <span class="pre">value</span> <span class="pre">*</span> <span class="pre">(3</span> <span class="pre">-</span> <span class="pre">2</span> <span class="pre">*</span> <span class="pre">value)</span></code></p>
...
<figcaption>
<p><span class="caption-text">Example demonstrating the angle returned</span><a class="headerlink" href="#id2" title="Link to this image">¶</a></p>
</figcaption>
</figure>
</dd></dl>
...
<div class="versionchanged">
<p><span class="versionmodified changed">Changed in pygame-ce 2.4.0: </span>It is now possible to use <code class="docutils literal notranslate"><span class="pre">clamp_magnitude</span></code> on a zero-vector as long as <code class="docutils literal notranslate"><span class="pre">min_length</span></code>
is unspecified or 0.</p>
</div>
<div class="admonition note">
<p class="admonition-title">Note</p>
<p>Before pygame-ce 2.4.0, attempting to clamp a zero vector would always raise a <code class="docutils literal notranslate"><span class="pre">ValueError</span></code></p>
</div>
</dd></dl>
...
<dl class="py attribute definition">
<dt class="sig sig-object py title" id="pygame.math.Vector2.angle">
<span class="sig-name descname"><span class="pre">angle</span></span><a class="headerlink" href="#pygame.math.Vector2.angle" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">Gives the angle of the vector in degrees, relative to the X-axis, normalized to the interval [-180, 180].</span></div>
</div>
<p>Read-only attribute representing the angle of the vector in degrees relative to the X-axis. This angle is normalized to
the interval [-180, 180].</p>
<p>Usage: Accessing <cite>angle</cite> provides the current angle of the vector in degrees within the predefined range of [-180, 180].</p>
<div class="versionadded">
<p><span class="versionmodified added">New in pygame-ce 2.5.5.</span></p>
</div>
</dd></dl>

<dl class="py attribute definition">
<dt class="sig sig-object py title" id="pygame.math.Vector2.angle_rad">
<span class="sig-name descname"><span class="pre">angle_rad</span></span><a class="headerlink" href="#pygame.math.Vector2.angle_rad" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">Gives the angle of the vector in radians, relative to the X-axis, normalized to the interval [-π, π].</span></div>
</div>
<p>Read-only attribute representing the angle of the vector in radians relative to the X-axis. This value is equivalent
to the <cite>angle</cite> attribute converted to radians and is normalized to the interval [-π, π].</p>
<p>Usage: Accessing <cite>angle_rad</cite> provides the current angle of the vector in radians within the predefined range of [-π, π].</p>
<div class="versionadded">
<p><span class="versionmodified added">New in pygame-ce 2.5.5.</span></p>
</div>
</dd></dl>
...
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="math.html#pygame.math.Vector3.smoothstep">pygame.math.Vector3.smoothstep</a></div>
</td>
<td>—</td>
<td>returns a smooth interpolation to the given vector.</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="math.html#pygame.math.Vector3.elementwise">pygame.math.Vector3.elementwise</a></div>
</td>
<td>—</td>
<td>The next operation will be performed elementwise.</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="math.html#pygame.math.Vector3.rotate">pygame.math.Vector3.rotate</a></div>
</td>
<td>—</td>
<td>rotates a vector by a given angle in degrees.</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="math.html#pygame.math.Vector3.rotate_rad">pygame.math.Vector3.rotate_rad</a></div>
</td>
<td>—</td>
<td>rotates a vector by a given angle in radians.</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="math.html#pygame.math.Vector3.rotate_ip">pygame.math.Vector3.rotate_ip</a></div>
</td>
<td>—</td>
<td>rotates the vector by a given angle in degrees in place.</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="math.html#pygame.math.Vector3.rotate_ip_rad">pygame.math.Vector3.rotate_ip_rad</a></div>
</td>
<td>—</td>
<td>rotates the vector by a given angle in radians in place.</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="math.html#pygame.math.Vector3.rotate_rad_ip">pygame.math.Vector3.rotate_rad_ip</a></div>
</td>
<td>—</td>
<td>rotates the vector by a given angle in radians in place.</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="math.html#pygame.math.Vector3.rotate_x">pygame.math.Vector3.rotate_x</a></div>
</td>
<td>—</td>
<td>rotates a vector around the x-axis by the angle in degrees.</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="math.html#pygame.math.Vector3.rotate_x_rad">pygame.math.Vector3.rotate_x_rad</a></div>
</td>
<td>—</td>
<td>rotates a vector around the x-axis by the angle in radians.</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="math.html#pygame.math.Vector3.rotate_x_ip">pygame.math.Vector3.rotate_x_ip</a></div>
</td>
<td>—</td>
<td>rotates the vector around the x-axis by the angle in degrees in place.</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="math.html#pygame.math.Vector3.rotate_x_ip_rad">pygame.math.Vector3.rotate_x_ip_rad</a></div>
</td>
<td>—</td>
<td>rotates the vector around the x-axis by the angle in radians in place.</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="math.html#pygame.math.Vector3.rotate_x_rad_ip">pygame.math.Vector3.rotate_x_rad_ip</a></div>
</td>
<td>—</td>
<td>rotates the vector around the x-axis by the angle in radians in place.</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="math.html#pygame.math.Vector3.rotate_y">pygame.math.Vector3.rotate_y</a></div>
</td>
<td>—</td>
<td>rotates a vector around the y-axis by the angle in degrees.</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="math.html#pygame.math.Vector3.rotate_y_rad">pygame.math.Vector3.rotate_y_rad</a></div>
</td>
<td>—</td>
<td>rotates a vector around the y-axis by the angle in radians.</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="math.html#pygame.math.Vector3.rotate_y_ip">pygame.math.Vector3.rotate_y_ip</a></div>
</td>
<td>—</td>
<td>rotates the vector around the y-axis by the angle in degrees in place.</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="math.html#pygame.math.Vector3.rotate_y_ip_rad">pygame.math.Vector3.rotate_y_ip_rad</a></div>
</td>
<td>—</td>
<td>rotates the vector around the y-axis by the angle in radians in place.</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="math.html#pygame.math.Vector3.rotate_y_rad_ip">pygame.math.Vector3.rotate_y_rad_ip</a></div>
</td>
<td>—</td>
<td>rotates the vector around the y-axis by the angle in radians in place.</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="math.html#pygame.math.Vector3.rotate_z">pygame.math.Vector3.rotate_z</a></div>
</td>
<td>—</td>
<td>rotates a vector around the z-axis by the angle in degrees.</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="math.html#pygame.math.Vector3.rotate_z_rad">pygame.math.Vector3.rotate_z_rad</a></div>
</td>
<td>—</td>
<td>rotates a vector around the z-axis by the angle in radians.</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="math.html#pygame.math.Vector3.rotate_z_ip">pygame.math.Vector3.rotate_z_ip</a></div>
</td>
<td>—</td>
<td>rotates the vector around the z-axis by the angle in degrees in place.</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="math.html#pygame.math.Vector3.rotate_z_ip_rad">pygame.math.Vector3.rotate_z_ip_rad</a></div>
</td>
<td>—</td>
<td>rotates the vector around the z-axis by the angle in radians in place.</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="math.html#pygame.math.Vector3.rotate_z_rad_ip">pygame.math.Vector3.rotate_z_rad_ip</a></div>
</td>
<td>—</td>
<td>rotates the vector around the z-axis by the angle in radians in place.</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="math.html#pygame.math.Vector3.angle_to">pygame.math.Vector3.angle_to</a></div>
</td>
<td>—</td>
<td>calculates the angle to a given vector in degrees.</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="math.html#pygame.math.Vector3.as_spherical">pygame.math.Vector3.as_spherical</a></div>
</td>
<td>—</td>
<td>returns a tuple with radial distance, inclination and azimuthal angle.</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="math.html#pygame.math.Vector3.from_spherical">pygame.math.Vector3.from_spherical</a></div>
</td>
<td>—</td>
<td>Sets x, y and z from a spherical coordinates 3-tuple.</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="math.html#pygame.math.Vector3.project">pygame.math.Vector3.project</a></div>
</td>
<td>—</td>
<td>projects a vector onto another.</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="math.html#pygame.math.Vector3.copy">pygame.math.Vector3.copy</a></div>
</td>
<td>—</td>
<td>Returns a copy of itself.</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="math.html#pygame.math.Vector3.clamp_magnitude">pygame.math.Vector3.clamp_magnitude</a></div>
</td>
<td>—</td>
<td>Returns a copy of a vector with the magnitude clamped between max_length and min_length.</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="math.html#pygame.math.Vector3.clamp_magnitude_ip">pygame.math.Vector3.clamp_magnitude_ip</a></div>
</td>
<td>—</td>
<td>Clamps the vector's magnitude between max_length and min_length</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="math.html#pygame.math.Vector3.update">pygame.math.Vector3.update</a></div>
</td>
<td>—</td>
<td>Sets the coordinates of the vector.</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="math.html#pygame.math.Vector3.epsilon">pygame.math.Vector3.epsilon</a></div>
</td>
<td>—</td>
<td>Determines the tolerance of vector calculations.</td>
</tr>
...
(i.e. has length <code class="docutils literal notranslate"><span class="pre">0</span></code> thus no direction) a <code class="docutils literal notranslate"><span class="pre">ValueError</span></code> is raised.</p>
</dd></dl>
...
<dl class="py method definition">
<dt class="sig sig-object py title" id="pygame.math.Vector3.smoothstep">
<span class="sig-name descname"><span class="pre">smoothstep</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#pygame.math.Vector3.smoothstep" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">returns a smooth interpolation to the given vector.</span></div>
<div class="line"><span class="signature">smoothstep(Vector3, value, /) -&gt; Vector3</span></div>
</div>
<p>Returns a Vector which is a smooth interpolation between self and the
given Vector. This means that the interpolation follows an s-shaped curve, with
change happening more slowly near the limits (0.0 and 1.0) and faster in the middle.
...
<div class="versionchanged">
<p><span class="versionmodified changed">Changed in pygame-ce 2.5.8: </span>Fixed a regression introduced in 2.1.1 where this method incorrectly rotated
around the X-axis instead of the Y-axis. In versions prior to 2.1.1, rotation
around the Y-axis worked correctly.</p>
</div>
</dd></dl>
...
around the Z-axis worked correctly.</p>
</div>
</dd></dl>
