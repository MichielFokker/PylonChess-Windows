...
<html lang="en" data-content_root="../">
  <head>
    ...
    <title>pygame._sdl2.touch &#8212; pygame-ce v2.5.8 documentation</title>
...
<div class="line"><span class="signature">get_finger(touchid, index) -&gt; dict | None</span></div>
</div>
<dl class="field-list simple">
<dt class="field-odd">Parameters<span class="colon">:</span></dt>
...
<p>Return a dict for the finger <code class="docutils literal notranslate"><span class="pre">index</span></code> active on <code class="docutils literal notranslate"><span class="pre">touchid</span></code>, or <code class="docutils literal notranslate"><span class="pre">None</span></code> if the
