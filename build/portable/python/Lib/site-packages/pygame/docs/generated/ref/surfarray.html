...
<html lang="en" data-content_root="../">
  <head>
    ...
    <title>pygame.surfarray &#8212; pygame-ce v2.5.8 documentation</title>
    ...
    <link rel="next" title="pygame.system" href="system.html" />
...
<p><span class="versionmodified changed">Changed in pygame-ce 2.5.6: </span>surfarray module is lazily loaded to avoid an expensive NumPy import when unnecessary</p>
</div>
...
<p><code class="docutils literal notranslate"><span class="pre">float32</span></code>, <code class="docutils literal notranslate"><span class="pre">float64</span></code> and (where available) <code class="docutils literal notranslate"><span class="pre">float96</span></code> NumPy arrays
are also accepted, but are first rounded to the nearest integer and
copied into a new array before creating the surface.</p>
...
well as <code class="docutils literal notranslate"><span class="pre">float32</span></code>, <code class="docutils literal notranslate"><span class="pre">float64</span></code> and (where available) <code class="docutils literal notranslate"><span class="pre">float96</span></code> NumPy
arrays.</p>
<p>Float arrays are first rounded to the nearest integer and copied into
a new array before blitting. This is significantly slower (on the order of 2x)
versus passing an integer array.</p>
      ...
      <ul>
        ...
        <li class="right" >
          <a href="../py-modindex.html" title="Python Module Index"
             >modules</a> |</li>
        <li class="right" >
          <a href="system.html" title="pygame.system"
