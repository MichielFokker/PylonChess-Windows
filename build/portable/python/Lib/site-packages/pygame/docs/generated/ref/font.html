...
<html lang="en" data-content_root="../">
  <head>
    ...
    <title>pygame.font &#8212; pygame-ce v2.5.8 documentation</title>
...
using the  <a class="tooltip reference internal" href="freetype.html#module-pygame.freetype" title=""><code class="xref py py-mod docutils literal notranslate"><span class="pre">pygame.freetype</span></code><span class="tooltip-content">pygame module for loading and rendering computer fonts</span></a> based <code class="docutils literal notranslate"><span class="pre">pygame.ftfont</span></code> to emulate the Font
...
<p>Previously created font objects will be invalid after the font module is quit.</p>
</dd></dl>
...
<div class="line"><span class="signature">get_default_font() -&gt; str</span></div>
</div>
...
<div class="line"><span class="signature">get_sdl_ttf_version(linked=True) -&gt; tuple[int, int, int]</span></div>
</div>
<p>Returns a tuple of integers that identify SDL_ttf's version,
<code class="docutils literal notranslate"><span class="pre">(major,</span> <span class="pre">minor,</span> <span class="pre">patch)</span></code>. SDL_ttf is the underlying font rendering library,
...
<div class="line"><span class="signature">get_fonts() -&gt; list[str]</span></div>
</div>
...
<p><span class="versionmodified changed">Changed in pygame-ce 2.1.3: </span>Checks through user fonts instead of just global fonts for Windows.</p>
</div>
</dd></dl>
...
<div class="line"><span class="signature">match_font(name, bold=False, italic=False) -&gt; str | None</span></div>
</div>
...
<p>Example:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">pygame</span><span class="o">.</span><span class="n">font</span><span class="o">.</span><span class="n">match_font</span><span class="p">(</span><span class="s1">&#39;Arial&#39;</span><span class="p">)</span>
<span class="go">&#39;C:\WINDOWS\Fonts\arial.ttf&#39;</span>
</pre></div>
</div>
</dd></dl>
...
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="font.html#pygame.font.Font.name">pygame.font.Font.name</a></div>
</td>
<td>—</td>
<td>Gets the font's name.</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="font.html#pygame.font.Font.style_name">pygame.font.Font.style_name</a></div>
</td>
<td>—</td>
<td>Gets the font's style_name.</td>
</tr>
...
<td>—</td>
<td>Gets or sets how rendered text is aligned when given a wrap length.</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="font.html#pygame.font.Font.point_size">pygame.font.Font.point_size</a></div>
</td>
<td>—</td>
<td>Gets or sets the font's point size.</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="font.html#pygame.font.Font.outline">pygame.font.Font.outline</a></div>
</td>
<td>—</td>
<td>Gets or sets the font's outline thickness (pixels).</td>
</tr>
...
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="font.html#pygame.font.Font.set_linesize">pygame.font.Font.set_linesize</a></div>
</td>
<td>—</td>
<td>Set the line space of the font text.</td>
</tr>
...
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="font.html#pygame.font.Font.set_point_size">pygame.font.Font.set_point_size</a></div>
</td>
<td>—</td>
<td>Set the point size of the font.</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="font.html#pygame.font.Font.get_point_size">pygame.font.Font.get_point_size</a></div>
</td>
<td>—</td>
<td>Get the point size of the font.</td>
</tr>
...
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="font.html#pygame.font.Font.set_direction">pygame.font.Font.set_direction</a></div>
</td>
<td>—</td>
...
<div class="versionchanged">
<p><span class="versionmodified changed">Changed in pygame-ce 2.1.4: </span>If no arguments are given then the default font will be used and
a font size of 20 is used.</p>
</div>
<div class="versionchanged">
<p><span class="versionmodified changed">Changed in pygame-ce 2.1.4: </span>This class is also available through the <code class="docutils literal notranslate"><span class="pre">pygame.Font</span></code>
alias.</p>
</div>
...
<dl class="py attribute definition">
<dt class="sig sig-object py title" id="pygame.font.Font.name">
<span class="sig-name descname"><span class="pre">name</span></span><a class="headerlink" href="#pygame.font.Font.name" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">Gets the font's name.</span></div>
<div class="line"><span class="signature">name -&gt; str</span></div>
</div>
<p>Read only. Returns the font's name.</p>
<div class="versionadded">
<p><span class="versionmodified added">New in pygame-ce 2.2.</span></p>
</div>
</dd></dl>

<dl class="py attribute definition">
<dt class="sig sig-object py title" id="pygame.font.Font.style_name">
<span class="sig-name descname"><span class="pre">style_name</span></span><a class="headerlink" href="#pygame.font.Font.style_name" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">Gets the font's style_name.</span></div>
<div class="line"><span class="signature">style_name -&gt; str</span></div>
</div>
<p>Read only. Returns the font's style name. Style names are arbitrary, can be an empty string.
Here are some examples:</p>
<blockquote>
<div><p>'Black', 'Bold', 'Bold Italic', 'BoldOblique', 'Book', 'BookOblique', 'Condensed', 'Condensed Oblique',
'ExtraLight', 'Italic', 'Light', 'LightOblique', 'Medium', 'MediumOblique', 'Oblique', 'Regular',
'Semibold', 'Semilight', 'Slanted'</p>
</div></blockquote>
<div class="versionadded">
...
<span class="sig-name descname"><span class="pre">align</span></span><a class="headerlink" href="#pygame.font.Font.align" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">Gets or sets how rendered text is aligned when given a wrap length.</span></div>
...
font. Defaults to <cite>pygame.FONT_LEFT</cite>.</p>
...
<dl class="py attribute definition">
<dt class="sig sig-object py title" id="pygame.font.Font.point_size">
<span class="sig-name descname"><span class="pre">point_size</span></span><a class="headerlink" href="#pygame.font.Font.point_size" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">Gets or sets the font's point size.</span></div>
<div class="line"><span class="signature">point_size -&gt; int</span></div>
</div>
<p>Returns the point size of the font. Will not be accurate upon initializing
the font object when the font name is initialized as <code class="docutils literal notranslate"><span class="pre">None</span></code>.</p>
<div class="versionadded">
<p><span class="versionmodified added">New in pygame-ce 2.3.1.</span></p>
</div>
</dd></dl>
...
<dl class="py attribute definition">
<dt class="sig sig-object py title" id="pygame.font.Font.outline">
<span class="sig-name descname"><span class="pre">outline</span></span><a class="headerlink" href="#pygame.font.Font.outline" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">Gets or sets the font's outline thickness (pixels).</span></div>
<div class="line"><span class="signature">outline -&gt; int</span></div>
</div>
<p>The outline value of the font.</p>
<p>When set to 0, the font will be drawn normally. When positive,
...
are not allowed.</p>
<p>This can be drawn underneath unoutlined text to create a text outline
effect. For example:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="k">def</span><span class="w"> </span><span class="nf">render_outlined</span><span class="p">(</span>
    <span class="n">font</span><span class="p">:</span> <span class="n">pygame</span><span class="o">.</span><span class="n">Font</span><span class="p">,</span>
    <span class="n">text</span><span class="p">:</span> <span class="nb">str</span><span class="p">,</span>
    <span class="n">text_color</span><span class="p">:</span> <span class="n">pygame</span><span class="o">.</span><span class="n">typing</span><span class="o">.</span><span class="n">ColorLike</span><span class="p">,</span>
    <span class="n">outline_color</span><span class="p">:</span> <span class="n">pygame</span><span class="o">.</span><span class="n">typing</span><span class="o">.</span><span class="n">ColorLike</span><span class="p">,</span>
    <span class="n">outline_width</span><span class="p">:</span> <span class="nb">int</span><span class="p">,</span>
<span class="p">)</span> <span class="o">-&gt;</span> <span class="n">pygame</span><span class="o">.</span><span class="n">Surface</span><span class="p">:</span>
    <span class="n">old_outline</span> <span class="o">=</span> <span class="n">font</span><span class="o">.</span><span class="n">outline</span>
    <span class="k">if</span> <span class="n">old_outline</span> <span class="o">!=</span> <span class="mi">0</span><span class="p">:</span>
        <span class="n">font</span><span class="o">.</span><span class="n">outline</span> <span class="o">=</span> <span class="mi">0</span>
    <span class="n">base_text_surf</span> <span class="o">=</span> <span class="n">font</span><span class="o">.</span><span class="n">render</span><span class="p">(</span><span class="n">text</span><span class="p">,</span> <span class="kc">True</span><span class="p">,</span> <span class="n">text_color</span><span class="p">)</span>
    <span class="n">font</span><span class="o">.</span><span class="n">outline</span> <span class="o">=</span> <span class="n">outline_width</span>
    <span class="n">outlined_text_surf</span> <span class="o">=</span> <span class="n">font</span><span class="o">.</span><span class="n">render</span><span class="p">(</span><span class="n">text</span><span class="p">,</span> <span class="kc">True</span><span class="p">,</span> <span class="n">outline_color</span><span class="p">)</span>

    <span class="n">outlined_text_surf</span><span class="o">.</span><span class="n">blit</span><span class="p">(</span><span class="n">base_text_surf</span><span class="p">,</span> <span class="p">(</span><span class="n">outline_width</span><span class="p">,</span> <span class="n">outline_width</span><span class="p">))</span>
    <span class="n">font</span><span class="o">.</span><span class="n">outline</span> <span class="o">=</span> <span class="n">old_outline</span>
    <span class="k">return</span> <span class="n">outlined_text_surf</span>
</pre></div>
</div>
<div class="versionadded">
<p><span class="versionmodified added">New in pygame-ce 2.5.7.</span></p>
</div>
</dd></dl>
...
<div class="line"><span class="signature">render(text, antialias, color, bgcolor=None, wraplength=0) -&gt; Surface</span></div>
</div>
...
to use for the text background. If bgcolor is <code class="docutils literal notranslate"><span class="pre">None</span></code> the area outside
the text will be transparent.</p>
...
<a class="tooltip reference internal" href="#pygame.font.Font.align" title=""><code class="xref py py-attr docutils literal notranslate"><span class="pre">pygame.font.Font.align</span></code><span class="tooltip-content">Gets or sets how rendered text is aligned when given a wrap length.</span></a> for line-alignment settings.</p>
...
<div class="versionchanged">
<p><span class="versionmodified changed">Changed in pygame-ce 2.1.4: </span>newline characters now will break text into
multiple lines.</p>
</div>
<div class="versionadded">
<p><span class="versionmodified added">New in pygame-ce 2.1.4: </span>wraplength parameter</p>
</div>
<div class="versionchanged">
<p><span class="versionmodified changed">Changed in pygame-ce 2.3.0: </span>now supports keyword arguments.</p>
</div>
</dd></dl>
...
<div class="line"><span class="signature">size(text, /) -&gt; tuple[int, int]</span></div>
</div>
<p>Returns the dimensions (width, height) needed to render the text.
...
<div class="line"><span class="signature">set_underline(value, /) -&gt; None</span></div>
</div>
...
<div class="line"><span class="signature">set_strikethrough(value, /) -&gt; None</span></div>
</div>
...
<div class="line"><span class="signature">set_bold(value, /) -&gt; None</span></div>
</div>
...
<div class="line"><span class="signature">set_italic(value, /) -&gt; None</span></div>
</div>
...
character.</p>
<div class="versionchanged">
<p><span class="versionmodified changed">Changed in pygame-ce 2.5.4: </span>This function now supports all unicode codepoints.
Previously, only a subset that was representable in UCS-2 was supported.</p>
</div>
</dd></dl>
...
between lines.</p>
<p>See also <a class="reference internal" href="#pygame.font.Font.set_linesize" title="pygame.font.Font.set_linesize"><code class="xref py py-meth docutils literal notranslate"><span class="pre">set_linesize()</span></code></a>.</p>
</dd></dl>

<dl class="py method definition">
<dt class="sig sig-object py title" id="pygame.font.Font.set_linesize">
<span class="sig-name descname"><span class="pre">set_linesize</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#pygame.font.Font.set_linesize" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">Set the line space of the font text.</span></div>
<div class="line"><span class="signature">set_linesize(linesize, /) -&gt; None</span></div>
</div>
<p>Set the height in pixels for a line of text with the font. When rendering
multiple lines of text this refers to the amount of space between lines.
The value must be non-negative.</p>
<p>See also <a class="reference internal" href="#pygame.font.Font.get_linesize" title="pygame.font.Font.get_linesize"><code class="xref py py-meth docutils literal notranslate"><span class="pre">get_linesize()</span></code></a>.</p>
<div class="versionadded">
...
<dl class="py method definition">
<dt class="sig sig-object py title" id="pygame.font.Font.set_point_size">
<span class="sig-name descname"><span class="pre">set_point_size</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#pygame.font.Font.set_point_size" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">Set the point size of the font.</span></div>
<div class="line"><span class="signature">set_point_size(val, /) -&gt; None</span></div>
</div>
<div class="admonition note">
<p class="admonition-title">Note</p>
<p>This is the same as the <a class="reference internal" href="#pygame.font.Font.point_size" title="pygame.font.Font.point_size"><code class="xref py py-attr docutils literal notranslate"><span class="pre">point_size</span></code></a> attribute.</p>
</div>
<div class="versionadded">
<p><span class="versionmodified added">New in pygame-ce 2.3.1.</span></p>
</div>
...
<dl class="py method definition">
<dt class="sig sig-object py title" id="pygame.font.Font.get_point_size">
<span class="sig-name descname"><span class="pre">get_point_size</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#pygame.font.Font.get_point_size" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">Get the point size of the font.</span></div>
<div class="line"><span class="signature">get_point_size() -&gt; int</span></div>
</div>
<p>Returns the point size of the font. Will not be accurate upon
initializing the font object when the font name is initialized
as <code class="docutils literal notranslate"><span class="pre">None</span></code>.</p>
<div class="admonition note">
<p class="admonition-title">Note</p>
<p>This is the same as the <a class="reference internal" href="#pygame.font.Font.point_size" title="pygame.font.Font.point_size"><code class="xref py py-attr docutils literal notranslate"><span class="pre">point_size</span></code></a> attribute.</p>
</div>
...
<div class="line"><span class="signature">set_script(script_code, /) -&gt; None</span></div>
</div>
...
<span class="sig-name descname"><span class="pre">set_direction</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#pygame.font.Font.set_direction" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">Set the script direction for text shaping.</span></div>
<div class="line"><span class="signature">set_direction(direction) -&gt; None</span></div>
</div>
...
<div class="admonition note">
<p class="admonition-title">Note</p>
<p>multiline renders with <a class="reference internal" href="#pygame.font.Font.render" title="pygame.font.Font.render"><code class="xref py py-meth docutils literal notranslate"><span class="pre">render()</span></code></a> do not play nicely with top-to-bottom
or bottom-to-top rendering.</p>
</div>
<div class="versionadded">
<p><span class="versionmodified added">New in pygame-ce 2.1.4.</span></p>
</div>
