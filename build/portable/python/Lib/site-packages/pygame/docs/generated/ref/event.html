...
<html lang="en" data-content_root="../">
  <head>
    ...
    <title>pygame.event &#8212; pygame-ce v2.5.8 documentation</title>
...
<td>—</td>
<td>control which events are blocked on the queue</td>
</tr>
...
<p class="rubric">Event queue</p>
<p>Pygame handles all its event messaging through an event queue. The functions in
this module help you manage that event queue. The input queue is heavily
dependent on the video system (<a class="tooltip reference internal" href="display.html#module-pygame.display" title=""><code class="xref py py-mod docutils literal notranslate"><span class="pre">pygame.display</span></code><span class="tooltip-content">Pygame module to control the display window and screen.</span></a> or <a class="tooltip reference internal" href="window.html#pygame.Window" title=""><code class="xref py py-class docutils literal notranslate"><span class="pre">pygame.Window</span></code><span class="tooltip-content">Pygame object that represents a window.</span></a>).
If a window has not been created, the event queue may not work properly.</p>
...
events every frame (with <a class="tooltip reference internal" href="#pygame.event.get" title=""><code class="xref py py-func docutils literal notranslate"><span class="pre">pygame.event.get()</span></code><span class="tooltip-content">get events from the queue</span></a>, <a class="tooltip reference internal" href="#pygame.event.pump" title=""><code class="xref py py-func docutils literal notranslate"><span class="pre">pygame.event.pump()</span></code><span class="tooltip-content">internally process pygame event handlers</span></a>,
<a class="tooltip reference internal" href="#pygame.event.wait" title=""><code class="xref py py-func docutils literal notranslate"><span class="pre">pygame.event.wait()</span></code><span class="tooltip-content">wait for a single event from the queue</span></a>, <a class="tooltip reference internal" href="#pygame.event.peek" title=""><code class="xref py py-func docutils literal notranslate"><span class="pre">pygame.event.peek()</span></code><span class="tooltip-content">test if event types are waiting on the queue</span></a> or
<a class="tooltip reference internal" href="#pygame.event.clear" title=""><code class="xref py py-func docutils literal notranslate"><span class="pre">pygame.event.clear()</span></code><span class="tooltip-content">remove all events from the queue</span></a>).</p>
<div class="admonition note">
<p class="admonition-title">Note</p>
<p>Not handling events may cause the system to decide the program is
frozen (not responding).</p>
</div>
<p class="rubric">Events of input devices</p>
...
<a class="tooltip reference internal" href="mouse.html#module-pygame.mouse" title=""><code class="xref py py-mod docutils literal notranslate"><span class="pre">pygame.mouse</span></code><span class="tooltip-content">Pygame module to work with the mouse.</span></a>, <a class="tooltip reference internal" href="key.html#module-pygame.key" title=""><code class="xref py py-mod docutils literal notranslate"><span class="pre">pygame.key</span></code><span class="tooltip-content">Pygame module to work with the keyboard.</span></a>, and <a class="tooltip reference internal" href="joystick.html#module-pygame.joystick" title=""><code class="xref py py-mod docutils literal notranslate"><span class="pre">pygame.joystick</span></code><span class="tooltip-content">Pygame module for interacting with joysticks, gamepads, and trackballs.</span></a>. However,
the event queue still needs to be running internally to enable this; programs
still need to use functions like <a class="tooltip reference internal" href="#pygame.event.get" title=""><code class="xref py py-func docutils literal notranslate"><span class="pre">pygame.event.get()</span></code><span class="tooltip-content">get events from the queue</span></a> or
<a class="tooltip reference internal" href="#pygame.event.pump" title=""><code class="xref py py-func docutils literal notranslate"><span class="pre">pygame.event.pump()</span></code><span class="tooltip-content">internally process pygame event handlers</span></a> periodically. Note: Joysticks will not send any
events until the device has been initialized.</p>
<p class="rubric">Event objects</p>
...
checking for the existence of events, to popping them off of the event queue.</p>
...
accessible as the <a class="tooltip reference internal" href="#pygame.event.Event.type" title=""><code class="xref py py-attr docutils literal notranslate"><span class="pre">pygame.event.Event.type</span></code><span class="tooltip-content">event type identifier.</span></a> property. An event type's
specific attributes can be accessed directly as an attribute on the event
object.</p>
<p>Users can create their own new events (or emulate system events) by
instantiating <a class="tooltip reference internal" href="#pygame.event.Event" title=""><code class="xref py py-func docutils literal notranslate"><span class="pre">pygame.event.Event()</span></code><span class="tooltip-content">pygame object for representing events</span></a> themselves, usually paired
with <a class="tooltip reference internal" href="#pygame.event.post" title=""><code class="xref py py-func docutils literal notranslate"><span class="pre">pygame.event.post()</span></code><span class="tooltip-content">place a new event on the queue</span></a>.</p>
...
<p class="rubric">Custom events and debugging</p>
...
of <code class="docutils literal notranslate"><span class="pre">USEREVENT</span></code> to <code class="docutils literal notranslate"><span class="pre">NUMEVENTS</span> <span class="pre">-</span> <span class="pre">1</span></code>. User defined events should reserve
a custom event number with <a class="tooltip reference internal" href="#pygame.event.custom_type" title=""><code class="xref py py-func docutils literal notranslate"><span class="pre">pygame.event.custom_type()</span></code><span class="tooltip-content">make custom user event type</span></a>.</p>
<p>While debugging and experimenting, you can print an event object for a quick
display of its type and members.</p>
<p class="rubric">Event types and attributes</p>
...
specific attributes and notes.</p>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">Event</span> <span class="nb">type</span>                 <span class="n">Attributes</span><span class="o">/</span><span class="n">Notes</span>

<span class="n">QUIT</span>
<span class="n">USEREVENT</span>                  <span class="p">(</span><span class="n">Starting</span> <span class="nb">type</span> <span class="n">of</span> <span class="n">the</span> <span class="n">user</span> <span class="n">defined</span>
                            <span class="n">event</span> <span class="n">types</span><span class="p">)</span>

<span class="n">KEYDOWN</span>                    <span class="n">key</span><span class="p">,</span> <span class="n">mod</span><span class="p">,</span> <span class="n">unicode</span><span class="p">,</span> <span class="n">scancode</span><span class="p">,</span> <span class="n">window</span><span class="p">(</span><span class="mi">1</span><span class="p">)</span>
<span class="n">KEYUP</span>                      <span class="n">key</span><span class="p">,</span> <span class="n">mod</span><span class="p">,</span> <span class="n">unicode</span><span class="p">,</span> <span class="n">scancode</span><span class="p">,</span> <span class="n">window</span><span class="p">(</span><span class="mi">1</span><span class="p">)</span>

<span class="n">MOUSEMOTION</span>                <span class="n">pos</span><span class="p">,</span> <span class="n">rel</span><span class="p">,</span> <span class="n">buttons</span><span class="p">,</span> <span class="n">touch</span><span class="p">(</span><span class="mi">2</span><span class="p">),</span> <span class="n">window</span><span class="p">(</span><span class="mi">1</span><span class="p">)</span>
<span class="n">MOUSEBUTTONUP</span>              <span class="n">pos</span><span class="p">,</span> <span class="n">button</span><span class="p">,</span> <span class="n">touch</span><span class="p">(</span><span class="mi">2</span><span class="p">),</span> <span class="n">clicks</span><span class="p">(</span><span class="mi">3</span><span class="p">),</span> <span class="n">window</span><span class="p">(</span><span class="mi">1</span><span class="p">)</span>
<span class="n">MOUSEBUTTONDOWN</span>            <span class="n">pos</span><span class="p">,</span> <span class="n">button</span><span class="p">,</span> <span class="n">touch</span><span class="p">(</span><span class="mi">2</span><span class="p">),</span> <span class="n">clicks</span><span class="p">(</span><span class="mi">3</span><span class="p">),</span> <span class="n">window</span><span class="p">(</span><span class="mi">1</span><span class="p">)</span>
<span class="n">MOUSEWHEEL</span>                 <span class="n">which</span><span class="p">,</span> <span class="n">flipped</span><span class="p">,</span> <span class="n">x</span><span class="p">,</span> <span class="n">y</span><span class="p">,</span> <span class="n">touch</span><span class="p">(</span><span class="mi">2</span><span class="p">),</span> <span class="n">precise_x</span><span class="p">,</span>
                            <span class="n">precise_y</span><span class="p">,</span> <span class="n">window</span><span class="p">(</span><span class="mi">1</span><span class="p">),</span> <span class="n">pos</span><span class="p">(</span><span class="mi">5</span><span class="p">)</span>

<span class="n">JOYAXISMOTION</span>              <span class="n">instance_id</span><span class="p">,</span> <span class="n">axis</span><span class="p">,</span> <span class="n">value</span> <span class="p">(</span><span class="n">deprecated</span><span class="p">:</span> <span class="n">joy</span><span class="p">)</span>
<span class="n">JOYBALLMOTION</span>              <span class="n">instance_id</span><span class="p">,</span> <span class="n">ball</span><span class="p">,</span> <span class="n">rel</span> <span class="p">(</span><span class="n">deprecated</span><span class="p">:</span> <span class="n">joy</span><span class="p">)</span>
<span class="n">JOYHATMOTION</span>               <span class="n">instance_id</span><span class="p">,</span> <span class="n">hat</span><span class="p">,</span> <span class="n">value</span> <span class="p">(</span><span class="n">deprecated</span><span class="p">:</span> <span class="n">joy</span><span class="p">)</span>
<span class="n">JOYBUTTONUP</span>                <span class="n">instance_id</span><span class="p">,</span> <span class="n">button</span> <span class="p">(</span><span class="n">deprecated</span><span class="p">:</span> <span class="n">joy</span><span class="p">)</span>
<span class="n">JOYBUTTONDOWN</span>              <span class="n">instance_id</span><span class="p">,</span> <span class="n">button</span> <span class="p">(</span><span class="n">deprecated</span><span class="p">:</span> <span class="n">joy</span><span class="p">)</span>
...
<span class="p">(</span><span class="n">Use</span> <span class="n">the</span> <span class="n">window</span> <span class="n">event</span> <span class="n">API</span> <span class="n">instead</span> <span class="n">of</span> <span class="n">legacy</span> <span class="n">events</span><span class="p">)</span>
<span class="n">ACTIVEEVENT</span>                <span class="n">gain</span><span class="p">,</span> <span class="n">state</span> <span class="p">(</span><span class="n">Legacy</span> <span class="n">event</span><span class="p">)</span>
<span class="n">VIDEORESIZE</span>                <span class="n">size</span><span class="p">,</span> <span class="n">w</span><span class="p">,</span> <span class="n">h</span>  <span class="p">(</span><span class="n">Legacy</span> <span class="n">event</span><span class="p">)</span>
<span class="n">VIDEOEXPOSE</span>                            <span class="p">(</span><span class="n">Legacy</span> <span class="n">event</span><span class="p">)</span>

<span class="n">AUDIODEVICEADDED</span>           <span class="n">which</span><span class="p">,</span> <span class="n">iscapture</span>
<span class="n">AUDIODEVICEREMOVED</span>         <span class="n">which</span><span class="p">,</span> <span class="n">iscapture</span>

<span class="n">FINGERMOTION</span>               <span class="n">touch_id</span><span class="p">,</span> <span class="n">finger_id</span><span class="p">,</span> <span class="n">x</span><span class="p">,</span> <span class="n">y</span><span class="p">,</span> <span class="n">dx</span><span class="p">,</span> <span class="n">dy</span><span class="p">,</span> <span class="n">window</span><span class="p">(</span><span class="mi">1</span><span class="p">)</span>
<span class="n">FINGERDOWN</span>                 <span class="n">touch_id</span><span class="p">,</span> <span class="n">finger_id</span><span class="p">,</span> <span class="n">x</span><span class="p">,</span> <span class="n">y</span><span class="p">,</span> <span class="n">dx</span><span class="p">,</span> <span class="n">dy</span><span class="p">,</span> <span class="n">window</span><span class="p">(</span><span class="mi">1</span><span class="p">)</span>
<span class="n">FINGERUP</span>                   <span class="n">touch_id</span><span class="p">,</span> <span class="n">finger_id</span><span class="p">,</span> <span class="n">x</span><span class="p">,</span> <span class="n">y</span><span class="p">,</span> <span class="n">dx</span><span class="p">,</span> <span class="n">dy</span><span class="p">,</span> <span class="n">window</span><span class="p">(</span><span class="mi">1</span><span class="p">)</span>
...
<span class="n">TEXTEDITING</span><span class="p">(</span><span class="mi">4</span><span class="p">)</span>             <span class="n">text</span><span class="p">,</span> <span class="n">start</span><span class="p">(</span><span class="mi">4</span><span class="p">),</span> <span class="n">length</span><span class="p">(</span><span class="mi">4</span><span class="p">),</span> <span class="n">window</span><span class="p">(</span><span class="mi">1</span><span class="p">)</span>
<span class="n">TEXTINPUT</span><span class="p">(</span><span class="mi">4</span><span class="p">)</span>               <span class="n">text</span><span class="p">,</span> <span class="n">window</span><span class="p">(</span><span class="mi">1</span><span class="p">)</span>

<span class="n">DROPFILE</span>                   <span class="n">window</span><span class="p">(</span><span class="mi">1</span><span class="p">),</span> <span class="n">file</span> <span class="p">(</span><span class="n">Path</span> <span class="n">of</span> <span class="n">the</span> <span class="n">file</span> <span class="n">dropped</span>
                            <span class="n">on</span> <span class="n">the</span> <span class="n">window</span><span class="p">)</span>
<span class="n">DROPBEGIN</span>                  <span class="n">window</span><span class="p">(</span><span class="mi">1</span><span class="p">)</span>
<span class="n">DROPCOMPLETE</span>               <span class="n">window</span><span class="p">(</span><span class="mi">1</span><span class="p">)</span>
<span class="n">DROPTEXT</span>                   <span class="n">window</span><span class="p">(</span><span class="mi">1</span><span class="p">)</span>

<span class="n">MIDIIN</span>                     <span class="p">(</span><span class="n">Reserved</span> <span class="k">for</span> <span class="n">pygame</span><span class="o">.</span><span class="n">midi</span> <span class="n">use</span><span class="p">)</span>
<span class="n">MIDIOUT</span>                    <span class="p">(</span><span class="n">Reserved</span> <span class="k">for</span> <span class="n">pygame</span><span class="o">.</span><span class="n">midi</span> <span class="n">use</span><span class="p">)</span>

<span class="n">KEYMAPCHANGED</span>              <span class="p">(</span><span class="n">Keymap</span> <span class="n">change</span> <span class="n">due</span> <span class="n">to</span> <span class="n">language</span><span class="o">/</span><span class="n">keyboard</span>
                            <span class="n">layout</span> <span class="n">change</span><span class="p">)</span>
<span class="n">CLIPBOARDUPDATE</span>            <span class="p">(</span><span class="n">Partially</span> <span class="n">experimental</span><span class="p">)</span>
<span class="n">LOCALECHANGED</span>

<span class="n">RENDER_TARGETS_RESET</span>
<span class="n">RENDER_DEVICE_RESET</span>
</pre></div>
</div>
<div class="line-block">
<div class="line"><br /></div>
</div>
<p>(<code class="docutils literal notranslate"><span class="pre">1</span></code>): if a <a class="tooltip reference internal" href="window.html#pygame.Window" title=""><code class="xref py py-class docutils literal notranslate"><span class="pre">pygame.Window</span></code><span class="tooltip-content">Pygame object that represents a window.</span></a> instance exists for the window that the event
occurred in, the <code class="docutils literal notranslate"><span class="pre">window</span></code> attribute of these events will be that instance,
otherwise it will be <code class="docutils literal notranslate"><span class="pre">None</span></code>.</p>
<p>(<code class="docutils literal notranslate"><span class="pre">2</span></code>): The <code class="docutils literal notranslate"><span class="pre">touch</span></code> attribute of <code class="docutils literal notranslate"><span class="pre">MOUSE</span></code> events indicates whether or not the
events were generated by a touch input device, and not a real mouse. You might
want to ignore such events, if your application already handles <code class="docutils literal notranslate"><span class="pre">FINGERMOTION</span></code>,
<code class="docutils literal notranslate"><span class="pre">FINGERDOWN</span></code> and <code class="docutils literal notranslate"><span class="pre">FINGERUP</span></code> events.</p>
<p>(<code class="docutils literal notranslate"><span class="pre">3</span></code>): The <code class="docutils literal notranslate"><span class="pre">clicks</span></code> attribute of the <code class="docutils literal notranslate"><span class="pre">MOUSEBUTTONDOWN</span></code> and <code class="docutils literal notranslate"><span class="pre">MOUSEBUTTONUP</span></code>
events indicate the number of clicks occurring in rapid succession, e.g. <code class="docutils literal notranslate"><span class="pre">1</span></code>
for single-click, <code class="docutils literal notranslate"><span class="pre">2</span></code> for double-click, etc. Note that double, triple, or
more clicks will still fire mouse events for each individual click, with a
progressively increasing <code class="docutils literal notranslate"><span class="pre">clicks</span></code> attribute.</p>
<p>(<code class="docutils literal notranslate"><span class="pre">4</span></code>): The <code class="docutils literal notranslate"><span class="pre">start</span></code> attribute of the <code class="docutils literal notranslate"><span class="pre">TEXTEDITING</span></code> event is the cursor position,
in UTF-8 characters, where the new typing will be inserted into the editing text,
while the <code class="docutils literal notranslate"><span class="pre">length</span></code> attribute is the number of UTF-8 characters that will be
replaced by the new typing.</p>
<p>These <code class="docutils literal notranslate"><span class="pre">TEXT*</span></code> events are useful to implement inputs/languages that require composition,
provided by the system's IME (Input Method Editor). The <code class="docutils literal notranslate"><span class="pre">TEXTINPUT</span></code> event is only
fired when the text is confirmed.</p>
<p>(<code class="docutils literal notranslate"><span class="pre">5</span></code>): Position information was added to <code class="docutils literal notranslate"><span class="pre">MOUSEWHEEL</span></code> events in SDL 2.26.0.  If
pygame was built on a version lower than that, the <code class="docutils literal notranslate"><span class="pre">pos</span></code> attribute is <code class="docutils literal notranslate"><span class="pre">None</span></code>.</p>
<div class="line-block">
<div class="line"><br /></div>
</div>
<p>Here is a list of the new window events.</p>
<p>All window events have a <code class="docutils literal notranslate"><span class="pre">window</span></code> attribute corresponding to the
<a class="tooltip reference internal" href="window.html#pygame.Window" title=""><code class="xref py py-class docutils literal notranslate"><span class="pre">pygame.Window</span></code><span class="tooltip-content">Pygame object that represents a window.</span></a> that generated them.</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">Event</span> <span class="nb">type</span>             <span class="n">Short</span> <span class="n">description</span> <span class="ow">and</span> <span class="n">additional</span> <span class="n">attributes</span>
...
<span class="n">WINDOWMOVED</span>            <span class="n">Window</span> <span class="n">got</span> <span class="n">moved</span>        <span class="p">(</span><span class="n">x</span><span class="p">,</span> <span class="n">y</span> <span class="n">attributes</span><span class="p">)</span>
<span class="n">WINDOWSIZECHANGED</span>      <span class="n">Window</span> <span class="n">size</span> <span class="n">has</span> <span class="n">changed</span> <span class="p">(</span><span class="n">x</span><span class="p">,</span> <span class="n">y</span> <span class="n">attributes</span><span class="p">)</span>
<span class="n">WINDOWRESIZED</span>          <span class="n">Window</span> <span class="n">got</span> <span class="n">resized</span> <span class="n">by</span> <span class="n">the</span> <span class="n">user</span><span class="o">/</span><span class="n">window</span> <span class="n">manager</span>
                        <span class="p">(</span><span class="n">x</span><span class="p">,</span> <span class="n">y</span> <span class="n">attributes</span><span class="p">)</span>
...
<span class="n">WINDOWICCPROFCHANGED</span>   <span class="n">Window</span> <span class="n">ICC</span> <span class="n">profile</span> <span class="n">changed</span>
                        <span class="p">(</span><span class="n">SDL</span> <span class="n">backend</span> <span class="o">&gt;=</span> <span class="mf">2.0.18</span><span class="p">)</span>
<span class="n">WINDOWDISPLAYCHANGED</span>   <span class="n">Window</span> <span class="n">moved</span> <span class="n">on</span> <span class="n">a</span> <span class="n">new</span> <span class="n">display</span> <span class="p">(</span><span class="n">display_index</span>
                        <span class="n">attribute</span><span class="o">.</span> <span class="n">SDL</span> <span class="n">backend</span> <span class="o">&gt;=</span> <span class="mf">2.0.18</span><span class="p">)</span>
</pre></div>
</div>
<div class="line-block">
<div class="line"><br /></div>
...
<span class="n">APP_LOWMEMORY</span>             <span class="n">OS</span> <span class="ow">is</span> <span class="n">low</span> <span class="n">on</span> <span class="n">memory</span> <span class="p">(</span><span class="k">try</span> <span class="n">to</span> <span class="n">free</span> <span class="n">memory</span><span class="p">)</span>
...
<p><span class="versionmodified added">New in pygame 2.0.1: </span>Window events and the <code class="docutils literal notranslate"><span class="pre">unicode</span></code> attribute for <code class="docutils literal notranslate"><span class="pre">KEYUP</span></code> events.</p>
</div>
<div class="versionaddedold">
<p><span class="versionmodified added">New in pygame 2.0.2: </span>The <code class="docutils literal notranslate"><span class="pre">touch</span></code> attribute was added to all the <code class="docutils literal notranslate"><span class="pre">MOUSE</span></code> events.</p>
</div>
<div class="versionadded">
<p><span class="versionmodified added">New in pygame-ce 2.1.3: </span>Android events, <code class="docutils literal notranslate"><span class="pre">precise_x</span></code> and <code class="docutils literal notranslate"><span class="pre">precise_y</span></code> to <code class="docutils literal notranslate"><span class="pre">MOUSEWHEEL</span></code> events,
<code class="docutils literal notranslate"><span class="pre">KEYMAPCHANGED</span></code>, <code class="docutils literal notranslate"><span class="pre">CLIPBOARDUPDATE</span></code>, <code class="docutils literal notranslate"><span class="pre">LOCALECHANGED</span></code>, <code class="docutils literal notranslate"><span class="pre">WINDOWICCPROFCHANGED</span></code>,
<code class="docutils literal notranslate"><span class="pre">WINDOWDISPLAYCHANGED</span></code>, <code class="docutils literal notranslate"><span class="pre">RENDER_TARGETS_RESET</span></code>, and <code class="docutils literal notranslate"><span class="pre">RENDER_DEVICE_RESET</span></code>.</p>
</div>
<div class="versionadded">
<p><span class="versionmodified added">New in pygame-ce 2.5.7: </span>The <code class="docutils literal notranslate"><span class="pre">clicks</span></code> attribute was added to <code class="docutils literal notranslate"><span class="pre">MOUSEBUTTONDOWN</span></code>
and <code class="docutils literal notranslate"><span class="pre">MOUSEBUTTONUP</span></code> events.</p>
</div>
<div class="versionadded">
<p><span class="versionmodified added">New in pygame-ce 2.5.8: </span>The <code class="docutils literal notranslate"><span class="pre">pos</span></code> attribute was added to <code class="docutils literal notranslate"><span class="pre">MOUSEWHEEL</span></code> events.</p>
</div>
<div class="line-block">
<div class="line"><br /></div>
</div>
...
<p>When <code class="docutils literal notranslate"><span class="pre">eventtype</span></code> is not passed or <code class="docutils literal notranslate"><span class="pre">None</span></code>, this function will return <code class="docutils literal notranslate"><span class="pre">True</span></code> if
there's any event on the queue, and return <code class="docutils literal notranslate"><span class="pre">False</span></code> if the queue is empty.</p>
<p>If <code class="docutils literal notranslate"><span class="pre">pump</span></code> is <code class="docutils literal notranslate"><span class="pre">True</span></code> (the default), then <a class="tooltip reference internal" href="#pygame.event.pump" title=""><code class="xref py py-func docutils literal notranslate"><span class="pre">pygame.event.pump()</span></code><span class="tooltip-content">internally process pygame event handlers</span></a> will be called.</p>
<div class="versionchangedold">
<p><span class="versionmodified changed">Changed in pygame 1.9.5: </span>Added <code class="docutils literal notranslate"><span class="pre">pump</span></code> argument</p>
</div>
<div class="versionchanged">
<p><span class="versionmodified changed">Changed in pygame-ce 2.5.3: </span>no longer mistakenly returns an event when <code class="docutils literal notranslate"><span class="pre">eventtype</span></code> is None or not passed.</p>
</div>
</dd></dl>
...
<dd><div class="line-block">
<div class="line"><span class="summaryline">control which events are blocked on the queue</span></div>
...
<p>When this event is received on the event queue, it will be a shallow copy of
...
<p>Reserves an event slot for use in a custom event <code class="docutils literal notranslate"><span class="pre">userevent</span></code> and returns the integer that the event slot is reserved to.</p>
...
<div class="versionchanged">
<p><span class="versionmodified changed">Changed in pygame-ce 2.1.4: </span>This class is also available through the <code class="docutils literal notranslate"><span class="pre">pygame.Event</span></code>
alias.</p>
</div>
<div class="admonition note">
<p class="admonition-title">Note</p>
...
<a class="tooltip reference internal" href="#pygame.event.Event" title=""><code class="xref py py-class docutils literal notranslate"><span class="pre">pygame.event.Event()</span></code><span class="tooltip-content">pygame object for representing events</span></a>.</p>
