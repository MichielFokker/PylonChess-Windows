...
<html lang="en" data-content_root="../">
  <head>
    ...
    <title>API exported by pygame.event &#8212; pygame-ce v2.5.8 documentation</title>
...
<dl class="c function">
<dt class="sig sig-object c" id="c.pgEvent_GetKeyDownInfo">
<span class="kt"><span class="pre">char</span></span><span class="w"> </span><span class="p"><span class="pre">*</span></span><span class="sig-name descname"><span class="n"><span class="pre">pgEvent_GetKeyDownInfo</span></span></span><span class="sig-paren">(</span><span class="kt"><span class="pre">void</span></span><span class="sig-paren">)</span><a class="headerlink" href="#c.pgEvent_GetKeyDownInfo" title="Link to this definition">¶</a><br /></dt>
<dd><p>Return an array of bools (using char) of length SDL_NUM_SCANCODES
with the most recent key presses.</p>
</dd></dl>

<dl class="c function">
<dt class="sig sig-object c" id="c.pgEvent_GetKeyUpInfo">
<span class="kt"><span class="pre">char</span></span><span class="w"> </span><span class="p"><span class="pre">*</span></span><span class="sig-name descname"><span class="n"><span class="pre">pgEvent_GetKeyUpInfo</span></span></span><span class="sig-paren">(</span><span class="kt"><span class="pre">void</span></span><span class="sig-paren">)</span><a class="headerlink" href="#c.pgEvent_GetKeyUpInfo" title="Link to this definition">¶</a><br /></dt>
<dd><p>Return an array of bools (using char) of length SDL_NUM_SCANCODES
with the most recent key releases.</p>
</dd></dl>

<dl class="c function">
<dt class="sig sig-object c" id="c.pgEvent_GetMouseButtonDownInfo">
<span class="kt"><span class="pre">char</span></span><span class="w"> </span><span class="p"><span class="pre">*</span></span><span class="sig-name descname"><span class="n"><span class="pre">pgEvent_GetMouseButtonDownInfo</span></span></span><span class="sig-paren">(</span><span class="kt"><span class="pre">void</span></span><span class="sig-paren">)</span><a class="headerlink" href="#c.pgEvent_GetMouseButtonDownInfo" title="Link to this definition">¶</a><br /></dt>
<dd><p>Return an array of bools (using char) of length 5
with the most recent button presses.</p>
</dd></dl>

<dl class="c function">
<dt class="sig sig-object c" id="c.pgEvent_GetMouseButtonUpInfo">
<span class="kt"><span class="pre">char</span></span><span class="w"> </span><span class="p"><span class="pre">*</span></span><span class="sig-name descname"><span class="n"><span class="pre">pgEvent_GetMouseButtonUpInfo</span></span></span><span class="sig-paren">(</span><span class="kt"><span class="pre">void</span></span><span class="sig-paren">)</span><a class="headerlink" href="#c.pgEvent_GetMouseButtonUpInfo" title="Link to this definition">¶</a><br /></dt>
<dd><p>Return an array of bools (using char) of length 5
with the most recent button releases.</p>
</dd></dl>

<dl class="c function">
<dt class="sig sig-object c" id="c.pg_post_event">
<span class="kt"><span class="pre">int</span></span><span class="w"> </span><span class="sig-name descname"><span class="n"><span class="pre">pg_post_event</span></span></span><span class="sig-paren">(</span><span class="n"><span class="pre">Uint32</span></span><span class="w"> </span><span class="n"><span class="pre">type</span></span>, <span class="n"><span class="pre">PyObject</span></span><span class="w"> </span><span class="p"><span class="pre">*</span></span><span class="n"><span class="pre">dict</span></span><span class="sig-paren">)</span><a class="headerlink" href="#c.pg_post_event" title="Link to this definition">¶</a><br /></dt>
<dd><p>Posts a pygame event that is an <code class="docutils literal notranslate"><span class="pre">SDL_USEREVENT</span></code> on the SDL side. This
...
otherwise. Just like the SDL <code class="docutils literal notranslate"><span class="pre">SDL_PushEvent</span></code> function, returns 1 on
success, 0 if the event was not posted due to it being blocked, and -1 on
failure.</p>
</dd></dl>

<dl class="c function">
<dt class="sig sig-object c" id="c.pg_post_event_dictproxy">
<span class="kt"><span class="pre">int</span></span><span class="w"> </span><span class="sig-name descname"><span class="n"><span class="pre">pg_post_event_dictproxy</span></span></span><span class="sig-paren">(</span><span class="n"><span class="pre">Uint32</span></span><span class="w"> </span><span class="n"><span class="pre">type</span></span>, <span class="n"><span class="pre">pgEventDictProxy</span></span><span class="w"> </span><span class="p"><span class="pre">*</span></span><span class="n"><span class="pre">dict_proxy</span></span><span class="sig-paren">)</span><a class="headerlink" href="#c.pg_post_event_dictproxy" title="Link to this definition">¶</a><br /></dt>
<dd><p>Posts a pygame event that is an <code class="docutils literal notranslate"><span class="pre">SDL_USEREVENT</span></code> on the SDL side, can also
...
Just like the SDL <code class="docutils literal notranslate"><span class="pre">SDL_PushEvent</span></code> function, returns 1 on success, 0 if the
event was not posted due to it being blocked, and -1 on failure.</p>
</dd></dl>
