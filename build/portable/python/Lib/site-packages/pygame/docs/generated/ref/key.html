...
<html lang="en" data-content_root="../">
  <head>
    ...
    <title>pygame.key &#8212; pygame-ce v2.5.8 documentation</title>
...
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="key.html#pygame.key.get_just_pressed">pygame.key.get_just_pressed</a></div>
</td>
<td>—</td>
<td>Returns a ScancodeWrapper containing the most recent key presses.</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="key.html#pygame.key.get_just_released">pygame.key.get_just_released</a></div>
</td>
<td>—</td>
<td>Returns a ScancodeWrapper containing the most recent key releases.</td>
</tr>
...
<div class="line"><span class="signature">get_pressed() -&gt; ScancodeWrapper</span></div>
</div>
...
<p><span class="versionmodified changed">Changed in pygame-ce 2.1.4: </span>The collection of bools returned by <code class="docutils literal notranslate"><span class="pre">get_pressed</span></code> can not be iterated
...
<dl class="py function definition">
<dt class="sig sig-object py title" id="pygame.key.get_just_pressed">
<span class="sig-prename descclassname"><span class="pre">pygame.key.</span></span><span class="sig-name descname"><span class="pre">get_just_pressed</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#pygame.key.get_just_pressed" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">Returns a ScancodeWrapper containing the most recent key presses.</span></div>
<div class="line"><span class="signature">get_just_pressed() -&gt; ScancodeWrapper</span></div>
</div>
<p>Returns a mapping from key codes to booleans indicating which keys were
newly pressed as of the last time events were processed. This can be used
as a convenience function to detect keys that were pressed &quot;this frame.&quot;</p>
...
<p>A key can be marked as &quot;just pressed&quot; even if it is not currently pressed
according to <a class="tooltip reference internal" href="#pygame.key.get_pressed" title=""><code class="xref py py-func docutils literal notranslate"><span class="pre">pygame.key.get_pressed()</span></code><span class="tooltip-content">Get the state of all keyboard buttons.</span></a>, if it was pressed and released
again during the same frame. Multiple presses and releases of the same key
are not distinguished from a single press with this function.</p>
<div class="admonition seealso">
<p class="admonition-title">See also</p>
<p><a class="tooltip reference internal" href="#pygame.key.get_just_released" title=""><code class="xref py py-func docutils literal notranslate"><span class="pre">pygame.key.get_just_released()</span></code><span class="tooltip-content">Returns a ScancodeWrapper containing the most recent key releases.</span></a></p>
</div>
<div class="admonition note">
<p class="admonition-title">Note</p>
<p>If you require getting the key presses in order, use the event queue
<code class="docutils literal notranslate"><span class="pre">KEYDOWN</span></code> events</p>
</div>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="k">if</span> <span class="n">pygame</span><span class="o">.</span><span class="n">key</span><span class="o">.</span><span class="n">get_just_pressed</span><span class="p">()[</span><span class="n">pygame</span><span class="o">.</span><span class="n">K_b</span><span class="p">]:</span>
   <span class="nb">print</span><span class="p">(</span><span class="s2">&quot;B key just pressed&quot;</span><span class="p">)</span>
</pre></div>
</div>
...
<dl class="py function definition">
<dt class="sig sig-object py title" id="pygame.key.get_just_released">
<span class="sig-prename descclassname"><span class="pre">pygame.key.</span></span><span class="sig-name descname"><span class="pre">get_just_released</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#pygame.key.get_just_released" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">Returns a ScancodeWrapper containing the most recent key releases.</span></div>
<div class="line"><span class="signature">get_just_released() -&gt; ScancodeWrapper</span></div>
</div>
<p>Returns a mapping from key codes to booleans indicating which keys were
newly released as of the last time events were processed. This can be used
as a convenience function to detect keys that were released &quot;this frame.&quot;</p>
<p>The result of this function is updated when new events are processed,
e.g. in <a class="tooltip reference internal" href="event.html#pygame.event.get" title=""><code class="xref py py-func docutils literal notranslate"><span class="pre">pygame.event.get()</span></code><span class="tooltip-content">get events from the queue</span></a> or <a class="tooltip reference internal" href="event.html#pygame.event.pump" title=""><code class="xref py py-func docutils literal notranslate"><span class="pre">pygame.event.pump()</span></code><span class="tooltip-content">internally process pygame event handlers</span></a>.</p>
<p>A key can be marked as &quot;just released&quot; even if it is currently pressed
according to <a class="tooltip reference internal" href="#pygame.key.get_pressed" title=""><code class="xref py py-func docutils literal notranslate"><span class="pre">pygame.key.get_pressed()</span></code><span class="tooltip-content">Get the state of all keyboard buttons.</span></a>, if it was released and pressed
again during the same frame. Multiple releases and presses of the same key
are not distinguished from a single release with this function.</p>
<div class="admonition seealso">
<p class="admonition-title">See also</p>
<p><a class="tooltip reference internal" href="#pygame.key.get_just_pressed" title=""><code class="xref py py-func docutils literal notranslate"><span class="pre">pygame.key.get_just_pressed()</span></code><span class="tooltip-content">Returns a ScancodeWrapper containing the most recent key presses.</span></a></p>
</div>
<div class="admonition note">
<p class="admonition-title">Note</p>
<p>If you require getting the key releases in order, use the event queue
<code class="docutils literal notranslate"><span class="pre">KEYUP</span></code> events.</p>
</div>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="k">if</span> <span class="n">pygame</span><span class="o">.</span><span class="n">key</span><span class="o">.</span><span class="n">get_just_released</span><span class="p">()[</span><span class="n">pygame</span><span class="o">.</span><span class="n">K_b</span><span class="p">]:</span>
   <span class="nb">print</span><span class="p">(</span><span class="s2">&quot;B key just released&quot;</span><span class="p">)</span>
</pre></div>
</div>
<div class="versionadded">
<p><span class="versionmodified added">New in pygame-ce 2.4.0.</span></p>
...
<div class="line"><span class="signature">set_mods(mods, /) -&gt; None</span></div>
</div>
...
<div class="line"><span class="signature">set_repeat(delay=0, interval=0, /) -&gt; None</span></div>
</div>
...
<div class="line"><span class="signature">get_repeat() -&gt; tuple[int, int]</span></div>
</div>
...
<div class="versionchanged">
<p><span class="versionmodified changed">Changed in pygame-ce 2.1.3: </span>Added <code class="docutils literal notranslate"><span class="pre">use_compat</span></code> argument and guaranteed API stability for it</p>
</div>
</dd></dl>
...
<div class="line"><span class="signature">key_code(name) -&gt; int</span></div>
</div>
...
<div class="admonition seealso">
<p class="admonition-title">See also</p>
<p><a class="tooltip reference internal" href="#pygame.key.stop_text_input" title=""><code class="xref py py-func docutils literal notranslate"><span class="pre">pygame.key.stop_text_input()</span></code><span class="tooltip-content">Stop handling Unicode text input events.</span></a></p>
</div>
<div class="versionaddedold">
<p><span class="versionmodified added">New in pygame 2.0.0.</span></p>
</div>
...
<a class="tooltip reference internal" href="#pygame.key.start_text_input" title=""><code class="xref py py-func docutils literal notranslate"><span class="pre">pygame.key.start_text_input()</span></code><span class="tooltip-content">Start handling Unicode text input events.</span></a>, hide it again.</p>
<p>Text input events handling is on by default.</p>
