...
<html lang="en" data-content_root="../">
  <head>
    ...
    <title>pygame.examples &#8212; pygame-ce v2.5.8 documentation</title>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="kn">import</span><span class="w"> </span><span class="nn">pygame.examples.scaletest</span>
...
pygame.</p>
<p><code class="docutils literal notranslate"><span class="pre">NOTE</span></code>: the pygame scale function uses SIMD acceleration if available,
and can be run in multiple threads.</p>
