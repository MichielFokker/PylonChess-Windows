...
<html lang="en" data-content_root="../">
  <head>
    ...
    <title>pygame.Rect &#8212; pygame-ce v2.5.8 documentation</title>
...
<div class="line"><span class="signature">Rect() -&gt; Rect</span></div>
<div class="line"><span class="signature">FRect(left, top, width, height, /) -&gt; FRect</span></div>
<div class="line"><span class="signature">FRect((left, top), (width, height), /) -&gt; FRect</span></div>
<div class="line"><span class="signature">FRect(object, /) -&gt; FRect</span></div>
<div class="line"><span class="signature">FRect() -&gt; FRect</span></div>
</div>
...
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="rect.html#pygame.Rect.move_to">pygame.Rect.move_to</a></div>
</td>
<td>—</td>
<td>moves the rectangle to the specified position</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="rect.html#pygame.Rect.inflate">pygame.Rect.inflate</a></div>
</td>
<td>—</td>
<td>grow or shrink the rectangle size</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="rect.html#pygame.Rect.inflate_ip">pygame.Rect.inflate_ip</a></div>
</td>
<td>—</td>
<td>grow or shrink the rectangle size, in place</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="rect.html#pygame.Rect.scale_by">pygame.Rect.scale_by</a></div>
</td>
<td>—</td>
<td>scale the rectangle by given a multiplier</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="rect.html#pygame.Rect.scale_by_ip">pygame.Rect.scale_by_ip</a></div>
</td>
<td>—</td>
<td>grow or shrink the rectangle size, in place</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="rect.html#pygame.Rect.update">pygame.Rect.update</a></div>
</td>
<td>—</td>
<td>sets the position and size of the rectangle</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="rect.html#pygame.Rect.clamp">pygame.Rect.clamp</a></div>
</td>
<td>—</td>
<td>moves the rectangle inside another</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="rect.html#pygame.Rect.clamp_ip">pygame.Rect.clamp_ip</a></div>
</td>
<td>—</td>
<td>moves the rectangle inside another, in place</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="rect.html#pygame.Rect.clip">pygame.Rect.clip</a></div>
</td>
<td>—</td>
<td>crops a rectangle inside another</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="rect.html#pygame.Rect.clipline">pygame.Rect.clipline</a></div>
</td>
<td>—</td>
<td>crops a line inside a rectangle</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="rect.html#pygame.Rect.union">pygame.Rect.union</a></div>
</td>
<td>—</td>
<td>joins two rectangles into one</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="rect.html#pygame.Rect.union_ip">pygame.Rect.union_ip</a></div>
</td>
<td>—</td>
<td>joins two rectangles into one, in place</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="rect.html#pygame.Rect.unionall">pygame.Rect.unionall</a></div>
</td>
<td>—</td>
<td>the union of many rectangles</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="rect.html#pygame.Rect.unionall_ip">pygame.Rect.unionall_ip</a></div>
</td>
<td>—</td>
<td>the union of many rectangles, in place</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="rect.html#pygame.Rect.fit">pygame.Rect.fit</a></div>
</td>
<td>—</td>
<td>resize and move a rectangle with aspect ratio</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="rect.html#pygame.Rect.normalize">pygame.Rect.normalize</a></div>
</td>
<td>—</td>
<td>correct negative sizes</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="rect.html#pygame.Rect.contains">pygame.Rect.contains</a></div>
</td>
<td>—</td>
<td>test if one rectangle is inside another</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="rect.html#pygame.Rect.collidepoint">pygame.Rect.collidepoint</a></div>
</td>
<td>—</td>
<td>test if a point is inside a rectangle</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="rect.html#pygame.Rect.colliderect">pygame.Rect.colliderect</a></div>
</td>
<td>—</td>
<td>test if two rectangles overlap</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="rect.html#pygame.Rect.collidelist">pygame.Rect.collidelist</a></div>
</td>
<td>—</td>
<td>test if one rectangle in a list intersects</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="rect.html#pygame.Rect.collidelistall">pygame.Rect.collidelistall</a></div>
</td>
<td>—</td>
<td>test if all rectangles in a list intersect</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="rect.html#pygame.Rect.collideobjects">pygame.Rect.collideobjects</a></div>
</td>
<td>—</td>
<td>test if any object in a list intersects</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="rect.html#pygame.Rect.collideobjectsall">pygame.Rect.collideobjectsall</a></div>
</td>
<td>—</td>
<td>test if all objects in a list intersect</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="rect.html#pygame.Rect.collidedict">pygame.Rect.collidedict</a></div>
</td>
<td>—</td>
<td>test if one rectangle in a dictionary intersects</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="rect.html#pygame.Rect.collidedictall">pygame.Rect.collidedictall</a></div>
</td>
<td>—</td>
...
<p><span class="versionmodified added">New in pygame-ce 2.2: </span>Added <code class="docutils literal notranslate"><span class="pre">FRect</span></code> class that is functionally identical to <code class="docutils literal notranslate"><span class="pre">Rect</span></code> but uses
floats instead of integers, enabling fractional precision and avoiding
truncation error while being interchangeable with standard Rects.</p>
</div>
...
<p>If no arguments are given, a zero Rect will be created (x=0, y=0, w=0, h=0).
This will only work when using the Rect/FRect class and not with functions
that require a Rect argument.</p>
...
<span class="n">size</span><span class="p">,</span> <span class="n">width</span><span class="p">,</span> <span class="n">height</span><span class="p">,</span> <span class="n">relcenter</span>
...
<p>Assigning to size, width, height, or relcenter changes the dimensions of the rectangle;
...
<div class="versionadded">
<p><span class="versionmodified added">New in pygame-ce 2.5.6: </span><code class="docutils literal notranslate"><span class="pre">relcenter</span></code> added to Rect / FRect. This will return a tuple containing half
the Rect's size; the center relative to the topleft of the Rect.
Setting it to a <code class="docutils literal notranslate"><span class="pre">Point</span></code> will modify the size of the rect to 2 times
the <code class="docutils literal notranslate"><span class="pre">Point</span></code> given. Below you can find a code example of how it should work:</p>
<div class="highlight-python notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">my_rect</span> <span class="o">=</span> <span class="n">pygame</span><span class="o">.</span><span class="n">Rect</span><span class="p">(</span><span class="mi">0</span><span class="p">,</span> <span class="mi">0</span><span class="p">,</span> <span class="mi">2</span><span class="p">,</span> <span class="mi">2</span><span class="p">)</span>
<span class="gp">&gt;&gt;&gt; </span><span class="n">my_rect</span><span class="o">.</span><span class="n">relcenter</span>
<span class="go">(1, 1)</span>
<span class="gp">&gt;&gt;&gt; </span><span class="n">my_rect</span><span class="o">.</span><span class="n">relcenter</span> <span class="o">=</span> <span class="p">(</span><span class="mi">128</span><span class="p">,</span> <span class="mi">128</span><span class="p">)</span>
<span class="gp">&gt;&gt;&gt; </span><span class="n">my_rect</span><span class="o">.</span><span class="n">size</span>
<span class="go">(256, 256)</span>
</pre></div>
</div>
<p>Beware of non-integer relative centers! For Rects (but not FRects), <code class="docutils literal notranslate"><span class="pre">relcenter</span></code>
will truncate the numbers in the returned tuple.</p>
</div>
...
<dl class="py method definition">
<dt class="sig sig-object py title" id="pygame.Rect.move_to">
<span class="sig-name descname"><span class="pre">move_to</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#pygame.Rect.move_to" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">moves the rectangle to the specified position</span></div>
<div class="line"><span class="signature">move_to(**kwargs) -&gt; Rect</span></div>
</div>
<p>Returns a new rectangle that is moved to the given position and optionally resized.
You must provide keyword arguments to the method such as <code class="docutils literal notranslate"><span class="pre">center</span></code>, <code class="docutils literal notranslate"><span class="pre">left</span></code>,
<code class="docutils literal notranslate"><span class="pre">midbottom</span></code>, <code class="docutils literal notranslate"><span class="pre">size</span></code> that correspond to the rectangle's attributes and the
method will return a new rectangle whose specified attributes are set to the given value.</p>
<p>It is similar to <a class="reference internal" href="surface.html#pygame.Surface.get_rect" title="pygame.Surface.get_rect"><code class="xref py py-meth docutils literal notranslate"><span class="pre">Surface.get_rect()</span></code></a> but instead of a calling it as a surface method
you call it as a rectangle method.</p>
<div class="versionadded">
...
<div class="line"><span class="signature">scale_by(scale_by) -&gt; Rect</span></div>
<div class="line"><span class="signature">scale_by(x, y) -&gt; Rect</span></div>
</div>
...
<p><span class="versionmodified changed">Changed in pygame-ce 2.5.2: </span>the argument <code class="docutils literal notranslate"><span class="pre">scale_by</span></code> can now be passed as a positional argument</p>
</div>
</dd></dl>
...
<dd><div class="line-block">
<div class="line"><span class="summaryline">grow or shrink the rectangle size, in place</span></div>
<div class="line"><span class="signature">scale_by_ip(scale_by) -&gt; None</span></div>
<div class="line"><span class="signature">scale_by_ip(x, y) -&gt; None</span></div>
</div>
...
<span class="linenos">16</span><span class="k">class</span><span class="w"> </span><span class="nc">ObjectWithRectAttribute</span><span class="p">(</span><span class="nb">object</span><span class="p">):</span>
<span class="linenos">17</span>    <span class="k">def</span><span class="w"> </span><span class="fm">__init__</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">r</span><span class="p">):</span>
...
<span class="linenos">26</span><span class="k">class</span><span class="w"> </span><span class="nc">ObjectWithCallableRectAttribute</span><span class="p">(</span><span class="nb">object</span><span class="p">):</span>
<span class="linenos">27</span>    <span class="k">def</span><span class="w"> </span><span class="fm">__init__</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">r</span><span class="p">):</span>
...
<span class="linenos">30</span>    <span class="k">def</span><span class="w"> </span><span class="nf">rect</span><span class="p">(</span><span class="bp">self</span><span class="p">):</span>
...
<span class="linenos">12</span>
<span class="linenos">13</span><span class="k">class</span><span class="w"> </span><span class="nc">ObjectWithSomRectAttribute</span><span class="p">:</span>
<span class="linenos">14</span>    <span class="k">def</span><span class="w"> </span><span class="fm">__init__</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">name</span><span class="p">,</span> <span class="n">collision_box</span><span class="p">,</span> <span class="n">draw_rect</span><span class="p">):</span>
...
<span class="linenos">19</span>    <span class="k">def</span><span class="w"> </span><span class="fm">__repr__</span><span class="p">(</span><span class="bp">self</span><span class="p">):</span>
...
<span class="linenos">15</span><span class="k">class</span><span class="w"> </span><span class="nc">ObjectWithSomRectAttribute</span><span class="p">:</span>
<span class="linenos">16</span>    <span class="k">def</span><span class="w"> </span><span class="fm">__init__</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">name</span><span class="p">,</span> <span class="n">collision_box</span><span class="p">,</span> <span class="n">draw_rect</span><span class="p">):</span>
...
<span class="linenos">21</span>    <span class="k">def</span><span class="w"> </span><span class="fm">__repr__</span><span class="p">(</span><span class="bp">self</span><span class="p">):</span>
...
<div class="line"><span class="signature">collidedict(rect_dict) -&gt; (key, value)</span></div>
<div class="line"><span class="signature">collidedict(rect_dict) -&gt; None</span></div>
<div class="line"><span class="signature">collidedict(rect_dict, values=False) -&gt; (key, value)</span></div>
<div class="line"><span class="signature">collidedict(rect_dict, values=False) -&gt; None</span></div>
</div>
...
<code class="docutils literal notranslate"><span class="pre">values</span></code> is False (default) then the dict's keys will be used in the
...
<div class="versionchanged">
<p><span class="versionmodified changed">Changed in pygame-ce 2.4.0: </span><code class="docutils literal notranslate"><span class="pre">values</span></code> is now accepted as a keyword argument. Type Stub updated
to use boolean <code class="docutils literal notranslate"><span class="pre">True</span></code> or <code class="docutils literal notranslate"><span class="pre">False</span></code>, but any truthy or falsy value
will be valid.</p>
</div>
</dd></dl>
...
<div class="line"><span class="signature">collidedictall(rect_dict) -&gt; [(key, value), ...]</span></div>
<div class="line"><span class="signature">collidedictall(rect_dict, values=False) -&gt; [(key, value), ...]</span></div>
</div>
...
If <code class="docutils literal notranslate"><span class="pre">values</span></code> is False (default) then the dict's keys will be used in the
collision detection, otherwise the dict's values will be used.</p>
<div class="admonition note">
<p class="admonition-title">Note</p>
<p>Rect objects cannot be used as keys in a dictionary (they are not
