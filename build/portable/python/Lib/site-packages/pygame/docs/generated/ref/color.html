...
<html lang="en" data-content_root="../">
  <head>
    ...
    <title>pygame.Color &#8212; pygame-ce v2.5.8 documentation</title>
...
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="color.html#pygame.Color.normalized">pygame.Color.normalized</a></div>
</td>
<td>—</td>
<td>Gets or sets the normalized representation of the Color.</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="color.html#pygame.Color.hex">pygame.Color.hex</a></div>
</td>
<td>—</td>
<td>Gets or sets the stringified hexadecimal representation of the Color.</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="color.html#pygame.Color.from_cmy">pygame.Color.from_cmy</a></div>
</td>
<td>—</td>
<td>Returns a Color object from a CMY representation.</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="color.html#pygame.Color.from_hsva">pygame.Color.from_hsva</a></div>
</td>
<td>—</td>
<td>Returns a Color object from an HSVA representation.</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="color.html#pygame.Color.from_hsla">pygame.Color.from_hsla</a></div>
</td>
<td>—</td>
<td>Returns a Color object from an HSLA representation.</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="color.html#pygame.Color.from_i1i2i3">pygame.Color.from_i1i2i3</a></div>
</td>
<td>—</td>
<td>Returns a Color object from a I1I2I3 representation.</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="color.html#pygame.Color.from_normalized">pygame.Color.from_normalized</a></div>
</td>
<td>—</td>
<td>Returns a Color object from a Normalized representation.</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="color.html#pygame.Color.from_hex">pygame.Color.from_hex</a></div>
</td>
<td>—</td>
<td>Returns a Color object from a Hexadecimal representation.</td>
</tr>
...
<p>Color objects support swizzling for their <code class="docutils literal notranslate"><span class="pre">RGBA</span></code> attributes, which allows
the creation of new color objects with the corresponding swizzled attributes
as its <code class="docutils literal notranslate"><span class="pre">RGBA</span></code> attributes. For example, <code class="docutils literal notranslate"><span class="pre">color.bgra</span></code> provides a shortcut to
doing <code class="docutils literal notranslate"><span class="pre">Color(color.b,</span> <span class="pre">color.g,</span> <span class="pre">color.r,</span> <span class="pre">color.a)</span></code>. Swizzling with other than
4 attributes will return a tuple consisting of the corresponding elements
instead of a color object.</p>
...
<p>Supported <code class="docutils literal notranslate"><span class="pre">color_value</span></code> formats:</p>
...
<p><span class="versionmodified changed">Changed in pygame-ce 2.5.6: </span><code class="docutils literal notranslate"><span class="pre">bytes(Color(...))</span></code> (assuming <a class="reference external" href="https://docs.python.org/3/library/stdtypes.html#bytes">bytes</a> is
the built-in type) now returns a <code class="docutils literal notranslate"><span class="pre">bytes</span></code> object (of length 4) with the RGBA values of the color,
as opposed to <a class="reference internal" href="#pygame.Color" title="pygame.Color"><code class="xref py py-class docutils literal notranslate"><span class="pre">Color</span></code></a> being interpreted as an integer (think <code class="docutils literal notranslate"><span class="pre">int(Color(...))</span></code>) causing it
to return a <code class="docutils literal notranslate"><span class="pre">bytes</span></code> object filled with 0s the length of said integer.</p>
</div>
...
<span class="sig-name descname"><span class="pre">r</span></span><em class="property"><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">int</span></em><a class="headerlink" href="#pygame.Color.r" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
...
<span class="sig-name descname"><span class="pre">g</span></span><em class="property"><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">int</span></em><a class="headerlink" href="#pygame.Color.g" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
...
<span class="sig-name descname"><span class="pre">b</span></span><em class="property"><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">int</span></em><a class="headerlink" href="#pygame.Color.b" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
...
<span class="sig-name descname"><span class="pre">a</span></span><em class="property"><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">int</span></em><a class="headerlink" href="#pygame.Color.a" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
...
<span class="sig-name descname"><span class="pre">cmy</span></span><em class="property"><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">tuple</span><span class="p"><span class="pre">[</span></span><span class="pre">float</span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="pre">float</span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="pre">float</span><span class="p"><span class="pre">]</span></span></em><a class="headerlink" href="#pygame.Color.cmy" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">Gets or sets the CMY representation of the Color.</span></div>
<div class="line"><span class="signature">cmy -&gt; tuple[float, float, float]</span></div>
</div>
...
<span class="sig-name descname"><span class="pre">hsva</span></span><em class="property"><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">tuple</span><span class="p"><span class="pre">[</span></span><span class="pre">float</span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="pre">float</span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="pre">float</span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="pre">float</span><span class="p"><span class="pre">]</span></span></em><a class="headerlink" href="#pygame.Color.hsva" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">Gets or sets the HSVA representation of the Color.</span></div>
<div class="line"><span class="signature">hsva -&gt; tuple[float, float, float, float]</span></div>
</div>
...
<span class="sig-name descname"><span class="pre">hsla</span></span><em class="property"><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">tuple</span><span class="p"><span class="pre">[</span></span><span class="pre">float</span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="pre">float</span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="pre">float</span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="pre">float</span><span class="p"><span class="pre">]</span></span></em><a class="headerlink" href="#pygame.Color.hsla" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">Gets or sets the HSLA representation of the Color.</span></div>
<div class="line"><span class="signature">hsla -&gt; tuple[float, float, float, float]</span></div>
</div>
...
<span class="sig-name descname"><span class="pre">i1i2i3</span></span><em class="property"><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">tuple</span><span class="p"><span class="pre">[</span></span><span class="pre">float</span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="pre">float</span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="pre">float</span><span class="p"><span class="pre">]</span></span></em><a class="headerlink" href="#pygame.Color.i1i2i3" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">Gets or sets the I1I2I3 representation of the Color.</span></div>
<div class="line"><span class="signature">i1i2i3 -&gt; tuple[float, float, float]</span></div>
</div>
...
<dl class="py attribute definition">
<dt class="sig sig-object py title" id="pygame.Color.normalized">
<span class="sig-name descname"><span class="pre">normalized</span></span><em class="property"><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">tuple</span><span class="p"><span class="pre">[</span></span><span class="pre">float</span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="pre">float</span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="pre">float</span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="pre">float</span><span class="p"><span class="pre">]</span></span></em><a class="headerlink" href="#pygame.Color.normalized" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">Gets or sets the normalized representation of the Color.</span></div>
<div class="line"><span class="signature">normalized -&gt; tuple[float, float, float, float]</span></div>
</div>
<p>The <code class="docutils literal notranslate"><span class="pre">Normalized</span></code> representation of the Color. The components of the <code class="docutils literal notranslate"><span class="pre">Normalized</span></code>
representation represent the basic <code class="docutils literal notranslate"><span class="pre">RGBA</span></code> values but normalized the
ranges of the values are <code class="docutils literal notranslate"><span class="pre">r</span></code> = [0, 1], <code class="docutils literal notranslate"><span class="pre">g</span></code> = [0, 1], <code class="docutils literal notranslate"><span class="pre">b</span></code> = [0, 1]
and <code class="docutils literal notranslate"><span class="pre">a</span></code> = [0, 1] respectively. Note that this will not return the absolutely exact
<code class="docutils literal notranslate"><span class="pre">Normalized</span></code> values for the set <code class="docutils literal notranslate"><span class="pre">RGBA</span></code> values in all cases.
Due to the <code class="docutils literal notranslate"><span class="pre">RGB</span></code> mapping from 0-255 and the <code class="docutils literal notranslate"><span class="pre">Normalized</span></code> mapping from 0-1
rounding errors may cause the <code class="docutils literal notranslate"><span class="pre">Normalized</span></code> values to differ
...
<dl class="py attribute definition">
<dt class="sig sig-object py title" id="pygame.Color.hex">
<span class="sig-name descname"><span class="pre">hex</span></span><em class="property"><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">str</span></em><a class="headerlink" href="#pygame.Color.hex" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">Gets or sets the stringified hexadecimal representation of the Color.</span></div>
<div class="line"><span class="signature">hex -&gt; str</span></div>
</div>
<p>The stringified hexadecimal representation of the Color. The hexadecimal string
is formatted as <code class="docutils literal notranslate"><span class="pre">&quot;#rrggbbaa&quot;</span></code> where rr, gg, bb, and aa are two digit hex numbers
in the range from 0x00 to 0xff.</p>
<p>Setting this property means changing the color channels in place. Both lowercase
and uppercase letters are allowed, the alpha can be omitted (defaults to 0xff) and
the string can start with either <code class="docutils literal notranslate"><span class="pre">#</span></code> or <code class="docutils literal notranslate"><span class="pre">0x</span></code>.</p>
<div class="versionadded">
<p><span class="versionmodified added">New in pygame-ce 2.5.4.</span></p>
</div>
</dd></dl>

<dl class="py method definition">
<dt class="sig sig-object py title" id="pygame.Color.from_cmy">
<em class="property"><span class="pre">classmethod</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">from_cmy</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#pygame.Color.from_cmy" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">Returns a Color object from a CMY representation.</span></div>
<div class="line"><span class="signature">from_cmy(object, /) -&gt; Color</span></div>
<div class="line"><span class="signature">from_cmy(c, m, y, /) -&gt; Color</span></div>
</div>
<p>Creates a Color object from the given CMY components. Refer to <a class="reference internal" href="#pygame.Color.cmy" title="pygame.Color.cmy"><code class="xref py py-attr docutils literal notranslate"><span class="pre">Color.cmy</span></code></a>
...
<dl class="py method definition">
<dt class="sig sig-object py title" id="pygame.Color.from_hsva">
<em class="property"><span class="pre">classmethod</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">from_hsva</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#pygame.Color.from_hsva" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">Returns a Color object from an HSVA representation.</span></div>
<div class="line"><span class="signature">from_hsva(object, /) -&gt; Color</span></div>
<div class="line"><span class="signature">from_hsva(h, s, v, a, /) -&gt; Color</span></div>
</div>
<p>Creates a Color object from the given HSVA components. Refer to <a class="reference internal" href="#pygame.Color.hsva" title="pygame.Color.hsva"><code class="xref py py-attr docutils literal notranslate"><span class="pre">Color.hsva</span></code></a>
for more information.</p>
<div class="versionadded">
<p><span class="versionmodified added">New in pygame-ce 2.3.1.</span></p>
</div>
...
<dl class="py method definition">
<dt class="sig sig-object py title" id="pygame.Color.from_hsla">
<em class="property"><span class="pre">classmethod</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">from_hsla</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#pygame.Color.from_hsla" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">Returns a Color object from an HSLA representation.</span></div>
<div class="line"><span class="signature">from_hsla(object, /) -&gt; Color</span></div>
<div class="line"><span class="signature">from_hsla(h, s, l, a, /) -&gt; Color</span></div>
</div>
<p>Creates a Color object from the given HSLA components. Refer to <a class="reference internal" href="#pygame.Color.hsla" title="pygame.Color.hsla"><code class="xref py py-attr docutils literal notranslate"><span class="pre">Color.hsla</span></code></a>
for more information.</p>
<div class="versionadded">
<p><span class="versionmodified added">New in pygame-ce 2.3.1.</span></p>
</div>
...
<dl class="py method definition">
<dt class="sig sig-object py title" id="pygame.Color.from_i1i2i3">
<em class="property"><span class="pre">classmethod</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">from_i1i2i3</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#pygame.Color.from_i1i2i3" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">Returns a Color object from a I1I2I3 representation.</span></div>
<div class="line"><span class="signature">from_i1i2i3(object, /) -&gt; Color</span></div>
<div class="line"><span class="signature">from_i1i2i3(i1, i2, i3, /) -&gt; Color</span></div>
</div>
<p>Creates a Color object from the given I1I2I3 components. Refer to <a class="reference internal" href="#pygame.Color.i1i2i3" title="pygame.Color.i1i2i3"><code class="xref py py-attr docutils literal notranslate"><span class="pre">Color.i1i2i3</span></code></a>
for more information.</p>
<div class="versionadded">
<p><span class="versionmodified added">New in pygame-ce 2.3.1.</span></p>
</div>
...
<dl class="py method definition">
<dt class="sig sig-object py title" id="pygame.Color.from_normalized">
<em class="property"><span class="pre">classmethod</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">from_normalized</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#pygame.Color.from_normalized" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">Returns a Color object from a Normalized representation.</span></div>
<div class="line"><span class="signature">from_normalized(object, /) -&gt; Color</span></div>
<div class="line"><span class="signature">from_normalized(r, g, b, a, /) -&gt; Color</span></div>
</div>
<p>Creates a Color object from the given Normalized components. Refer to <a class="reference internal" href="#pygame.Color.normalized" title="pygame.Color.normalized"><code class="xref py py-attr docutils literal notranslate"><span class="pre">Color.normalized</span></code></a>
for more information.</p>
<div class="versionadded">
<p><span class="versionmodified added">New in pygame-ce 2.5.0.</span></p>
</div>
...
<dl class="py method definition">
<dt class="sig sig-object py title" id="pygame.Color.from_hex">
<em class="property"><span class="pre">classmethod</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">from_hex</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#pygame.Color.from_hex" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">Returns a Color object from a Hexadecimal representation.</span></div>
<div class="line"><span class="signature">from_hex(hex, /) -&gt; Color</span></div>
</div>
<p>Creates a Color object from the given Hexadecimal components. Refer to <a class="reference internal" href="#pygame.Color.hex" title="pygame.Color.hex"><code class="xref py py-attr docutils literal notranslate"><span class="pre">Color.hex</span></code></a>
for more information.</p>
<div class="versionadded">
...
<div class="line"><span class="signature">normalize() -&gt; tuple[float, float, float, float]</span></div>
</div>
...
<div class="line"><span class="signature">set_length(length, /) -&gt; None</span></div>
</div>
...
<p><span class="versionmodified deprecated">Deprecated since pygame-ce 2.1.3.</span></p>
</div>
...
<div class="line"><span class="signature">lerp(color, amount) -&gt; Color</span></div>
</div>
...
<p>Returns a new Color where each of the red, green and blue color
...
flag for <a class="tooltip reference internal" href="surface.html#pygame.Surface.blit" title=""><code class="xref py py-meth docutils literal notranslate"><span class="pre">pygame.Surface.blit()</span></code><span class="tooltip-content">Draw another Surface onto this one.</span></a>, which assumes that all surfaces using
...
<div class="line"><span class="signature">update(rgbvalue, /) -&gt; None</span></div>
</div>
