...
<html lang="en" data-content_root="../">
  <head>
    ...
    <title>pygame.mouse &#8212; pygame-ce v2.5.8 documentation</title>
...
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="mouse.html#pygame.mouse.get_just_pressed">pygame.mouse.get_just_pressed</a></div>
</td>
<td>—</td>
<td>Get the most recently pressed buttons.</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="mouse.html#pygame.mouse.get_just_released">pygame.mouse.get_just_released</a></div>
</td>
<td>—</td>
<td>Get the most recently released buttons.</td>
</tr>
...
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="mouse.html#pygame.mouse.get_relative_mode">pygame.mouse.get_relative_mode</a></div>
</td>
<td>—</td>
<td>Query whether relative mouse mode is enabled.</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="mouse.html#pygame.mouse.set_relative_mode">pygame.mouse.set_relative_mode</a></div>
</td>
<td>—</td>
<td>Set relative mouse mode.</td>
</tr>
</tbody>
</table>
...
<div class="line"><span class="signature">get_pressed(num_buttons=3, desktop=False) -&gt; tuple[bool, bool, bool]</span></div>
<div class="line"><span class="signature">get_pressed(num_buttons, desktop=False) -&gt; tuple</span></div>
</div>
...
of the call.</p>
<p>To get all of the mouse events it is better to use either
...
<code class="docutils literal notranslate"><span class="pre">MOUSEMOTION</span></code>. Remember to call <code class="docutils literal notranslate"><span class="pre">pygame.event.get()</span></code> or <code class="docutils literal notranslate"><span class="pre">pygame.event.pump()</span></code>
before this function, otherwise it will not work as expected.</p>
...
<p>If the <code class="docutils literal notranslate"><span class="pre">desktop</span></code> argument is <code class="docutils literal notranslate"><span class="pre">True</span></code> the mouse state will be correct even
if the window has no focus. In addition since it queries the OS it does not depend
on the last event pump while being slightly slower.</p>
<div class="admonition note">
<p class="admonition-title">Note</p>
<p>On <code class="docutils literal notranslate"><span class="pre">X11</span></code> some X servers use middle button emulation. When you
...
<p>Due to design constraints it is impossible to retrieve the desktop
mouse state on Wayland. The normal mouse state is returned instead.</p>
</div>
...
<p><span class="versionmodified changed">Changed in pygame-ce 2.5.2: </span>Added the <code class="docutils literal notranslate"><span class="pre">desktop</span></code> argument</p>
</div>
</dd></dl>

<dl class="py function definition">
<dt class="sig sig-object py title" id="pygame.mouse.get_just_pressed">
<span class="sig-prename descclassname"><span class="pre">pygame.mouse.</span></span><span class="sig-name descname"><span class="pre">get_just_pressed</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#pygame.mouse.get_just_pressed" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">Get the most recently pressed buttons.</span></div>
<div class="line"><span class="signature">get_just_pressed() -&gt; tuple</span></div>
</div>
<p>Very similar to <a class="tooltip reference internal" href="#pygame.mouse.get_pressed" title=""><code class="xref py py-func docutils literal notranslate"><span class="pre">pygame.mouse.get_pressed()</span></code><span class="tooltip-content">Get the state of the mouse buttons.</span></a>, returning a tuple
...
and correct ordering prefer using the <code class="docutils literal notranslate"><span class="pre">pygame.MOUSEBUTTONDOWN</span></code> event.</p>
<p>The result of this function is updated when new events are processed,
e.g. in <a class="tooltip reference internal" href="event.html#pygame.event.get" title=""><code class="xref py py-func docutils literal notranslate"><span class="pre">pygame.event.get()</span></code><span class="tooltip-content">get events from the queue</span></a> or <a class="tooltip reference internal" href="event.html#pygame.event.pump" title=""><code class="xref py py-func docutils literal notranslate"><span class="pre">pygame.event.pump()</span></code><span class="tooltip-content">internally process pygame event handlers</span></a>.</p>
<div class="admonition seealso">
<p class="admonition-title">See also</p>
<p><a class="tooltip reference internal" href="#pygame.mouse.get_just_released" title=""><code class="xref py py-func docutils literal notranslate"><span class="pre">pygame.mouse.get_just_released()</span></code><span class="tooltip-content">Get the most recently released buttons.</span></a></p>
</div>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="k">if</span> <span class="n">pygame</span><span class="o">.</span><span class="n">mouse</span><span class="o">.</span><span class="n">get_just_pressed</span><span class="p">()[</span><span class="mi">0</span><span class="p">]:</span>
   <span class="nb">print</span><span class="p">(</span><span class="s2">&quot;LMB just pressed&quot;</span><span class="p">)</span>
</pre></div>
</div>
...
<dl class="py function definition">
<dt class="sig sig-object py title" id="pygame.mouse.get_just_released">
<span class="sig-prename descclassname"><span class="pre">pygame.mouse.</span></span><span class="sig-name descname"><span class="pre">get_just_released</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#pygame.mouse.get_just_released" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">Get the most recently released buttons.</span></div>
<div class="line"><span class="signature">get_just_released() -&gt; tuple</span></div>
</div>
<p>Similar to <a class="tooltip reference internal" href="#pygame.mouse.get_pressed" title=""><code class="xref py py-func docutils literal notranslate"><span class="pre">pygame.mouse.get_pressed()</span></code><span class="tooltip-content">Get the state of the mouse buttons.</span></a>, returning a tuple
of length 5 with the important difference that the buttons are
...
and correct ordering prefer using the <code class="docutils literal notranslate"><span class="pre">pygame.MOUSEBUTTONUP</span></code> event.</p>
<p>The result of this function is updated when new events are processed,
e.g. in <a class="tooltip reference internal" href="event.html#pygame.event.get" title=""><code class="xref py py-func docutils literal notranslate"><span class="pre">pygame.event.get()</span></code><span class="tooltip-content">get events from the queue</span></a> or <a class="tooltip reference internal" href="event.html#pygame.event.pump" title=""><code class="xref py py-func docutils literal notranslate"><span class="pre">pygame.event.pump()</span></code><span class="tooltip-content">internally process pygame event handlers</span></a>.</p>
<div class="admonition seealso">
<p class="admonition-title">See also</p>
<p><a class="tooltip reference internal" href="#pygame.mouse.get_just_pressed" title=""><code class="xref py py-func docutils literal notranslate"><span class="pre">pygame.mouse.get_just_pressed()</span></code><span class="tooltip-content">Get the most recently pressed buttons.</span></a></p>
</div>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="k">if</span> <span class="n">pygame</span><span class="o">.</span><span class="n">mouse</span><span class="o">.</span><span class="n">get_just_released</span><span class="p">()[</span><span class="mi">0</span><span class="p">]:</span>
   <span class="nb">print</span><span class="p">(</span><span class="s2">&quot;LMB just released&quot;</span><span class="p">)</span>
</pre></div>
</div>
<div class="versionadded">
<p><span class="versionmodified added">New in pygame-ce 2.5.0.</span></p>
...
<div class="line"><span class="signature">get_pos(desktop=False) -&gt; tuple[int, int]</span></div>
</div>
<p>By default returns the <code class="docutils literal notranslate"><span class="pre">x</span></code> and <code class="docutils literal notranslate"><span class="pre">y</span></code> position of the mouse cursor. The position
is relative to the top-left corner of the display. The cursor position can be
located outside of the display window, but is always constrained to the screen.</p>
<p>If the <code class="docutils literal notranslate"><span class="pre">desktop</span></code> argument is <code class="docutils literal notranslate"><span class="pre">True</span></code>, the position will be instead relative to the
top-left corner of the primary monitor. The position might be negative or exceed
the desktop bounds if multiple monitors are present.</p>
<div class="admonition warning">
<p class="admonition-title">Warning</p>
<p>Due to design constraints it is impossible to retrieve the desktop
mouse state on Wayland. The relative mouse position is returned instead.</p>
</div>
<div class="versionchanged">
<p><span class="versionmodified changed">Changed in pygame-ce 2.5.2: </span>Added the <code class="docutils literal notranslate"><span class="pre">desktop</span></code> argument</p>
</div>
...
<div class="line"><span class="signature">get_rel() -&gt; tuple[int, int]</span></div>
</div>
...
<div class="line"><span class="signature">set_visible(value, /) -&gt; int</span></div>
</div>
...
<div class="line"><span class="signature">set_cursor(cursor) -&gt; None</span></div>
...
<div class="line"><span class="signature">get_cursor() -&gt; Cursor</span></div>
</div>
...
<dl class="py function definition">
<dt class="sig sig-object py title" id="pygame.mouse.get_relative_mode">
<span class="sig-prename descclassname"><span class="pre">pygame.mouse.</span></span><span class="sig-name descname"><span class="pre">get_relative_mode</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#pygame.mouse.get_relative_mode" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">Query whether relative mouse mode is enabled.</span></div>
<div class="line"><span class="signature">get_relative_mode() -&gt; bool</span></div>
</div>
...
<dl class="py function definition">
<dt class="sig sig-object py title" id="pygame.mouse.set_relative_mode">
<span class="sig-prename descclassname"><span class="pre">pygame.mouse.</span></span><span class="sig-name descname"><span class="pre">set_relative_mode</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#pygame.mouse.set_relative_mode" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">Set relative mouse mode.</span></div>
<div class="line"><span class="signature">set_relative_mode(enable, /) -&gt; None</span></div>
</div>
<p>Sets the relative mouse mode state.
...
mouse is at the edge of the window.</p>
<p><em>This function will flush any pending mouse motion.&quot;</em></p>
<p>Calling <a class="tooltip reference internal" href="#pygame.mouse.set_visible" title=""><code class="xref py py-func docutils literal notranslate"><span class="pre">pygame.mouse.set_visible()</span></code><span class="tooltip-content">Hide or show the mouse cursor.</span></a> with argument
<code class="docutils literal notranslate"><span class="pre">True</span></code> will exit relative mouse mode.</p>
<div class="versionadded">
<p><span class="versionmodified added">New in pygame-ce 2.4.0.</span></p>
</div>
<div class="versionchanged">
<p><span class="versionmodified changed">Changed in pygame-ce 2.5.6: </span>calling this function before calling
<a class="tooltip reference internal" href="display.html#pygame.display.set_mode" title=""><code class="xref py py-func docutils literal notranslate"><span class="pre">pygame.display.set_mode()</span></code><span class="tooltip-content">Initialize a window or screen for display.</span></a> is deprecated and may error in the future.</p>
</div>
</dd></dl>
