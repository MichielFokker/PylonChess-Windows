...
<html lang="en" data-content_root="../">
  <head>
    ...
    <title>API exported by pygame.joystick &#8212; pygame-ce v2.5.8 documentation</title>
...
<section id="api-exported-by-pygame-joystick">
<section id="src-c-joystick-c">
<h2>src_c/joystick.c<a class="headerlink" href="#src-c-joystick-c" title="Link to this heading">¶</a></h2>
<p>The extension module <a class="tooltip reference internal" href="../ref/joystick.html#module-pygame.joystick" title=""><code class="xref py py-mod docutils literal notranslate"><span class="pre">pygame.joystick</span></code><span class="tooltip-content">Pygame module for interacting with joysticks, gamepads, and trackballs.</span></a>.</p>
<p>Header file: src_c/include/pygame.h</p>
<dl class="c var">
<dt class="sig sig-object c" id="c.pgJoystick_Type">
<span class="n"><span class="pre">PyTypeObject</span></span><span class="w"> </span><span class="p"><span class="pre">*</span></span><span class="sig-name descname"><span class="n"><span class="pre">pgJoystick_Type</span></span></span><a class="headerlink" href="#c.pgJoystick_Type" title="Link to this definition">¶</a><br /></dt>
<dd><p>The Pygame joystick object type <code class="xref py py-class docutils literal notranslate"><span class="pre">pygame.Joystick</span></code>.</p>
</dd></dl>

<dl class="c function">
<dt class="sig sig-object c" id="c.pgJoystick_New">
<span class="n"><span class="pre">PyObject</span></span><span class="w"> </span><span class="p"><span class="pre">*</span></span><span class="sig-name descname"><span class="n"><span class="pre">pgJoystick_New</span></span></span><span class="sig-paren">(</span><span class="kt"><span class="pre">int</span></span><span class="w"> </span><span class="n"><span class="pre">id</span></span><span class="sig-paren">)</span><a class="headerlink" href="#c.pgJoystick_New" title="Link to this definition">¶</a><br /></dt>
<dd><p>Return a new <code class="xref py py-class docutils literal notranslate"><span class="pre">pygame.Joystick</span></code> instance.
On failure, raise a Python exception and return <code class="docutils literal notranslate"><span class="pre">NULL</span></code>.</p>
</dd></dl>

<dl class="c function">
<dt class="sig sig-object c" id="c.pgJoystick_GetDeviceIndexByInstanceID">
<span class="kt"><span class="pre">int</span></span><span class="w"> </span><span class="sig-name descname"><span class="n"><span class="pre">pgJoystick_GetDeviceIndexByInstanceID</span></span></span><span class="sig-paren">(</span><span class="kt"><span class="pre">int</span></span><span class="w"> </span><span class="n"><span class="pre">instance_id</span></span><span class="sig-paren">)</span><a class="headerlink" href="#c.pgJoystick_GetDeviceIndexByInstanceID" title="Link to this definition">¶</a><br /></dt>
<dd><p>Get the device index of a joystick by a instance id.
Return a device index.
On failure, it returns -1.</p>
</dd></dl>
...
<br /><br />
<hr />
<a href="https://github.com/pygame-community/pygame-ce/edit/main/docs/reST/c_api\joystick.rst" rel="nofollow">Edit on GitHub</a>
    ...
    <div class="related" role="navigation" aria-label="Related">
      ...
      <ul>
        ...
        <li class="nav-item nav-item-this"><a href="">API exported by pygame.joystick</a></li> 
      </ul>
    </div>
