...
<html lang="en" data-content_root="../">
  <head>
    ...
    <title>pygame.time &#8212; pygame-ce v2.5.8 documentation</title>
...
<p>Provides utilities for monitoring time, delaying time, and maintaining a
constant frame rate.
Times in pygame-ce are represented in milliseconds (1/1000 of a second).</p>
...
<div class="line"><span class="signature">get_ticks() -&gt; int</span></div>
</div>
...
<div class="line"><span class="signature">wait(milliseconds, /) -&gt; int</span></div>
</div>
...
<dd><div class="line-block">
<div class="line"><span class="summaryline">Pause the program for an amount of time.</span></div>
<div class="line"><span class="signature">delay(milliseconds, /) -&gt; int</span></div>
</div>
...
<p>The <code class="docutils literal notranslate"><span class="pre">event</span></code> parameter can be a <code class="docutils literal notranslate"><span class="pre">pygame.event.Event</span></code> object or an integer
...
event type.</p>
<p>When this function is called with an <code class="docutils literal notranslate"><span class="pre">Event</span></code> object, the event(s) received
...
on the queue that don't have a common dict reference.</p>
<p>This function is not supported on web (WASM/Emscripten) builds.</p>
...
<p><span class="versionmodified changed">Changed in pygame-ce 2.1.4: </span>This class is also available through the <code class="docutils literal notranslate"><span class="pre">pygame.Clock</span></code>
alias.</p>
</div>
...
<div class="line"><span class="signature">tick(framerate=0, /) -&gt; int</span></div>
</div>
...
the framerate.</p>
<p>Note that this function uses <code class="docutils literal notranslate"><span class="pre">SDL_Delay</span></code>, which is not accurate on
...
<dd><div class="line-block">
<div class="line"><span class="summaryline">Update the clock.</span></div>
<div class="line"><span class="signature">tick_busy_loop(framerate=0, /) -&gt; int</span></div>
</div>
<p>This method should be called once per frame. It will compute how many
milliseconds have passed since the previous call.</p>
<p>If you pass the optional framerate argument the function will delay to
...
<div class="line"><span class="signature">get_time() -&gt; int</span></div>
</div>
...
<div class="line"><span class="signature">get_rawtime() -&gt; int</span></div>
</div>
...
averaging the last ten calls to <code class="docutils literal notranslate"><span class="pre">Clock.tick()</span></code>. Returns 0.0 if fewer
than ten ticks have been made.</p>
</dd></dl>
