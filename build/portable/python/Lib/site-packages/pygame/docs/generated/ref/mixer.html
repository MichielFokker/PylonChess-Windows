...
<html lang="en" data-content_root="../">
  <head>
    ...
    <title>pygame.mixer &#8212; pygame-ce v2.5.8 documentation</title>
...
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="mixer.html#pygame.mixer.get_driver">pygame.mixer.get_driver</a></div>
</td>
<td>—</td>
<td>get the name of the current audio backend driver</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="mixer.html#pygame.mixer.stop">pygame.mixer.stop</a></div>
</td>
<td>—</td>
<td>stop playback of all sound channels</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="mixer.html#pygame.mixer.pause">pygame.mixer.pause</a></div>
</td>
<td>—</td>
<td>temporarily stop playback of all sound channels</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="mixer.html#pygame.mixer.unpause">pygame.mixer.unpause</a></div>
</td>
<td>—</td>
<td>resume paused playback of sound channels</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="mixer.html#pygame.mixer.fadeout">pygame.mixer.fadeout</a></div>
</td>
<td>—</td>
<td>fade out the volume on all sounds before stopping</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="mixer.html#pygame.mixer.set_num_channels">pygame.mixer.set_num_channels</a></div>
</td>
<td>—</td>
<td>set the total number of playback channels</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="mixer.html#pygame.mixer.get_num_channels">pygame.mixer.get_num_channels</a></div>
</td>
<td>—</td>
<td>get the total number of playback channels</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="mixer.html#pygame.mixer.set_reserved">pygame.mixer.set_reserved</a></div>
</td>
<td>—</td>
<td>reserve channels from being automatically used</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="mixer.html#pygame.mixer.find_channel">pygame.mixer.find_channel</a></div>
</td>
<td>—</td>
<td>find an unused channel</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="mixer.html#pygame.mixer.set_soundfont">pygame.mixer.set_soundfont</a></div>
</td>
<td>—</td>
<td>set the soundfont for playing midi music</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="mixer.html#pygame.mixer.get_soundfont">pygame.mixer.get_soundfont</a></div>
</td>
<td>—</td>
<td>get the soundfont for playing midi music</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="mixer.html#pygame.mixer.get_busy">pygame.mixer.get_busy</a></div>
</td>
<td>—</td>
<td>test if any sound is being mixed</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="mixer.html#pygame.mixer.get_sdl_mixer_version">pygame.mixer.get_sdl_mixer_version</a></div>
</td>
<td>—</td>
<td>get the mixer's SDL version</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="mixer.html#pygame.mixer.Sound">pygame.mixer.Sound</a></div>
</td>
<td>—</td>
<td>Create a new Sound object from a file or buffer object</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="mixer.html#pygame.mixer.Channel">pygame.mixer.Channel</a></div>
</td>
<td>—</td>
...
arguments to control the playback rate and sample size.</p>
...
<blockquote>
<div><ul class="simple">
<li><p><code class="docutils literal notranslate"><span class="pre">WAV</span></code></p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">MP3</span></code></p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">OGG</span></code></p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">FLAC</span></code></p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">OPUS</span></code></p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">WV</span></code> (WavPack)</p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">MOD</span></code> (&quot;Module file&quot; family of music file formats)</p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">MIDI</span></code> (see the <a class="reference internal" href="#pygame.mixer.get_soundfont" title="pygame.mixer.get_soundfont"><code class="xref py py-func docutils literal notranslate"><span class="pre">get_soundfont()</span></code></a> and <a class="reference internal" href="#pygame.mixer.set_soundfont" title="pygame.mixer.set_soundfont"><code class="xref py py-func docutils literal notranslate"><span class="pre">set_soundfont()</span></code></a> methods)</p></li>
</ul>
</div></blockquote>
<div class="versionadded">
<p><span class="versionmodified added">New in pygame-ce 2.5.0: </span>Loading WV (Relies on SDL_mixer 2.8.0+)</p>
</div>
...
<code class="docutils literal notranslate"><span class="pre">NOTE</span></code>: The channels argument is not related to the number
of channels for playback of sounds, that you can get with the function
&quot;get_num_channels&quot; or set with the function &quot;set_num_channels&quot; (see below).</p>
...
<p>The devicename parameter is the name of sound device to open for audio
playback. Allowed device names will vary based on the host system.
If left as <code class="docutils literal notranslate"><span class="pre">None</span></code> then a sensible default will be chosen for you.</p>
...
change to the closest that SDL supports.</p>
...
<div class="line"><span class="signature">get_init() -&gt; (frequency, format, channels) | None</span></div>
</div>
...
<dl class="py function definition">
<dt class="sig sig-object py title" id="pygame.mixer.get_driver">
<span class="sig-prename descclassname"><span class="pre">pygame.mixer.</span></span><span class="sig-name descname"><span class="pre">get_driver</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#pygame.mixer.get_driver" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">get the name of the current audio backend driver</span></div>
<div class="line"><span class="signature">get_driver() -&gt; str</span></div>
</div>
<p>Pygame chooses one of many available audio backend drivers when it is
...
This can be controlled with <code class="docutils literal notranslate"><span class="pre">SDL_AUDIODRIVER</span></code> environment variable.</p>
<div class="versionadded">
...
<p>Sets the number of available playback channels for the mixer. The default value is 8.
...
<div class="line"><span class="signature">find_channel(force=False) -&gt; Channel | None</span></div>
</div>
...
<dl class="py function definition">
<dt class="sig sig-object py title" id="pygame.mixer.set_soundfont">
<span class="sig-prename descclassname"><span class="pre">pygame.mixer.</span></span><span class="sig-name descname"><span class="pre">set_soundfont</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#pygame.mixer.set_soundfont" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">set the soundfont for playing midi music</span></div>
<div class="line"><span class="signature">set_soundfont(path, /) -&gt; None</span></div>
</div>
<p>This sets the soundfont file to be used in the playback of midi music.
The soundfont only affects the playback of <code class="docutils literal notranslate"><span class="pre">MID</span></code>, <code class="docutils literal notranslate"><span class="pre">MIDI</span></code>, and <code class="docutils literal notranslate"><span class="pre">KAR</span></code> file formats.
The optional <code class="docutils literal notranslate"><span class="pre">path</span></code> argument, a string (or multiple strings separated by a semi-colon),
must point to the soundfont file(s) to be searched for in order given if some
are missing. If <code class="docutils literal notranslate"><span class="pre">path</span></code> is an empty string or the default (<code class="docutils literal notranslate"><span class="pre">None</span></code>), any specified soundfont paths
will be cleared from the mixer.</p>
<p>Note on Windows, the mixer always uses the built-in soundfont instead of the one specified.</p>
<p>Function <a class="reference internal" href="#pygame.mixer.set_soundfont" title="pygame.mixer.set_soundfont"><code class="xref py py-func docutils literal notranslate"><span class="pre">set_soundfont()</span></code></a> calls underlying SDL_mixer function
<code class="docutils literal notranslate"><span class="pre">Mix_SetSoundFonts</span></code>.</p>
<div class="versionadded">
...
<dl class="py function definition">
<dt class="sig sig-object py title" id="pygame.mixer.get_soundfont">
<span class="sig-prename descclassname"><span class="pre">pygame.mixer.</span></span><span class="sig-name descname"><span class="pre">get_soundfont</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#pygame.mixer.get_soundfont" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">get the soundfont for playing midi music</span></div>
<div class="line"><span class="signature">get_soundfont() -&gt; paths</span></div>
</div>
<p>This gets the soundfont filepaths as a string (each path is separated by a semi-colon)
to be used in the playback of <code class="docutils literal notranslate"><span class="pre">MID</span></code>, <code class="docutils literal notranslate"><span class="pre">MIDI</span></code>, and <code class="docutils literal notranslate"><span class="pre">KAR</span></code> music file formats. If no
soundfont is specified, the return type is <code class="docutils literal notranslate"><span class="pre">None</span></code>.</p>
<p>Function <a class="reference internal" href="#pygame.mixer.get_soundfont" title="pygame.mixer.get_soundfont"><code class="xref py py-func docutils literal notranslate"><span class="pre">get_soundfont()</span></code></a> calls underlying SDL_mixer function
<code class="docutils literal notranslate"><span class="pre">Mix_GetSoundFonts</span></code>.</p>
<div class="versionadded">
<p><span class="versionmodified added">New in pygame-ce 2.3.1.</span></p>
</div>
</dd></dl>
...
idle or uninitialized then this returns <code class="docutils literal notranslate"><span class="pre">False</span></code>.</p>
</dd></dl>
...
<p>The linked and compiled version numbers should be the same.</p>
</div>
<div class="versionaddedold">
...
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="mixer.html#pygame.mixer.Sound.copy">pygame.mixer.Sound.copy</a></div>
</td>
<td>—</td>
<td>return a new Sound object that is a deep copy of this Sound</td>
</tr>
</tbody>
</table>
...
<div class="admonition note">
<p class="admonition-title">Note</p>
<p><code class="docutils literal notranslate"><span class="pre">bytes(Sound)</span></code> and <code class="docutils literal notranslate"><span class="pre">bytearray(Sound)</span></code> make use of the buffer
interface, which is implemented internally by <code class="docutils literal notranslate"><span class="pre">pygame.mixer.Sound</span></code>.
Because of this, there is no need to directly implement <code class="docutils literal notranslate"><span class="pre">__bytes__</span></code>.</p>
</div>
<div class="versionaddedold">
...
<p><span class="versionmodified changed">Changed in pygame-ce 2.5.2: </span>This class is also available through the <code class="docutils literal notranslate"><span class="pre">pygame.Sound</span></code>
alias.</p>
</div>
...
<div class="admonition note">
<p class="admonition-title">Note</p>
<p>The values are internally converted and kept as integer values in range [0, 128], which means
that <code class="docutils literal notranslate"><span class="pre">get_volume()</span></code> may return a different volume than it was set to. For example,</p>
<div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">sound</span><span class="o">.</span><span class="n">set_volume</span><span class="p">(</span><span class="mf">0.1</span><span class="p">)</span>
<span class="gp">&gt;&gt;&gt; </span><span class="n">sound</span><span class="o">.</span><span class="n">get_volume</span><span class="p">()</span>
<span class="go">0.09375</span>
</pre></div>
</div>
<p>This is because when you <code class="docutils literal notranslate"><span class="pre">set_volume(0.1)</span></code>, the volume is internally calculated like so</p>
<div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="nb">int</span><span class="p">(</span><span class="mf">0.1</span> <span class="o">*</span> <span class="mi">128</span><span class="p">)</span>
<span class="go">12</span>
</pre></div>
</div>
<p>This means that some of the precision is lost, so when you retrieve it again using <code class="docutils literal notranslate"><span class="pre">get_volume()</span></code>,
it is converted back to a <code class="docutils literal notranslate"><span class="pre">float</span></code> using that integer</p>
<div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="mi">12</span> <span class="o">/</span> <span class="mi">128</span>
<span class="go">0.09375</span>
</pre></div>
</div>
</div>
...
<p>Return a value from 0.0 to 1.0 (inclusive) representing the volume for this Sound.</p>
<div class="admonition note">
<p class="admonition-title">Note</p>
<p>See <a class="reference internal" href="#pygame.mixer.Sound.set_volume" title="pygame.mixer.Sound.set_volume"><code class="xref py py-func docutils literal notranslate"><span class="pre">Sound.set_volume()</span></code></a> for more information regarding the returned value</p>
</div>
</dd></dl>
...
<dl class="py method definition">
<dt class="sig sig-object py title" id="pygame.mixer.Sound.copy">
<span class="sig-name descname"><span class="pre">copy</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#pygame.mixer.Sound.copy" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">return a new Sound object that is a deep copy of this Sound</span></div>
<div class="line"><span class="signature">copy() -&gt; Sound</span></div>
<div class="line"><span class="signature">copy.copy(original_sound) -&gt; Sound</span></div>
</div>
<p>Return a new Sound object that is a deep copy of this Sound. The new Sound
will be just as if you loaded it from the same file on disk as you did the
original Sound. If the copy fails, a <code class="docutils literal notranslate"><span class="pre">TypeError</span></code> or <a class="tooltip reference internal" href="pygame.html#pygame.error" title=""><code class="xref py py-meth docutils literal notranslate"><span class="pre">pygame.error()</span></code><span class="tooltip-content">standard pygame exception</span></a>
exception will be raised.</p>
<p>If copying a subclass of <code class="docutils literal notranslate"><span class="pre">mixer.Sound</span></code>, an instance of the same subclass
will be returned.</p>
<p>Also note that this functions as <code class="docutils literal notranslate"><span class="pre">Sound.__copy__</span></code>.</p>
<div class="versionadded">
...
<table class="toc docutils align-default">
<tbody>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="mixer.html#pygame.mixer.Channel.id">pygame.mixer.Channel.id</a></div>
</td>
<td>—</td>
<td>get the channel id for the Channel object</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="mixer.html#pygame.mixer.Channel.play">pygame.mixer.Channel.play</a></div>
</td>
<td>—</td>
<td>play a Sound on a specific Channel</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="mixer.html#pygame.mixer.Channel.stop">pygame.mixer.Channel.stop</a></div>
</td>
<td>—</td>
<td>stop playback on a Channel</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="mixer.html#pygame.mixer.Channel.pause">pygame.mixer.Channel.pause</a></div>
</td>
<td>—</td>
<td>temporarily stop playback of a channel</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="mixer.html#pygame.mixer.Channel.unpause">pygame.mixer.Channel.unpause</a></div>
</td>
<td>—</td>
<td>resume pause playback of a channel</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="mixer.html#pygame.mixer.Channel.fadeout">pygame.mixer.Channel.fadeout</a></div>
</td>
<td>—</td>
<td>stop playback after fading channel out</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="mixer.html#pygame.mixer.Channel.set_source_location">pygame.mixer.Channel.set_source_location</a></div>
</td>
<td>—</td>
<td>set the position of a playing channel</td>
</tr>
...
value from 0 up to, but not including, <code class="docutils literal notranslate"><span class="pre">pygame.mixer.get_num_channels()</span></code>.</p>
...
<div class="versionchanged">
<p><span class="versionmodified changed">Changed in pygame-ce 2.1.4: </span>This class is also available through the <code class="docutils literal notranslate"><span class="pre">pygame.Channel</span></code>
alias.</p>
</div>
<div class="versionchanged">
<p><span class="versionmodified changed">Changed in pygame-ce 2.4.0: </span>It is now possible to create subclasses of <code class="docutils literal notranslate"><span class="pre">pygame.mixer.Channel</span></code></p>
</div>
<dl class="py attribute definition">
<dt class="sig sig-object py title" id="pygame.mixer.Channel.id">
<span class="sig-name descname"><span class="pre">id</span></span><a class="headerlink" href="#pygame.mixer.Channel.id" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">get the channel id for the Channel object</span></div>
<div class="line"><span class="signature">id -&gt; int</span></div>
</div>
<p>This simply returns the channel id used to create the <code class="docutils literal notranslate"><span class="pre">Channel</span></code> instance
as a read-only attribute</p>
<div class="versionadded">
...
<dl class="py method definition">
<dt class="sig sig-object py title" id="pygame.mixer.Channel.set_source_location">
<span class="sig-name descname"><span class="pre">set_source_location</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#pygame.mixer.Channel.set_source_location" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">set the position of a playing channel</span></div>
<div class="line"><span class="signature">set_source_location(angle, distance, /) -&gt; None</span></div>
</div>
<p>Set the position (angle, distance) of a playing channel.</p>
<p><cite>angle</cite>: Angle in degrees.</p>
<p><cite>distance</cite>: Range from 0 to 255.</p>
<div class="admonition warning">
<p class="admonition-title">Warning</p>
<p>This function currently fails and raises a
<a class="tooltip reference internal" href="pygame.html#pygame.error" title=""><code class="xref py py-exc docutils literal notranslate"><span class="pre">pygame.error</span></code><span class="tooltip-content">standard pygame exception</span></a> when using 7.1 surround sound.
...
this function.</p>
<p>One way of avoiding this is only using <a class="reference internal" href="#pygame.mixer.Channel.set_source_location" title="pygame.mixer.Channel.set_source_location"><code class="xref py py-func docutils literal notranslate"><span class="pre">set_source_location()</span></code></a>
with forced stereo. For example:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">pygame</span><span class="o">.</span><span class="n">mixer</span><span class="o">.</span><span class="n">pre_init</span><span class="p">(</span>
   <span class="n">channels</span><span class="o">=</span><span class="mi">2</span><span class="p">,</span>
   <span class="n">allowedchanges</span><span class="o">=</span><span class="n">pygame</span><span class="o">.</span><span class="n">AUDIO_ALLOW_FREQUENCY_CHANGE</span><span class="p">,</span>
<span class="p">)</span>
...
value argument is in the range of 0.0 to 1.0 (inclusive).</p>
...
<div class="admonition note">
<p class="admonition-title">Note</p>
<p>See <a class="reference internal" href="#pygame.mixer.Sound.set_volume" title="pygame.mixer.Sound.set_volume"><code class="xref py py-func docutils literal notranslate"><span class="pre">Sound.set_volume()</span></code></a> for more information regarding how the value is stored internally</p>
</div>
</dd></dl>
...
<p>Return the volume of the channel for the current playing sound
...
<div class="line"><span class="signature">get_sound() -&gt; Sound | None</span></div>
</div>
...
<div class="line"><span class="signature">get_queue() -&gt; Sound | None</span></div>
</div>
