...
<html lang="en" data-content_root="../">
  <head>
    ...
    <title>pygame.PixelArray &#8212; pygame-ce v2.5.8 documentation</title>
...
<p>When assigning to a range of pixels, a non tuple sequence of colors or
...
<p><span class="versionmodified changed">Changed in pygame-ce 2.5.8: </span>Fixed incorrect color matching and writing on 24-bit surfaces whose
byte layout did not match the platform default.</p>
</div>
