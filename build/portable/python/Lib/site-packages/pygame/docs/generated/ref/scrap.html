...
<html lang="en" data-content_root="../">
  <head>
    ...
    <title>pygame.scrap &#8212; pygame-ce v2.5.8 documentation</title>
...
<tbody>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="scrap.html#pygame.scrap.put_text">pygame.scrap.put_text</a></div>
</td>
<td>—</td>
<td>Places text into the clipboard.</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="scrap.html#pygame.scrap.get_text">pygame.scrap.get_text</a></div>
</td>
<td>—</td>
<td>Gets text from the clipboard.</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="scrap.html#pygame.scrap.has_text">pygame.scrap.has_text</a></div>
</td>
<td>—</td>
<td>Checks if text is in the clipboard.</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="scrap.html#pygame.scrap.init">pygame.scrap.init</a></div>
</td>
<td>—</td>
<td>Initializes the scrap module.</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="scrap.html#pygame.scrap.get_init">pygame.scrap.get_init</a></div>
</td>
<td>—</td>
<td>Returns True if the scrap module is currently initialized.</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="scrap.html#pygame.scrap.get">pygame.scrap.get</a></div>
</td>
<td>—</td>
<td>Gets the data for the specified type from the clipboard.</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="scrap.html#pygame.scrap.get_types">pygame.scrap.get_types</a></div>
</td>
<td>—</td>
<td>Gets a list of the available clipboard types.</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="scrap.html#pygame.scrap.put">pygame.scrap.put</a></div>
</td>
<td>—</td>
<td>Places data into the clipboard.</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="scrap.html#pygame.scrap.contains">pygame.scrap.contains</a></div>
</td>
<td>—</td>
<td>Checks whether data for a given type is available in the clipboard.</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="scrap.html#pygame.scrap.lost">pygame.scrap.lost</a></div>
</td>
<td>—</td>
<td>Indicates if the clipboard ownership has been lost by the pygame application.</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="scrap.html#pygame.scrap.set_mode">pygame.scrap.set_mode</a></div>
</td>
<td>—</td>
...
<p>The scrap module is for transferring data to/from the clipboard. This allows for
transferring of strings between pygame and other applications. Currently, only strings
are supported with the <code class="docutils literal notranslate"><span class="pre">scrap.put_text</span></code>, <code class="docutils literal notranslate"><span class="pre">scrap.get_text</span></code>, and <code class="docutils literal notranslate"><span class="pre">scrap.has_text</span></code>
functions. All other functions are deprecated as of pygame 2.2.0 and will be removed
in a future release of pygame.</p>
<div class="admonition note">
<p class="admonition-title">Note</p>
<p><code class="docutils literal notranslate"><span class="pre">scrap.put_text</span></code>, <code class="docutils literal notranslate"><span class="pre">scrap.get_text</span></code>, and <code class="docutils literal notranslate"><span class="pre">scrap.has_text</span></code> use the same
clipboard as the rest of the current API, but only strings are compatible with the
new API as of right now.</p>
</div>
<dl class="py function definition">
<dt class="sig sig-object py title" id="pygame.scrap.put_text">
<span class="sig-prename descclassname"><span class="pre">pygame.scrap.</span></span><span class="sig-name descname"><span class="pre">put_text</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#pygame.scrap.put_text" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">Places text into the clipboard.</span></div>
<div class="line"><span class="signature">put_text(text, /) -&gt; None</span></div>
</div>
<p>Places the input text into the clipboard. The data should be a string.
This is the same clipboard as the legacy scrap API when using <code class="docutils literal notranslate"><span class="pre">SCRAP_TEXT</span></code>.</p>
<dl class="field-list simple">
<dt class="field-odd">Raises<span class="colon">:</span></dt>
<dd class="field-odd"><p><a class="tooltip reference internal" href="pygame.html#pygame.error" title=""><strong>pygame.error</strong><span class="tooltip-content">standard pygame exception</span></a> -- if video mode has not been set_mode</p>
</dd>
</dl>
<div class="admonition note">
<p class="admonition-title">Note</p>
<p><code class="docutils literal notranslate"><span class="pre">pygame.display.set_mode()</span></code> should be called before using the <code class="docutils literal notranslate"><span class="pre">scrap</span></code> module</p>
</div>
...
<dl class="py function definition">
<dt class="sig sig-object py title" id="pygame.scrap.get_text">
<span class="sig-prename descclassname"><span class="pre">pygame.scrap.</span></span><span class="sig-name descname"><span class="pre">get_text</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#pygame.scrap.get_text" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">Gets text from the clipboard.</span></div>
<div class="line"><span class="signature">get_text() -&gt; str</span></div>
</div>
<p>Gets text from the clipboard and returns it. If the clipboard is empty,
returns an empty string. This is the same clipboard as the legacy scrap
API when using <code class="docutils literal notranslate"><span class="pre">SCRAP_TEXT</span></code>.</p>
<div class="versionadded">
<p><span class="versionmodified added">New in pygame-ce 2.2.0.</span></p>
</div>
</dd></dl>
...
<dl class="py function definition">
<dt class="sig sig-object py title" id="pygame.scrap.has_text">
<span class="sig-prename descclassname"><span class="pre">pygame.scrap.</span></span><span class="sig-name descname"><span class="pre">has_text</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#pygame.scrap.has_text" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">Checks if text is in the clipboard.</span></div>
<div class="line"><span class="signature">has_text() -&gt; bool</span></div>
</div>
<p>Returns <code class="docutils literal notranslate"><span class="pre">True</span></code> if the clipboard has a string, otherwise returns <code class="docutils literal notranslate"><span class="pre">False</span></code>.
This is the same clipboard as the legacy scrap API when using <code class="docutils literal notranslate"><span class="pre">SCRAP_TEXT</span></code>.</p>
<div class="versionadded">
<p><span class="versionmodified added">New in pygame-ce 2.2.0.</span></p>
</div>
...
<p><strong>THE BELOW INFORMATION IS DEPRECATED IN PYGAME 2.2.0 AND WILL BE REMOVED IN THE FUTURE.</strong></p>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="s2">&quot;text/plain&quot;</span>                 <span class="n">Plain</span> <span class="n">text</span> <span class="p">(</span><span class="n">also</span> <span class="n">accessible</span> <span class="n">via</span> <span class="n">the</span> <span class="n">SCRAP_TEXT</span> <span class="n">constant</span><span class="p">)</span>
<span class="s2">&quot;text/plain;charset=utf-8&quot;</span>   <span class="n">UTF</span><span class="o">-</span><span class="mi">8</span> <span class="n">encoded</span> <span class="n">text</span>
</pre></div>
</div>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="s2">&quot;image/bmp&quot;</span>                  <span class="n">BMP</span> <span class="n">encoded</span> <span class="n">image</span> <span class="n">data</span> <span class="p">(</span><span class="n">also</span> <span class="n">accessible</span> <span class="n">via</span> <span class="n">the</span> <span class="n">SCRAP_BMP</span> <span class="n">constant</span><span class="p">)</span>
...
<p>User defined types can be used on <strong>Windows</strong>, but the data might not be
...
<div class="admonition note">
<p class="admonition-title">Note</p>
<p>Non-text data is only supported on Windows. On other platforms only text is supported.</p>
</div>
<dl class="py function definition">
...
<p><span class="versionmodified deprecated">Deprecated since pygame-ce 2.2.0.</span></p>
</div>
</dd></dl>
...
<code class="docutils literal notranslate"><span class="pre">pygame.SCRAP_BMP</span></code> or <code class="docutils literal notranslate"><span class="pre">pygame.SCRAP_TEXT</span></code> values or a user defined
string identifier.</p>
<dl class="field-list simple">
<dt class="field-odd">Parameters<span class="colon">:</span></dt>
