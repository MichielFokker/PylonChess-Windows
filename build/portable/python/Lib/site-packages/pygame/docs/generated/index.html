...
<html lang="en" data-content_root="./">
  <head>
    ...
    <title>Pygame-ce Front Page &#8212; pygame-ce v2.5.8 documentation</title>
...
<section id="pygame-ce-front-page">
<h1>Pygame-ce Front Page<a class="headerlink" href="#pygame-ce-front-page" title="Link to this heading">¶</a></h1>
<div class="toctree-wrapper compound">
</div>
<section id="quick-start">
<h2>Quick start<a class="headerlink" href="#quick-start" title="Link to this heading">¶</a></h2>
<p>Welcome to pygame-ce! Once you've got pygame-ce installed
(<code class="code docutils literal notranslate"><span class="pre">pip</span> <span class="pre">install</span> <span class="pre">pygame-ce</span></code> or <code class="code docutils literal notranslate"><span class="pre">pip3</span> <span class="pre">install</span> <span class="pre">pygame-ce</span></code> for most
...
section below, or reference the API documentation by module.</p>
</section>
<section id="experimental-modules">
<h2>Experimental modules<a class="headerlink" href="#experimental-modules" title="Link to this heading">¶</a></h2>
<p>Experimental modules are work in progress, this is why you should refrain from relying on any features
...
them, this is how you can do it:</p>
<div class="highlight-python notranslate"><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">pygame</span><span class="w"> </span><span class="kn">import</span> <span class="n">experimental_module</span>
<span class="c1"># Or for specific modules like _sdl2.controller</span>
<span class="kn">from</span><span class="w"> </span><span class="nn">pygame._sdl2</span><span class="w"> </span><span class="kn">import</span> <span class="n">controller</span>
<span class="c1"># Or</span>
<span class="kn">import</span><span class="w"> </span><span class="nn">pygame.experimental_module</span>
</pre></div>
</div>
<p>Don't forget to report us any problem with the experimental features on <a class="reference external" href="https://github.com/pygame-community/pygame-ce">github</a> so we can easily
turn them to stable API in the future ^^.</p>
<p><strong>Below is currently the list of experimental modules :</strong></p>
<dl class="simple">
<dt><a class="reference internal" href="ref/geometry.html"><span class="doc">pygame.geometry</span></a></dt><dd><p>Pygame module for the Circle, Line, and Polygon objects.</p>
</dd>
<dt><a class="reference internal" href="ref/sdl2_controller.html"><span class="doc">pygame._sdl2.controller</span></a></dt><dd><p>Pygame module to work with controllers.</p>
</dd>
<dt><a class="reference internal" href="ref/sdl2_video.html"><span class="doc">pygame.sdl2_video</span></a></dt><dd><p>Pygame module for porting new SDL video systems.</p>
</dd>
</dl>
</section>
...
<dl class="simple">
<dt><a class="reference external" href="https://github.com/pygame-community/pygame-ce#readme">Readme</a></dt><dd><p>Basic information about pygame: what it is, who is involved, and where to find it.</p>
</dd>
...
<div class="line"><a class="reference external" href="https://www.youtube.com/watch?v=8OMghdHP-zs">Master Python by making 5 games [the new ultimate introduction to pygame]</a></div>
<div class="line-block">
<div class="line">YouTube video by Clear Code.</div>
</div>
</div>
<div class="line-block">
<div class="line"><a class="reference external" href="https://www.youtube.com/watch?v=blLLtdv4tvo">Pygame in 18 Minutes</a></div>
<div class="line-block">
<div class="line">YouTube video by DaFluffyPotato.</div>
</div>
</div>
<div class="line-block">
<div class="line"><a class="reference external" href="https://github.com/adamsralf/pygame_book/blob/main/00%20pygamece.pdf">Introduction to Pygame-ce, 2D game programming</a></div>
<div class="line-block">
<div class="line">Book by Ralf Adams.</div>
</div>
</div>
<dl class="simple">
<dt><a class="reference internal" href="tutorials/en/newbie-guide.html"><span class="doc">Newbie Guide</span></a></dt><dd><p>A list of thirteen helpful tips for people to get comfortable using pygame.</p>
</dd>
<dt><a class="reference internal" href="tutorials/en/import-init.html"><span class="doc">Import and Initialize</span></a></dt><dd><p>The beginning steps on importing and initializing pygame.
The pygame package is made of several modules.
Some modules are not included on all platforms.</p>
</dd>
<dt><a class="reference internal" href="tutorials/en/move-it.html"><span class="doc">How do I move an Image?</span></a></dt><dd><p>A basic tutorial that covers the concepts behind 2D computer animation.
Information about drawing and clearing objects to make them appear animated.</p>
</dd>
<dt><a class="reference internal" href="tutorials/en/chimp-explanation.html"><span class="doc">Chimp Tutorial, Line by Line</span></a></dt><dd><p>The pygame examples include a simple program with an interactive fist and a chimpanzee.
...
<dt><a class="reference internal" href="tutorials/en/premultiplied-alpha.html"><span class="doc">What is Premultiplied Alpha?</span></a></dt><dd><p>An explanation of alpha compositing and the advantages of using premultiplied alpha.</p>
</dd>
<dt><a class="reference internal" href="tutorials/en/intro-to-sprites.html"><span class="doc">Sprite Module Introduction</span></a></dt><dd><p>Pygame includes a higher level sprite module to help organize games.
...
<dt><a class="reference internal" href="tutorials/en/intro-to-pygame.html"><span class="doc">Introduction to Pygame</span></a></dt><dd><p>An introduction to the basics of pygame.
This is written for users of Python and appeared in volume two of the Py magazine.</p>
</dd>
<dt><a class="reference internal" href="tutorials/en/intro-to-surfarray.html"><span class="doc">Surfarray Introduction</span></a></dt><dd><p>Pygame used the NumPy python module to allow efficient per pixel effects on images.
...
<dt><a class="reference internal" href="tutorials/en/intro-to-camera.html"><span class="doc">Camera Module Introduction</span></a></dt><dd><p>Pygame, as of 1.9, has a camera module that allows you to capture images,
watch live streams, and do some basic computer vision.
This tutorial covers those use cases.</p>
</dd>
<dt><a class="reference internal" href="tutorials/en/make-games.html"><span class="doc">Making Games Tutorial</span></a></dt><dd><p>A large tutorial that covers the bigger topics needed to create an entire game.</p>
</dd>
<dt><a class="reference internal" href="tutorials/en/display-modes.html"><span class="doc">Display Modes</span></a></dt><dd><p>Getting a display surface for the screen.</p>
</dd>
<dt><a class="reference internal" href="tutorials/es/ChimpanceLineaporLinea.html"><span class="doc">Tutorial de Pygame - Ejemplo del Chimpancé, Línea Por Línea</span></a></dt><dd><p>Los ejemplos de pygame incluyen un sencillo programa con un puño interactivo y un chimpancé.
Está inspirado en el molesto banner de flash de principios de la década de 2000.
Este tutorial examina cada línea de código utilizada en el ejemplo.</p>
</dd>
</dl>
</section>
...
<dt><a class="reference internal" href="ref/typing.html"><span class="doc">pygame.typing</span></a></dt><dd><p>Provide common typehints</p>
</dd>
<dt><a class="reference internal" href="ref/window.html"><span class="doc">pygame.Window</span></a></dt><dd><p>Pygame object that handles a window.</p>
</dd>
...
<br /><br />
<hr />
<a href="https://github.com/pygame-community/pygame-ce/edit/main/docs/reST/index.rst" rel="nofollow">Edit on GitHub</a>
    ...
    <div class="related" role="navigation" aria-label="Related">
      ...
      <ul>
        ...
        <li class="nav-item nav-item-0"><a href="#">pygame-ce v2.5.8 documentation</a> &#187;</li>
        <li class="nav-item nav-item-this"><a href="">Pygame-ce Front Page</a></li> 
      </ul>
    </div>
