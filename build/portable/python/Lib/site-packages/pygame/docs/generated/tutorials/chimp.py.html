...
<html lang="en" data-content_root="../">
  <head>
    ...
    <title>pygame/examples/chimp.py &#8212; pygame-ce v2.5.8 documentation</title>
    ...
    <link rel="next" title="Pygame Tutorials - Setting Display Modes" href="en/display-modes.html" />
    <link rel="prev" title="Pygame Tutorials - Line By Line Chimp Example" href="en/chimp-explanation.html" /> 
  </head><body>  
...
<span class="k">if</span> <span class="ow">not</span> <span class="n">pygame</span><span class="o">.</span><span class="n">font</span><span class="p">:</span>
...
<span class="k">def</span><span class="w"> </span><span class="nf">load_image</span><span class="p">(</span><span class="n">name</span><span class="p">,</span> <span class="n">colorkey</span><span class="o">=</span><span class="kc">None</span><span class="p">,</span> <span class="n">scale</span><span class="o">=</span><span class="mi">1</span><span class="p">):</span>
...
<span class="k">def</span><span class="w"> </span><span class="nf">load_sound</span><span class="p">(</span><span class="n">name</span><span class="p">):</span>
...
<span class="k">class</span><span class="w"> </span><span class="nc">Fist</span><span class="p">(</span><span class="n">pygame</span><span class="o">.</span><span class="n">sprite</span><span class="o">.</span><span class="n">Sprite</span><span class="p">):</span>
...
<span class="k">class</span><span class="w"> </span><span class="nc">Chimp</span><span class="p">(</span><span class="n">pygame</span><span class="o">.</span><span class="n">sprite</span><span class="o">.</span><span class="n">Sprite</span><span class="p">):</span>
...
<span class="sd">    a loop until the function returns.&quot;&quot;&quot;</span>
    ...
    <span class="n">font</span> <span class="o">=</span> <span class="n">pygame</span><span class="o">.</span><span class="n">Font</span><span class="p">(</span><span class="kc">None</span><span class="p">,</span> <span class="mi">64</span><span class="p">)</span>
...
<br /><br />
<hr />
<a href="https://github.com/pygame-community/pygame-ce/edit/main/docs/reST/tutorials\chimp.py.rst" rel="nofollow">Edit on GitHub</a>
      ...
      <ul>
        ...
        <li class="right" >
          <a href="../py-modindex.html" title="Python Module Index"
             >modules</a> |</li>
        <li class="right" >
          <a href="en/display-modes.html" title="Pygame Tutorials - Setting Display Modes"
             accesskey="N">next</a> |</li>
        <li class="right" >
          <a href="en/chimp-explanation.html" title="Pygame Tutorials - Line By Line Chimp Example"
             accesskey="P">previous</a> |</li>
        <li class="nav-item nav-item-0"><a href="../index.html">pygame-ce v2.5.8 documentation</a> &#187;</li>
          <li class="nav-item nav-item-1"><a href="en/chimp-explanation.html" accesskey="U">Pygame Tutorials - Line By Line Chimp Example</a> &#187;</li>
