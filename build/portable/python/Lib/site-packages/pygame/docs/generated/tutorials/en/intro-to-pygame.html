...
<html lang="en" data-content_root="../../">
  <head>
    ...
    <title>Pygame Intro &#8212; pygame-ce v2.5.8 documentation</title>
    ...
    <link rel="next" title="Pygame Tutorials - Sprite Module Introduction" href="intro-to-sprites.html" />
    <link rel="prev" title="Pygame Tutorials - Camera Module Introduction" href="intro-to-camera.html" /> 
  </head><body>  
...
<p>This article is an introduction to the <a class="reference external" href="https://pyga.me">pygame library</a>
...
<img alt="../../_images/intro_ball.webp" class="inlined-right" src="../../_images/intro_ball.webp" />
<div class="highlight-python notranslate"><div class="highlight"><pre><span></span><span class="linenos"> 1</span><span class="kn">import</span><span class="w"> </span><span class="nn">sys</span><span class="o">,</span><span class="w"> </span><span class="nn">pygame</span>
...
<span class="linenos">10</span><span class="n">ball</span> <span class="o">=</span> <span class="n">pygame</span><span class="o">.</span><span class="n">image</span><span class="o">.</span><span class="n">load</span><span class="p">(</span><span class="s2">&quot;intro_ball.webp&quot;</span><span class="p">)</span>
...
to copy from, and a position (which can be a <a class="reference internal" href="../../ref/rect.html#pygame.Rect" title="pygame.Rect"><code class="xref py py-class docutils literal notranslate"><span class="pre">Rect</span></code></a> object or a pair of numbers e.g. (50.0, 25.0)), to place the source onto the destination.</p>
...
<tbody>
<tr class="row-odd"><td><p><a class="reference internal" href="../../ref/cursors.html#module-pygame.cursors" title="pygame.cursors: Pygame module for cursor resources."><code class="xref py py-mod docutils literal notranslate"><span class="pre">cursors</span></code></a></p></td>
<td><p>load cursor images, includes standard cursors</p></td>
</tr>
<tr class="row-even"><td><p><a class="reference internal" href="../../ref/display.html#module-pygame.display" title="pygame.display: Pygame module to control the display window and screen."><code class="xref py py-mod docutils literal notranslate"><span class="pre">display</span></code></a></p></td>
<td><p>control the display window or screen</p></td>
</tr>
<tr class="row-odd"><td><p><a class="reference internal" href="../../ref/draw.html#module-pygame.draw" title="pygame.draw: Pygame module for drawing shapes."><code class="xref py py-mod docutils literal notranslate"><span class="pre">draw</span></code></a></p></td>
<td><p>draw simple shapes onto a Surface</p></td>
</tr>
<tr class="row-even"><td><p><a class="reference internal" href="../../ref/event.html#module-pygame.event" title="pygame.event: pygame module for interacting with events and queues"><code class="xref py py-mod docutils literal notranslate"><span class="pre">event</span></code></a></p></td>
<td><p>manage events and the event queue</p></td>
</tr>
<tr class="row-odd"><td><p><a class="reference internal" href="../../ref/font.html#module-pygame.font" title="pygame.font: pygame module for loading and rendering fonts"><code class="xref py py-mod docutils literal notranslate"><span class="pre">font</span></code></a></p></td>
<td><p>create and render TrueType fonts</p></td>
</tr>
<tr class="row-even"><td><p><a class="reference internal" href="../../ref/image.html#module-pygame.image" title="pygame.image: Pygame module for image transfer."><code class="xref py py-mod docutils literal notranslate"><span class="pre">image</span></code></a></p></td>
<td><p>save and load images</p></td>
</tr>
<tr class="row-odd"><td><p><a class="reference internal" href="../../ref/joystick.html#module-pygame.joystick" title="pygame.joystick: Pygame module for interacting with joysticks, gamepads, and trackballs."><code class="xref py py-mod docutils literal notranslate"><span class="pre">joystick</span></code></a></p></td>
<td><p>manage joystick devices</p></td>
</tr>
<tr class="row-even"><td><p><a class="reference internal" href="../../ref/key.html#module-pygame.key" title="pygame.key: Pygame module to work with the keyboard."><code class="xref py py-mod docutils literal notranslate"><span class="pre">key</span></code></a></p></td>
<td><p>manage the keyboard</p></td>
</tr>
<tr class="row-odd"><td><p><a class="reference internal" href="../../ref/mouse.html#module-pygame.mouse" title="pygame.mouse: Pygame module to work with the mouse."><code class="xref py py-mod docutils literal notranslate"><span class="pre">mouse</span></code></a></p></td>
<td><p>manage the mouse</p></td>
</tr>
<tr class="row-even"><td><p><a class="reference internal" href="../../ref/sndarray.html#module-pygame.sndarray" title="pygame.sndarray: Pygame module for accessing sound sample data."><code class="xref py py-mod docutils literal notranslate"><span class="pre">sndarray</span></code></a></p></td>
<td><p>manipulate sounds with numpy</p></td>
</tr>
<tr class="row-odd"><td><p><a class="reference internal" href="../../ref/surfarray.html#module-pygame.surfarray" title="pygame.surfarray: pygame module for accessing surface pixel data using array interfaces"><code class="xref py py-mod docutils literal notranslate"><span class="pre">surfarray</span></code></a></p></td>
<td><p>manipulate images with numpy</p></td>
</tr>
<tr class="row-even"><td><p><a class="reference internal" href="../../ref/time.html#module-pygame.time" title="pygame.time: Pygame module for monitoring time."><code class="xref py py-mod docutils literal notranslate"><span class="pre">time</span></code></a></p></td>
<td><p>control timing</p></td>
</tr>
<tr class="row-odd"><td><p><a class="reference internal" href="../../ref/transform.html#module-pygame.transform" title="pygame.transform: Pygame module to transform surfaces."><code class="xref py py-mod docutils literal notranslate"><span class="pre">transform</span></code></a></p></td>
...
<br /><br />
<hr />
<a href="https://github.com/pygame-community/pygame-ce/edit/main/docs/reST/tutorials\en\intro-to-pygame.rst" rel="nofollow">Edit on GitHub</a>
      ...
      <ul>
        ...
        <li class="right" >
          <a href="../../py-modindex.html" title="Python Module Index"
             >modules</a> |</li>
        <li class="right" >
          <a href="intro-to-sprites.html" title="Pygame Tutorials - Sprite Module Introduction"
             accesskey="N">next</a> |</li>
        <li class="right" >
          <a href="intro-to-camera.html" title="Pygame Tutorials - Camera Module Introduction"
