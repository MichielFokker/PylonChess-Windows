...
<html lang="en" data-content_root="../">
  <head>
    ...
    <title>pygame.image &#8212; pygame-ce v2.5.8 documentation</title>
...
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="image.html#pygame.image.load_sized_svg">pygame.image.load_sized_svg</a></div>
</td>
<td>—</td>
<td>Load an SVG image from a file (or file-like object) with the given size.</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="image.html#pygame.image.load_animation">pygame.image.load_animation</a></div>
</td>
<td>—</td>
<td>Load an animation (GIF/WEBP) from a file (or file-like object) as a list of frames.</td>
</tr>
...
<li><p><code class="docutils literal notranslate"><span class="pre">LBM</span></code></p></li>
...
<li><p><code class="docutils literal notranslate"><span class="pre">PNM</span></code> (<code class="docutils literal notranslate"><span class="pre">PBM</span></code>, <code class="docutils literal notranslate"><span class="pre">PGM</span></code>, <code class="docutils literal notranslate"><span class="pre">PPM</span></code>)</p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">QOI</span></code></p></li>
...
<li><p><code class="docutils literal notranslate"><span class="pre">XCF</span></code></p></li>
</ul>
</div></blockquote>
<div class="versionaddedold">
<p><span class="versionmodified added">New in pygame 2.0.0: </span>Loading SVG, WebP, PNM</p>
</div>
<div class="versionadded">
<p><span class="versionmodified added">New in pygame-ce 2.4.0: </span>Loading QOI (Relies on SDL_Image 2.6.0+)</p>
</div>
...
<div class="line"><span class="signature">load(file, namehint='') -&gt; Surface</span></div>
</div>
...
<a class="tooltip reference internal" href="surface.html#pygame.Surface.convert" title=""><code class="xref py py-func docutils literal notranslate"><span class="pre">pygame.Surface.convert()</span></code><span class="tooltip-content">Change the pixel format of a Surface.</span></a> with no arguments, to create a copy that
will draw more quickly on the screen.</p>
<p>For alpha transparency, like in .png images, use the
<a class="tooltip reference internal" href="surface.html#pygame.Surface.convert_alpha" title=""><code class="xref py py-func docutils literal notranslate"><span class="pre">pygame.Surface.convert_alpha()</span></code><span class="tooltip-content">Change the pixel format of a Surface including per pixel alphas.</span></a> method after loading so that the
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">surf</span> <span class="o">=</span> <span class="n">pygame</span><span class="o">.</span><span class="n">image</span><span class="o">.</span><span class="n">load</span><span class="p">(</span><span class="n">os</span><span class="o">.</span><span class="n">path</span><span class="o">.</span><span class="n">join</span><span class="p">(</span><span class="s1">&#39;data&#39;</span><span class="p">,</span> <span class="s1">&#39;bla.png&#39;</span><span class="p">))</span>
</pre></div>
</div>
<div class="versionchanged">
<p><span class="versionmodified changed">Changed in pygame-ce 2.2.0: </span>Now supports keyword arguments.</p>
</div>
</dd></dl>

<dl class="py function definition">
<dt class="sig sig-object py title" id="pygame.image.load_sized_svg">
<span class="sig-prename descclassname"><span class="pre">pygame.image.</span></span><span class="sig-name descname"><span class="pre">load_sized_svg</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#pygame.image.load_sized_svg" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">Load an SVG image from a file (or file-like object) with the given size.</span></div>
<div class="line"><span class="signature">load_sized_svg(file, size) -&gt; Surface</span></div>
</div>
<p>This function rasterizes the input SVG at the size specified by the <code class="docutils literal notranslate"><span class="pre">size</span></code>
argument. The <code class="docutils literal notranslate"><span class="pre">file</span></code> argument can be either a filename, a Python file-like
object, or a pathlib.Path.</p>
<p>The usage of this function for handling SVGs is recommended, as calling the
regular <code class="docutils literal notranslate"><span class="pre">load</span></code> function and then scaling the returned surface would not
preserve the quality that an SVG can provide.</p>
<p>It is to be noted that this function does not return a surface whose
dimensions exactly match the <code class="docutils literal notranslate"><span class="pre">size</span></code> argument. This function preserves
aspect ratio, so the returned surface could be smaller along at most one
dimension.</p>
<p>This function requires SDL_image 2.6.0 or above. If pygame was compiled with
an older version, <code class="docutils literal notranslate"><span class="pre">pygame.error</span></code> will be raised when this function is
called.</p>
<div class="versionadded">
...
<dl class="py function definition">
<dt class="sig sig-object py title" id="pygame.image.load_animation">
<span class="sig-prename descclassname"><span class="pre">pygame.image.</span></span><span class="sig-name descname"><span class="pre">load_animation</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#pygame.image.load_animation" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">Load an animation (GIF/WEBP) from a file (or file-like object) as a list of frames.</span></div>
<div class="line"><span class="signature">load_animation(file, namehint='') -&gt; list[tuple[Surface, float]]</span></div>
</div>
<p>Load an animation (GIF/WEBP) from a file source. You can pass either a
...
format.</p>
<p>This returns a list of tuples (corresponding to every frame of the animation),
where each tuple is a (surface, delay in milliseconds) pair for that frame.</p>
<p>This function requires SDL_image 2.6.0 or above. If pygame was compiled with
an older version, <code class="docutils literal notranslate"><span class="pre">pygame.error</span></code> will be raised when this function is
called.</p>
<div class="versionadded">
...
<div class="line"><span class="signature">save(surface, file, namehint='') -&gt; None</span></div>
</div>
...
<div class="line"><span class="signature">get_sdl_image_version(linked=True) -&gt; tuple[int, int, int] | None</span></div>
</div>
...
<div class="versionchanged">
<p><span class="versionmodified changed">Changed in pygame-ce 2.1.4: </span><code class="docutils literal notranslate"><span class="pre">linked</span></code> keyword argument added and default
...
<div class="line"><span class="signature">tostring(surface, format, flipped=False, pitch=-1) -&gt; bytes</span></div>
</div>
<p>DEPRECATED: This function has the same functionality as <a class="reference internal" href="#pygame.image.tobytes" title="pygame.image.tobytes"><code class="xref py py-func docutils literal notranslate"><span class="pre">tobytes()</span></code></a>,
which is preferred and should be used.</p>
<div class="deprecated">
<p><span class="versionmodified deprecated">Deprecated since pygame-ce 2.3.0.</span></p>
</div>
</dd></dl>
...
<dd><div class="line-block">
<div class="line"><span class="summaryline">Transfer image to byte buffer.</span></div>
<div class="line"><span class="signature">tobytes(surface, format, flipped=False, pitch=-1) -&gt; bytes</span></div>
</div>
<p>Creates a bytes object that can be transferred with the <code class="docutils literal notranslate"><span class="pre">fromstring</span></code>
...
<li><p><code class="docutils literal notranslate"><span class="pre">ABGR</span></code>, 32-bit image with alpha channel, reverse order</p></li>
...
<p>The 'pitch' argument can be used to specify the pitch/stride per horizontal line
...
<div class="admonition note">
<p class="admonition-title">Note</p>
<p>The use of this function is recommended over <a class="reference internal" href="#pygame.image.tostring" title="pygame.image.tostring"><code class="xref py py-func docutils literal notranslate"><span class="pre">tostring()</span></code></a> as of pygame 2.1.3.
...
<div class="versionchanged">
<p><span class="versionmodified changed">Changed in pygame-ce 2.5.0: </span>Added a 'pitch' argument.</p>
</div>
<div class="versionchanged">
<p><span class="versionmodified changed">Changed in pygame-ce 2.5.1: </span>Added support for ABGR image format</p>
</div>
</dd></dl>
...
<p>DEPRECATED: This function has the same functionality as <a class="reference internal" href="#pygame.image.frombytes" title="pygame.image.frombytes"><code class="xref py py-func docutils literal notranslate"><span class="pre">frombytes()</span></code></a>,
which is preferred and should be used.</p>
<div class="deprecated">
<p><span class="versionmodified deprecated">Deprecated since pygame-ce 2.3.0.</span></p>
</div>
...
<div class="admonition note">
<p class="admonition-title">Note</p>
<p>The use of this function is recommended over <a class="reference internal" href="#pygame.image.fromstring" title="pygame.image.fromstring"><code class="xref py py-func docutils literal notranslate"><span class="pre">fromstring()</span></code></a> as of pygame 2.1.3.
This function was introduced so it matches nicely with other
libraries (PIL, NumPy, etc), and with people's expectations.</p>
</div>
<div class="versionadded">
...
<div class="versionadded">
<p><span class="versionmodified added">New in pygame-ce 2.1.4: </span>Added a 'pitch' argument and support for keyword arguments.</p>
</div>
</dd></dl>
...
This method takes similar arguments to <a class="tooltip reference internal" href="#pygame.image.frombytes" title=""><code class="xref py py-func docutils literal notranslate"><span class="pre">pygame.image.frombytes()</span></code><span class="tooltip-content">Create new Surface from a byte buffer.</span></a>, but
is unable to vertically flip the source data.</p>
<p>This will run much faster than <a class="tooltip reference internal" href="#pygame.image.frombytes" title=""><code class="xref py py-func docutils literal notranslate"><span class="pre">pygame.image.frombytes()</span></code><span class="tooltip-content">Create new Surface from a byte buffer.</span></a>, since no
...
the same size as how many bytes the pure pixel data of each horizontal line takes.</p>
<div class="versionadded">
<p><span class="versionmodified added">New in pygame-ce 2.1.3: </span>BGRA format</p>
</div>
<div class="versionadded">
<p><span class="versionmodified added">New in pygame-ce 2.1.4: </span>Added a 'pitch' argument and support for keyword arguments.</p>
</div>
...
format. This function is always available, no matter how pygame was built.</p>
</dd></dl>
...
<div class="line"><span class="signature">load_extended(file, namehint='') -&gt; Surface</span></div>
</div>
...
function will raise a <code class="docutils literal notranslate"><span class="pre">NotImplementedError</span></code> if pygame was built without
...
<code class="docutils literal notranslate"><span class="pre">NotImplementedError</span></code> if extended image formats are not supported.
Previously, this function may or may not be available, depending on the
state of extended image format support.</p>
</div>
<div class="versionchanged">
<p><span class="versionmodified changed">Changed in pygame-ce 2.2.0: </span>Now supports keyword arguments.</p>
</div>
...
<div class="line"><span class="signature">save_extended(surface, file, namehint='') -&gt; None</span></div>
</div>
