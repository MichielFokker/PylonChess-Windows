...
<html lang="en" data-content_root="../">
  <head>
    ...
    <title>pygame.sprite &#8212; pygame-ce v2.5.8 documentation</title>
    ...
    <link rel="prev" title="special flags" href="special_flags_list.html" /> 
  </head><body>  
...
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="sprite.html#pygame.sprite.LayeredUpdates">pygame.sprite.LayeredUpdates</a></div>
</td>
<td>—</td>
<td>LayeredUpdates is a sprite group that handles layers and draws like RenderUpdates.</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="sprite.html#pygame.sprite.LayeredDirty">pygame.sprite.LayeredDirty</a></div>
</td>
<td>—</td>
<td>LayeredDirty group is for DirtySprite objects.  Subclasses LayeredUpdates.</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="sprite.html#pygame.sprite.GroupSingle">pygame.sprite.GroupSingle</a></div>
</td>
<td>—</td>
<td>Group container that holds a single sprite.</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="sprite.html#pygame.sprite.spritecollide">pygame.sprite.spritecollide</a></div>
</td>
<td>—</td>
<td>Find sprites in a group that intersect another sprite.</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="sprite.html#pygame.sprite.collide_rect">pygame.sprite.collide_rect</a></div>
</td>
<td>—</td>
<td>Collision detection between two sprites, using rects.</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="sprite.html#pygame.sprite.collide_rect_ratio">pygame.sprite.collide_rect_ratio</a></div>
</td>
<td>—</td>
<td>Collision detection between two sprites, using rects scaled to a ratio.</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="sprite.html#pygame.sprite.collide_circle">pygame.sprite.collide_circle</a></div>
</td>
<td>—</td>
<td>Collision detection between two sprites, using circles.</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="sprite.html#pygame.sprite.collide_circle_ratio">pygame.sprite.collide_circle_ratio</a></div>
</td>
<td>—</td>
<td>Collision detection between two sprites, using circles scaled to a ratio.</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="sprite.html#pygame.sprite.collide_mask">pygame.sprite.collide_mask</a></div>
</td>
<td>—</td>
<td>Collision detection between two sprites, using masks.</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="sprite.html#pygame.sprite.groupcollide">pygame.sprite.groupcollide</a></div>
</td>
<td>—</td>
<td>Find all sprites that collide between two groups.</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="sprite.html#pygame.sprite.spritecollideany">pygame.sprite.spritecollideany</a></div>
</td>
<td>—</td>
...
<code class="docutils literal notranslate"><span class="pre">Group.draw()</span></code> method requires that each Sprite have a <code class="docutils literal notranslate"><span class="pre">Sprite.image</span></code>
attribute and a <code class="docutils literal notranslate"><span class="pre">Sprite.rect</span></code>. The <code class="docutils literal notranslate"><span class="pre">Group.clear()</span></code> method requires these
same attributes, and can be used to erase all the Sprites with background.
There are also more advanced Groups: <code class="docutils literal notranslate"><span class="pre">pygame.sprite.RenderUpdates()</span></code>.</p>
...
find the collisions, the Sprites are required to have a <code class="docutils literal notranslate"><span class="pre">Sprite.rect</span></code>
...
<div class="highlight-python notranslate"><div class="highlight"><pre><span></span><span class="k">class</span><span class="w"> </span><span class="nc">Block</span><span class="p">(</span><span class="n">pygame</span><span class="o">.</span><span class="n">sprite</span><span class="o">.</span><span class="n">Sprite</span><span class="p">):</span>

    <span class="c1"># Constructor. Pass in the color of the block,</span>
    <span class="c1"># and its x and y position</span>
    <span class="k">def</span><span class="w"> </span><span class="fm">__init__</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">color</span><span class="p">,</span> <span class="n">width</span><span class="p">,</span> <span class="n">height</span><span class="p">):</span>
...
<span class="p">(</span><span class="n">you</span> <span class="n">must</span> <span class="nb">set</span> <span class="n">it</span> <span class="n">dirty</span> <span class="n">too</span> <span class="n">to</span> <span class="n">be</span> <span class="n">erased</span> <span class="kn">from</span><span class="w"> </span><span class="nn">screen</span><span class="p">)</span>
</pre></div>
</div>
<p>layer = 0</p>
...
<p>Each sprite argument can also be an iterator containing Sprites.</p>
</dd></dl>
...
<div class="line"><span class="signature">draw(Surface, bgd=None, special_flags=0) -&gt; list[Rect]</span></div>
</div>
...
<code class="docutils literal notranslate"><span class="pre">bgd</span></code> is unused in this method but <code class="docutils literal notranslate"><span class="pre">LayeredDirty.draw()</span></code> uses
it.</p>
<p>The Group keeps sprites in the order they were added, they will be drawn in this order.</p>
<div class="versionchanged">
<p><span class="versionmodified changed">Changed in pygame-ce 2.5.4: </span>Added the <code class="docutils literal notranslate"><span class="pre">bgd</span></code> and <code class="docutils literal notranslate"><span class="pre">special_flags</span></code> arguments</p>
</div>
</dd></dl>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="k">def</span><span class="w"> </span><span class="nf">clear_callback</span><span class="p">(</span><span class="n">surf</span><span class="p">,</span> <span class="n">rect</span><span class="p">):</span>
...
<div class="line"><span class="signature">draw(surface, bgd=None, special_flags=0) -&gt; Rect_list</span></div>
</div>
...
passed to <code class="docutils literal notranslate"><span class="pre">Surface.blit()</span></code>. <code class="docutils literal notranslate"><span class="pre">bgd</span></code> is unused in this method but
<code class="docutils literal notranslate"><span class="pre">LayeredDirty.draw()</span></code> uses it.</p>
...
<dd><div class="line-block">
<div class="line"><span class="summaryline">LayeredUpdates is a sprite group that handles layers and draws like RenderUpdates.</span></div>
...
<td>—</td>
<td>returns an ordered list of sprites (first back, last top).</td>
</tr>
...
<dd><div class="line-block">
<div class="line"><span class="summaryline">returns an ordered list of sprites (first back, last top).</span></div>
...
<dd><div class="line-block">
<div class="line"><span class="summaryline">draw all sprites in the right order onto the passed surface.</span></div>
<div class="line"><span class="signature">draw(surface, bgd=None, special_flags=None) -&gt; Rect_list</span></div>
</div>
<p>You can pass the background too. If a background is already set, then the
bgd argument has no effect. <code class="docutils literal notranslate"><span class="pre">special_flags</span></code> is passed to
<code class="docutils literal notranslate"><span class="pre">Surface.blit()</span></code>.</p>
<div class="versionchanged">
<p><span class="versionmodified changed">Changed in pygame-ce 2.5.4: </span>Added the <code class="docutils literal notranslate"><span class="pre">special_flags</span></code> argument</p>
</div>
</dd></dl>
...
<a href="https://github.com/pygame-community/pygame-ce/edit/main/docs/reST/ref\sprite.rst" rel="nofollow">Edit on GitHub</a>
    ...
    <div class="related" role="navigation" aria-label="Related">
      ...
      <ul>
        ...
        <li class="right" >
          <a href="special_flags_list.html" title="special flags"
