...
<html lang="en" data-content_root="../../">
  <head>
    ...
    <title>Pygame Tutorials - Sprite Module Introduction &#8212; pygame-ce v2.5.8 documentation</title>
    ...
    <link rel="next" title="Pygame Tutorials - Surfarray Introduction" href="intro-to-surfarray.html" />
    <link rel="prev" title="Pygame Intro" href="intro-to-pygame.html" /> 
  </head><body>  
...
<code class="docutils literal notranslate"><span class="pre">Sprite</span></code> class has a placeholder <code class="docutils literal notranslate"><span class="pre">update()</span></code> method that takes any sort of
...
<blockquote>
<div><p>This group is inherited from <code class="docutils literal notranslate"><span class="pre">Group</span></code>, but changes the
<code class="docutils literal notranslate"><span class="pre">draw()</span></code> method to also return a list of pygame <code class="docutils literal notranslate"><span class="pre">Rects</span></code>,
...
probably just get away with the <code class="docutils literal notranslate"><span class="pre">Group</span></code> one. For a scrolling or stationary
type game, you should probably go with the <code class="docutils literal notranslate"><span class="pre">Group</span></code> group here to manage
your rendering.</p>
...
<code class="docutils literal notranslate"><span class="pre">draw()</span></code> method for each sprite, instead of just blitting an &quot;image&quot;
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="k">class</span><span class="w"> </span><span class="nc">RenderUpdatesDraw</span><span class="p">(</span><span class="n">Group</span><span class="p">):</span>
<span class="w">    </span><span class="sd">&quot;&quot;&quot;call sprite.draw(screen) to render sprites&quot;&quot;&quot;</span>
    <span class="k">def</span><span class="w"> </span><span class="nf">draw</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">surface</span><span class="p">):</span>
...
<br /><br />
<hr />
<a href="https://github.com/pygame-community/pygame-ce/edit/main/docs/reST/tutorials\en\intro-to-sprites.rst" rel="nofollow">Edit on GitHub</a>
