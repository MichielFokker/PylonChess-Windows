...
<html lang="en" data-content_root="../">
  <head>
    ...
    <title>pygame.gfxdraw &#8212; pygame-ce v2.5.8 documentation</title>
    ...
    <link rel="prev" title="pygame.geometry" href="geometry.html" /> 
  </head><body>  
...
<span class="kn">import</span><span class="w"> </span><span class="nn">pygame.gfxdraw</span>
</pre></div>
</div>
...
<p>The adjacent points in the <code class="docutils literal notranslate"><span class="pre">points</span></code> argument, as well as the first
...
<dd class="field-odd"><ul class="simple">
<li><p><strong>surface</strong> (<a class="reference internal" href="surface.html#pygame.Surface" title="pygame.Surface"><em>Surface</em></a>) -- surface to draw on</p></li>
<li><p><strong>points</strong> (<em>tuple</em><em>(</em><em>point</em><em>) or </em><em>list</em><em>(</em><em>point</em><em>)</em>) -- a sequence of 3 or more (x, y) coordinates, where each
...
<li><p><strong>IndexError</strong> -- if <code class="docutils literal notranslate"><span class="pre">len(point)</span> <span class="pre">&lt;</span> <span class="pre">2</span></code> (each point must have
...
a <a class="tooltip reference internal" href="surface.html#pygame.Surface.blit" title=""><code class="xref py py-func docutils literal notranslate"><span class="pre">pygame.Surface.blit()</span></code><span class="tooltip-content">Draw another Surface onto this one.</span></a> blit. Also, a per-pixel alpha texture cannot be
...
<dd class="field-odd"><ul class="simple">
<li><p><strong>surface</strong> (<a class="reference internal" href="surface.html#pygame.Surface" title="pygame.Surface"><em>Surface</em></a>) -- surface to draw on</p></li>
<li><p><strong>points</strong> (<em>tuple</em><em>(</em><em>point</em><em>) or </em><em>list</em><em>(</em><em>point</em><em>)</em>) -- a sequence of 3 or more (x, y) coordinates used to form a
...
<div class="admonition note">
<p class="admonition-title">Note</p>
<p>This function supports up to around 150-200 points before the algorithm
breaks down.</p>
</div>
</dd></dl>
