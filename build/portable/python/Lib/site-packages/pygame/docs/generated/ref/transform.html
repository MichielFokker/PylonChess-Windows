...
<html lang="en" data-content_root="../">
  <head>
    ...
    <title>pygame.transform &#8212; pygame-ce v2.5.8 documentation</title>
    ...
    <link rel="next" title="pygame.typing" href="typing.html" />
...
<td>—</td>
<td>Return smoothscale filter version in use: 'GENERIC', 'MMX', 'SSE', 'SSE2', or 'NEON'.</td>
</tr>
...
<td>—</td>
<td>Set smoothscale filter version to one of: 'GENERIC', 'MMX', 'SSE', 'SSE2', or 'NEON'.</td>
</tr>
...
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="transform.html#pygame.transform.box_blur">pygame.transform.box_blur</a></div>
</td>
<td>—</td>
<td>Blur a surface using box blur.</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="transform.html#pygame.transform.gaussian_blur">pygame.transform.gaussian_blur</a></div>
</td>
<td>—</td>
<td>Blur a surface using gaussian blur.</td>
</tr>
...
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="transform.html#pygame.transform.invert">pygame.transform.invert</a></div>
</td>
<td>—</td>
<td>Inverts the RGB elements of a surface.</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="transform.html#pygame.transform.grayscale">pygame.transform.grayscale</a></div>
</td>
<td>—</td>
<td>Grayscale a surface.</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="transform.html#pygame.transform.solid_overlay">pygame.transform.solid_overlay</a></div>
</td>
<td>—</td>
<td>Replaces non transparent pixels with the provided color.</td>
</tr>
...
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="transform.html#pygame.transform.hsl">pygame.transform.hsl</a></div>
</td>
<td>—</td>
<td>Change the hue, saturation, and lightness of a surface.</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="transform.html#pygame.transform.pixelate">pygame.transform.pixelate</a></div>
</td>
<td>—</td>
<td>Returns a pixelated version of the original surface.</td>
</tr>
</tbody>
</table>
...
<p>An optional destination surface can be passed which is faster than creating a new
Surface. This destination surface must be the same as the size (width, height) passed
in, and the same depth and format as the source Surface.</p>
<div class="versionchanged">
<p><span class="versionmodified changed">Changed in pygame-ce 2.2.1: </span>internal scaling algorithm was replaced with a nearly
...
(width * factor, height * factor) and same depth and format as the source Surface.</p>
...
(width * 2, height * 2) and same depth and format as the source Surface.</p>
</dd></dl>
...
This function only works for 24-bit or 32-bit surfaces. A <code class="docutils literal notranslate"><span class="pre">ValueError</span></code> will
be thrown if the input surface bit depth is less than 24.</p>
<p>An optional destination surface can be passed which is faster than creating a new
Surface. This destination surface must be the same as the size (width, height) passed
in, and the same depth and format as the source Surface.</p>
...
<div class="versionchanged">
<p><span class="versionmodified changed">Changed in pygame-ce 2.4.0: </span>now uses SSE2/NEON SIMD for acceleration on x86
...
<dd><div class="line-block">
<div class="line"><span class="summaryline">Return smoothscale filter version in use: 'GENERIC', 'MMX', 'SSE', 'SSE2', or 'NEON'.</span></div>
<div class="line"><span class="signature">get_smoothscale_backend() -&gt; Literal['GENERIC', 'SSE2', 'NEON']</span></div>
</div>
<p>Shows whether or not smoothscale is using SIMD acceleration.
If no acceleration is available then &quot;GENERIC&quot; is returned. The level of
acceleration possible is automatically determined at runtime.</p>
<p>This function is provided for pygame testing and debugging.</p>
<div class="versionchanged">
<p><span class="versionmodified changed">Changed in pygame-ce 2.4.0: </span>Added SSE2 and NEON backends, MMX and SSE are deprecated.</p>
</div>
</dd></dl>
...
<dd><div class="line-block">
<div class="line"><span class="summaryline">Set smoothscale filter version to one of: 'GENERIC', 'MMX', 'SSE', 'SSE2', or 'NEON'.</span></div>
...
<dl class="py function definition">
<dt class="sig sig-object py title" id="pygame.transform.box_blur">
<span class="sig-prename descclassname"><span class="pre">pygame.transform.</span></span><span class="sig-name descname"><span class="pre">box_blur</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#pygame.transform.box_blur" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">Blur a surface using box blur.</span></div>
<div class="line"><span class="signature">box_blur(surface, radius, repeat_edge_pixels=True, dest_surface=None) -&gt; Surface</span></div>
</div>
<p>Returns the blurred surface using box blur algorithm.</p>
<p>This function does not work for indexed surfaces.
An exception will be thrown if the input is an indexed surface.</p>
<p>An optional destination surface can be passed which is faster than creating a new
Surface. This destination surface must have the same dimensions (width, height) and
depth and format as the source Surface.</p>
<div class="versionadded">
<p><span class="versionmodified added">New in pygame-ce 2.2.0.</span></p>
</div>
<div class="versionchanged">
<p><span class="versionmodified changed">Changed in pygame-ce 2.3.0: </span>Passing the calling surface as destination surface raises a <code class="docutils literal notranslate"><span class="pre">ValueError</span></code></p>
</div>
<div class="versionchanged">
<p><span class="versionmodified changed">Changed in pygame-ce 2.5.0: </span>A surface with either width or height equal to 0 won't raise a <code class="docutils literal notranslate"><span class="pre">ValueError</span></code></p>
</div>
</dd></dl>

<dl class="py function definition">
<dt class="sig sig-object py title" id="pygame.transform.gaussian_blur">
<span class="sig-prename descclassname"><span class="pre">pygame.transform.</span></span><span class="sig-name descname"><span class="pre">gaussian_blur</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#pygame.transform.gaussian_blur" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">Blur a surface using gaussian blur.</span></div>
<div class="line"><span class="signature">gaussian_blur(surface, radius, repeat_edge_pixels=True, dest_surface=None) -&gt; Surface</span></div>
</div>
<p>Returns the blurred surface using gaussian blur algorithm.
Slower than <cite>box_blur()</cite>.</p>
<p>This function does not work for indexed surfaces.
An exception will be thrown if the input is an indexed surface.</p>
<p>An optional destination surface can be passed which is faster than creating a new
Surface. This destination surface must have the same dimensions (width, height) and
...
<div class="versionchanged">
<p><span class="versionmodified changed">Changed in pygame-ce 2.3.1: </span>Now the standard deviation of the Gaussian kernel is equal to the radius.
Blur results will be slightly different.</p>
</div>
<div class="versionchanged">
<p><span class="versionmodified changed">Changed in pygame-ce 2.5.0: </span>A surface with either width or height equal to 0 won't raise a <code class="docutils literal notranslate"><span class="pre">ValueError</span></code></p>
</div>
...
grayscale colors, and not palette colors.</p>
<p>Note, this function currently does not handle palette using surfaces
correctly.</p>
<p>An optional destination surface can be passed which is faster than creating a new
Surface. This destination surface must have the same dimensions (width, height) and
depth as the first passed source Surface.</p>
<div class="versionaddedold">
<p><span class="versionmodified added">New in pygame 1.8.</span></p>
</div>
<div class="versionaddedold">
...
<div class="line"><span class="signature">average_color(surface, rect=None, consider_alpha=False) -&gt; tuple[int, int, int, int]</span></div>
</div>
...
(removing the black artifacts).</p>
<div class="versionaddedold">
...
<dl class="py function definition">
<dt class="sig sig-object py title" id="pygame.transform.invert">
<span class="sig-prename descclassname"><span class="pre">pygame.transform.</span></span><span class="sig-name descname"><span class="pre">invert</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#pygame.transform.invert" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">Inverts the RGB elements of a surface.</span></div>
<div class="line"><span class="signature">invert(surface, dest_surface=None) -&gt; Surface</span></div>
</div>
<p>Inverts each RGB pixel contained within the Surface, does not affect alpha channel.</p>
<p>An optional destination surface can be passed which is faster than creating a new
Surface. This destination surface must have the same dimensions (width, height) and
depth as the source Surface.</p>
<div class="versionadded">
...
<div class="versionchanged">
<p><span class="versionmodified changed">Changed in pygame-ce 2.4.0: </span>Adjusted formula slightly to support performance
optimisation. It may return very slightly different pixels than before,
but should run seven to eleven times faster on most systems.</p>
</div>
</dd></dl>

<dl class="py function definition">
<dt class="sig sig-object py title" id="pygame.transform.solid_overlay">
<span class="sig-prename descclassname"><span class="pre">pygame.transform.</span></span><span class="sig-name descname"><span class="pre">solid_overlay</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#pygame.transform.solid_overlay" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">Replaces non transparent pixels with the provided color.</span></div>
<div class="line"><span class="signature">solid_overlay(surface, color, dest_surface=None, keep_alpha=False) -&gt; Surface</span></div>
</div>
<p>Returns a new version of the original surface with all non transparent pixels set to the color provided.</p>
<p>An optional destination surface can be passed which is faster than creating a new
Surface.
...
<li><p><strong>surface</strong> (<a class="tooltip reference internal" href="surface.html#pygame.Surface" title=""><em>pygame.Surface</em><span class="tooltip-content">Pygame object for representing images.</span></a>) -- The target surface.</p></li>
<li><p><strong>color</strong> (<a class="reference internal" href="typing.html#pygame.typing.ColorLike" title="pygame.typing.ColorLike"><code class="xref py py-data docutils literal notranslate"><span class="pre">pygame.typing.ColorLike</span></code></a>) -- Color which all non transparent within the target surface must be set to.</p></li>
<li><p><strong>dest_surface</strong> (<a class="tooltip reference internal" href="surface.html#pygame.Surface" title=""><em>pygame.Surface</em><span class="tooltip-content">Pygame object for representing images.</span></a><em> or </em><em>None</em>) -- Optional destination surface to which the changes will be applied.</p></li>
<li><p><strong>keep_alpha</strong> (<em>bool</em>) -- Optional parameter that controls whether to keep the surface alpha when replacing with the color.</p></li>
</ul>
</dd>
</dl>
<div class="versionadded">
...
<div class="line"><span class="signature">threshold(dest_surface, surface, search_color, threshold=(0, 0, 0, 0), set_color=(0, 0, 0, 0), set_behavior=1, search_surf=None, inverse_set=False) -&gt; int</span></div>
</div>
...
<li><p><strong>search_color</strong> -- Color we are searching for.</p></li>
<li><p><strong>threshold</strong> -- Within this distance from search_color (or search_surf).
...
if you like.</p></li>
<li><p><strong>set_color</strong> -- Color we set in dest_surf.</p></li>
...
<div class="versionchanged">
<p><span class="versionmodified changed">Changed in pygame-ce 2.5.8: </span>Fixed <code class="docutils literal notranslate"><span class="pre">set_color</span></code> writing the wrong channels on 24-bit destination
surfaces whose byte layout did not match the platform default.</p>
</div>
</dd></dl>

<dl class="py function definition">
<dt class="sig sig-object py title" id="pygame.transform.hsl">
<span class="sig-prename descclassname"><span class="pre">pygame.transform.</span></span><span class="sig-name descname"><span class="pre">hsl</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#pygame.transform.hsl" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">Change the hue, saturation, and lightness of a surface.</span></div>
<div class="line"><span class="signature">hsl(surface, hue=0, saturation=0, lightness=0, dest_surface=None) -&gt; Surface</span></div>
</div>
<p>This function allows you to modify the hue, saturation, and lightness of a given surface.</p>
<dl class="field-list simple">
<dt class="field-odd">Parameters<span class="colon">:</span></dt>
<dd class="field-odd"><ul class="simple">
<li><p><strong>surface</strong> (<a class="tooltip reference internal" href="surface.html#pygame.Surface" title=""><em>pygame.Surface</em><span class="tooltip-content">Pygame object for representing images.</span></a>) -- The surface to transform.</p></li>
<li><p><strong>hue</strong> (<em>float</em>) -- The amount to change the hue. Positive values rotate the hue clockwise,
while negative values rotate it counterclockwise. Value range: -360 to 360.</p></li>
<li><p><strong>saturation</strong> (<em>float</em>) -- The amount to change the saturation. Positive values increase saturation,
while negative values decrease it. Value range: -1 to 1.</p></li>
<li><p><strong>lightness</strong> (<em>float</em>) -- The amount to change the lightness. Positive values increase lightness,
while negative values decrease it. Value range: -1 to 1.</p></li>
<li><p><strong>dest_surface</strong> (<a class="tooltip reference internal" href="surface.html#pygame.Surface" title=""><em>pygame.Surface</em><span class="tooltip-content">Pygame object for representing images.</span></a>) -- An optional destination surface to store the transformed image.
If provided, it should have the same dimensions and depth as the source surface.</p></li>
</ul>
</dd>
<dt class="field-even">Returns<span class="colon">:</span></dt>
<dd class="field-even"><p>A new surface with the hue, saturation, and lightness transformed.</p>
</dd>
<dt class="field-odd">Examples<span class="colon">:</span></dt>
<dd class="field-odd"><p></p></dd>
</dl>
<p>Apply a hue rotation of 30 degrees, increase saturation by 20%, and decrease lightness by 10% to a surface:</p>
<div class="highlight-python notranslate"><div class="highlight"><pre><span></span><span class="n">new_surf</span> <span class="o">=</span> <span class="n">hsl</span><span class="p">(</span><span class="n">original_surf</span><span class="p">,</span> <span class="mi">30</span><span class="p">,</span> <span class="mf">0.2</span><span class="p">,</span> <span class="o">-</span><span class="mf">0.1</span><span class="p">)</span>
</pre></div>
</div>
<div class="versionadded">
...
<dl class="py function definition">
<dt class="sig sig-object py title" id="pygame.transform.pixelate">
<span class="sig-prename descclassname"><span class="pre">pygame.transform.</span></span><span class="sig-name descname"><span class="pre">pixelate</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#pygame.transform.pixelate" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">Returns a pixelated version of the original surface.</span></div>
<div class="line"><span class="signature">pixelate(surface, pixel_size, dest_surface=None) -&gt; Surface</span></div>
</div>
<p><code class="docutils literal notranslate"><span class="pre">pixel_size</span></code> is an integer describing how large you want the pixels in the final pixelated image to be.
An optional destination surface can be passed which is faster than creating a new Surface. This destination
surface must have the same dimensions (width, height) and same depth and format as the source Surface.</p>
<dl class="field-list simple">
<dt class="field-odd">Parameters<span class="colon">:</span></dt>
<dd class="field-odd"><ul class="simple">
<li><p><strong>surface</strong> (<a class="tooltip reference internal" href="surface.html#pygame.Surface" title=""><em>pygame.Surface</em><span class="tooltip-content">Pygame object for representing images.</span></a>) -- the surface to pixelate.</p></li>
<li><p><strong>pixel_size</strong> (<em>int</em>) -- how large the pixels in the pixelated image should be.</p></li>
<li><p><strong>dest_surface</strong> (<a class="tooltip reference internal" href="surface.html#pygame.Surface" title=""><em>pygame.Surface</em><span class="tooltip-content">Pygame object for representing images.</span></a>) -- An optional destination surface to store the pixelated image.
If provided, it should have the same dimensions and depth as the source surface.</p></li>
</ul>
</dd>
<dt class="field-even">Returns<span class="colon">:</span></dt>
<dd class="field-even"><p>A new surface that's been pixelated.</p>
</dd>
</dl>
<div class="versionadded">
...
<p><code class="docutils literal notranslate"><span class="pre">pixel_size</span></code> must be &gt;= 1. A <code class="docutils literal notranslate"><span class="pre">ValueError</span></code> is raised otherwise.</p>
</div>
</dd></dl>
