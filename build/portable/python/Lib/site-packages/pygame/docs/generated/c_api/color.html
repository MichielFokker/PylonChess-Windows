...
<html lang="en" data-content_root="../">
  <head>
    ...
    <title>Class Color API exported by pygame.color &#8212; pygame-ce v2.5.8 documentation</title>
...
<dl class="c function">
<dt class="sig sig-object c" id="c.pgColor_CheckExact">
<span class="kt"><span class="pre">int</span></span><span class="w"> </span><span class="sig-name descname"><span class="n"><span class="pre">pgColor_CheckExact</span></span></span><span class="sig-paren">(</span><span class="n"><span class="pre">PyObject</span></span><span class="w"> </span><span class="p"><span class="pre">*</span></span><span class="n"><span class="pre">obj</span></span><span class="sig-paren">)</span><a class="headerlink" href="#c.pgColor_CheckExact" title="Link to this definition">¶</a><br /></dt>
...
<dd><p>Return a new <a class="reference internal" href="../ref/color.html#pygame.Color" title="pygame.Color"><code class="xref py py-class docutils literal notranslate"><span class="pre">pygame.Color</span></code></a> instance from the four element array <em>rgba</em>.
...
<dl class="c function">
<dt class="sig sig-object c" id="c.pg_RGBAFromObjEx">
<span class="kt"><span class="pre">int</span></span><span class="w"> </span><span class="sig-name descname"><span class="n"><span class="pre">pg_RGBAFromObjEx</span></span></span><span class="sig-paren">(</span><span class="n"><span class="pre">PyObject</span></span><span class="w"> </span><span class="p"><span class="pre">*</span></span><span class="n"><span class="pre">color</span></span>, <span class="n"><span class="pre">Uint8</span></span><span class="w"> </span><span class="n"><span class="pre">rgba</span></span><span class="p"><span class="pre">[</span></span><span class="p"><span class="pre">]</span></span>, <span class="n"><span class="pre">pgColorHandleFlags</span></span><span class="w"> </span><span class="n"><span class="pre">handle_flags</span></span><span class="sig-paren">)</span><a class="headerlink" href="#c.pg_RGBAFromObjEx" title="Link to this definition">¶</a><br /></dt>
<dd><p>Set the four element array <em>rgba</em> to the color represented by object <em>color</em>.
Return <code class="docutils literal notranslate"><span class="pre">1</span></code> on success, <code class="docutils literal notranslate"><span class="pre">0</span></code> otherwise and sets a python exception.
This in an extension of <a class="reference internal" href="base.html#c.pg_RGBAFromObj" title="pg_RGBAFromObj"><code class="xref c c-func docutils literal notranslate"><span class="pre">pg_RGBAFromObj()</span></code></a> optimized for pgColor_Type
instances and tuples. It can also handle integer and string color inputs based
on <code class="docutils literal notranslate"><span class="pre">handle_flags</span></code>.</p>
</dd></dl>

<dl class="c function">
<dt class="sig sig-object c" id="c.pg_MappedColorFromObj">
<span class="kt"><span class="pre">int</span></span><span class="w"> </span><span class="sig-name descname"><span class="n"><span class="pre">pg_MappedColorFromObj</span></span></span><span class="sig-paren">(</span><span class="n"><span class="pre">PyObject</span></span><span class="w"> </span><span class="p"><span class="pre">*</span></span><span class="n"><span class="pre">val</span></span>, <span class="n"><span class="pre">SDL_Surface</span></span><span class="w"> </span><span class="p"><span class="pre">*</span></span><span class="n"><span class="pre">surf</span></span>, <span class="n"><span class="pre">Uint32</span></span><span class="w"> </span><span class="p"><span class="pre">*</span></span><span class="n"><span class="pre">color</span></span>, <span class="n"><span class="pre">pgColorHandleFlags</span></span><span class="w"> </span><span class="n"><span class="pre">handle_flags</span></span><span class="sig-paren">)</span><a class="headerlink" href="#c.pg_MappedColorFromObj" title="Link to this definition">¶</a><br /></dt>
<dd><p>Like above function, but returns mapped color instead. One notable point of difference is
the way in which ints are handled (this function directly interprets the int passed as the
mapped color on the surface <code class="docutils literal notranslate"><span class="pre">surf`</span></code>)</p>
</dd></dl>
