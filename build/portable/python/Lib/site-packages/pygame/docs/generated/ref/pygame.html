...
<html lang="en" data-content_root="../">
  <head>
    ...
    <title>pygame &#8212; pygame-ce v2.5.8 documentation</title>
...
<span class="sig-prename descclassname"><span class="pre">pygame.</span></span><span class="sig-name descname"><span class="pre">IS_CE</span></span><a class="headerlink" href="#pygame.IS_CE" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
...
<p><span class="versionmodified changed">Changed in pygame-ce 2.1.4: </span><code class="docutils literal notranslate"><span class="pre">linked</span></code> keyword argument added</p>
</div>
</dd></dl>
...
supported.</p>
<p>This function is not needed for normal pygame-ce usage.</p>
<div class="versionaddedold">
...
<span class="sig-prename descclassname"><span class="pre">pygame.</span></span><span class="sig-name descname"><span class="pre">print_debug_info</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#pygame.print_debug_info" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
...
<div class="line"><span class="signature">SDL = '(2, 26, 5)'</span></div>
</div>
...
<span class="go">SDLVersion(major=2, minor=26, patch=5)</span>
</pre></div>
</div>
<div class="versionaddedold">
...
<span class="n">Set</span> <span class="n">to</span> <span class="s2">&quot;opencv&quot;</span>
</pre></div>
</div>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">SDL_MOUSE_TOUCH_EVENTS</span>
<span class="n">Set</span> <span class="n">to</span> <span class="s2">&quot;1&quot;</span> <span class="n">to</span> <span class="n">make</span> <span class="n">mouse</span> <span class="n">events</span> <span class="n">also</span> <span class="n">generate</span> <span class="n">touch</span> <span class="n">events</span><span class="o">.</span>
</pre></div>
</div>
<p>Useful for testing touch events on desktop platforms (e.g. with a trackpad)
where this is set to 0 by default.</p>
<div class="line-block">
<div class="line"><br /></div>
</div>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="s2">&quot;SDL_WINDOWS_DPI_AWARENESS&quot;</span>
<span class="n">Set</span> <span class="n">to</span> <span class="s2">&quot;permonitorv2&quot;</span> <span class="n">on</span> <span class="n">windows</span> <span class="mi">10</span> <span class="p">(</span><span class="ow">and</span> <span class="n">later</span><span class="p">)</span> <span class="n">to</span> <span class="n">declare</span> <span class="n">the</span> <span class="n">pygame</span>
<span class="n">window</span> <span class="n">DPI</span> <span class="n">aware</span> <span class="ow">and</span> <span class="n">ignore</span> <span class="n">the</span> <span class="n">desktop</span> <span class="n">scaling</span><span class="p">,</span> <span class="s2">&quot;permonitor&quot;</span> <span class="k">for</span>
<span class="n">windows</span> <span class="mf">8.1</span> <span class="ow">and</span> <span class="n">later</span> <span class="n">DPI</span> <span class="n">awareness</span> <span class="ow">and</span> <span class="s2">&quot;system&quot;</span> <span class="k">for</span> <span class="n">windows</span> <span class="n">Vista</span>
<span class="ow">and</span> <span class="n">later</span> <span class="n">DPI</span> <span class="n">awareness</span> <span class="p">(</span><span class="ow">not</span> <span class="n">per</span> <span class="n">monitor</span><span class="p">)</span><span class="o">.</span> <span class="n">Finally</span> <span class="nb">set</span> <span class="n">it</span> <span class="n">to</span> <span class="s2">&quot;unaware&quot;</span><span class="p">,</span>
<span class="n">to</span> <span class="n">have</span> <span class="n">the</span> <span class="n">pygame</span> <span class="n">window</span> <span class="n">scale</span> <span class="k">with</span> <span class="n">the</span> <span class="n">desktop</span> <span class="n">scaling</span><span class="o">.</span>
</pre></div>
</div>
<p>This hint only affects the windows platform, other platforms can control DPI awareness
via a Window creation keyword parameter called &quot;allow_high_dpi&quot;.</p>
</dd></dl>
