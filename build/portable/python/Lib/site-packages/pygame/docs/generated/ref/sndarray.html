...
<html lang="en" data-content_root="../">
  <head>
    ...
    <title>pygame.sndarray &#8212; pygame-ce v2.5.8 documentation</title>
    ...
    <link rel="next" title="special flags" href="special_flags_list.html" />
...
package. If NumPy can't be imported, <code class="docutils literal notranslate"><span class="pre">sndarray</span></code> becomes a <code class="docutils literal notranslate"><span class="pre">MissingModule</span></code>
object.</p>
...
<p><span class="versionmodified changed">Changed in pygame-ce 2.5.6: </span>sndarray module is lazily loaded to avoid an expensive NumPy import when unnecessary</p>
</div>
...
<div class="line"><span class="signature">array(sound) -&gt; numpy.ndarray</span></div>
</div>
...
<div class="line"><span class="signature">samples(sound) -&gt; numpy.ndarray</span></div>
</div>
...
Using this function will raise a <code class="docutils literal notranslate"><span class="pre">DeprecationWarning</span></code>.</p>
</dd></dl>
...
<div class="line"><span class="signature">get_arraytypes() -&gt; tuple[str]</span></div>
</div>
...
<a class="tooltip reference internal" href="#pygame.sndarray.use_arraytype" title=""><code class="xref py py-func docutils literal notranslate"><span class="pre">pygame.sndarray.use_arraytype()</span></code><span class="tooltip-content">Sets the array system to be used for sound arrays.</span></a> method. Using this function will
raise a <code class="docutils literal notranslate"><span class="pre">DeprecationWarning</span></code>.</p>
<div class="versionaddedold">
<p><span class="versionmodified added">New in pygame 1.8.</span></p>
</div>
</dd></dl>
