...
<html lang="en" data-content_root="../">
  <head>
    ...
    <title>pygame.draw &#8212; pygame-ce v2.5.8 documentation</title>
...
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="draw.html#pygame.draw.aacircle">pygame.draw.aacircle</a></div>
</td>
<td>—</td>
<td>Draw an antialiased circle.</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="draw.html#pygame.draw.ellipse">pygame.draw.ellipse</a></div>
</td>
<td>—</td>
<td>Draw an ellipse.</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="draw.html#pygame.draw.arc">pygame.draw.arc</a></div>
</td>
<td>—</td>
<td>Draw an elliptical arc.</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="draw.html#pygame.draw.line">pygame.draw.line</a></div>
</td>
<td>—</td>
<td>Draw a straight line.</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="draw.html#pygame.draw.lines">pygame.draw.lines</a></div>
</td>
<td>—</td>
<td>Draw multiple contiguous straight line segments.</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="draw.html#pygame.draw.aaline">pygame.draw.aaline</a></div>
</td>
<td>—</td>
<td>Draw a straight antialiased line.</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="draw.html#pygame.draw.aalines">pygame.draw.aalines</a></div>
</td>
<td>—</td>
<td>Draw multiple contiguous straight antialiased line segments.</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="draw.html#pygame.draw.flood_fill">pygame.draw.flood_fill</a></div>
</td>
<td>—</td>
<td>Fill an enclosed, same color area, on a surface.</td>
</tr>
</tbody>
</table>
...
<p>All the drawing functions accept a color argument that is compatible with
<a class="reference internal" href="typing.html#pygame.typing.ColorLike" title="pygame.typing.ColorLike"><code class="xref py py-data docutils literal notranslate"><span class="pre">pygame.typing.ColorLike</span></code></a>.</p>
...
<div class="line"><span class="signature">rect(surface, color, rect, width=0, border_radius=-1, border_top_left_radius=-1, border_top_right_radius=-1, border_bottom_left_radius=-1, border_bottom_right_radius=-1) -&gt; Rect</span></div>
</div>
...
<li><p><strong>color</strong> (<a class="reference internal" href="typing.html#pygame.typing.ColorLike" title="pygame.typing.ColorLike"><code class="xref py py-data docutils literal notranslate"><span class="pre">pygame.typing.ColorLike</span></code></a>) -- color to draw with, the alpha value is optional if using a
...
<li><p><strong>color</strong> (<a class="reference internal" href="typing.html#pygame.typing.ColorLike" title="pygame.typing.ColorLike"><code class="xref py py-data docutils literal notranslate"><span class="pre">pygame.typing.ColorLike</span></code></a>) -- color to draw with, the alpha value is optional if using a
tuple <code class="docutils literal notranslate"><span class="pre">(RGB[A])</span></code></p></li>
<li><p><strong>points</strong> (<em>tuple</em><em>(</em><em>point</em><em>) or </em><em>list</em><em>(</em><em>point</em><em>)</em>) -- a sequence of 3 or more (x, y) coordinates that make up the
...
<div class="line"><span class="signature">circle(surface, color, center, radius, width=0, draw_top_right=False, draw_top_left=False, draw_bottom_left=False, draw_bottom_right=False) -&gt; Rect</span></div>
</div>
...
<blockquote>
<div><div class="line-block">
<div class="line">If any quadrants are set to True, only they will be drawn, otherwise the entire circle will be drawn.</div>
</div>
</div></blockquote>
</p></li>
</ul>
...
<dl class="py function definition">
<dt class="sig sig-object py title" id="pygame.draw.aacircle">
<span class="sig-prename descclassname"><span class="pre">pygame.draw.</span></span><span class="sig-name descname"><span class="pre">aacircle</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#pygame.draw.aacircle" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">Draw an antialiased circle.</span></div>
<div class="line"><span class="signature">aacircle(surface, color, center, radius, width=0, draw_top_right=False, draw_top_left=False, draw_bottom_left=False, draw_bottom_right=False) -&gt; Rect</span></div>
</div>
<p>Draws an antialiased circle on the given surface.
Uses Xiaolin Wu Circle Algorithm.
Adapted from: <a class="reference external" href="https://cgg.mff.cuni.cz/~pepca/ref/WU.pdf">https://cgg.mff.cuni.cz/~pepca/ref/WU.pdf</a></p>
<dl class="field-list simple">
<dt class="field-odd">Parameters<span class="colon">:</span></dt>
<dd class="field-odd"><ul class="simple">
<li><p><strong>surface</strong> (<a class="reference internal" href="surface.html#pygame.Surface" title="pygame.Surface"><em>Surface</em></a>) -- surface to draw on</p></li>
...
<li><p><strong>points</strong> (<em>tuple</em><em>(</em><em>point</em><em>) or </em><em>list</em><em>(</em><em>point</em><em>)</em>) -- a sequence of 2 or more (x, y) coordinates, where each
...
<div class="line"><span class="signature">aaline(surface, color, start_pos, end_pos, width=1) -&gt; Rect</span></div>
</div>
<p>Draws a straight antialiased line on the given surface. There are no endcaps.
For thick lines the ends are squared off.</p>
<div class="admonition note">
<p class="admonition-title">Note</p>
...
<div class="line-block">
<div class="line">if width &gt;= 1, used for line thickness (default is 1)</div>
<div class="line">if width &lt; 1, a line of width == 1 will be drawn</div>
</div>
</p></li>
</ul>
</dd>
...
<p><span class="versionmodified changed">Changed in pygame-ce 2.4.0: </span>Removed deprecated 'blend' argument</p>
</div>
<div class="versionchanged">
<p><span class="versionmodified changed">Changed in pygame-ce 2.5.0: </span><code class="docutils literal notranslate"><span class="pre">blend</span></code> argument re-added for backcompat, but will
do nothing different and always raise a deprecation exception when used.</p>
</div>
<div class="versionchanged">
<p><span class="versionmodified changed">Changed in pygame-ce 2.5.6: </span>Added <code class="docutils literal notranslate"><span class="pre">width</span></code> in place of the deprecated
<code class="docutils literal notranslate"><span class="pre">blend</span></code> argument in a way that doesn't break backcompat too much.</p>
</div>
</dd></dl>
...
<div class="versionchanged">
<p><span class="versionmodified changed">Changed in pygame-ce 2.4.0: </span>Removed deprecated <code class="docutils literal notranslate"><span class="pre">blend</span></code> argument</p>
</div>
<div class="versionchanged">
<p><span class="versionmodified changed">Changed in pygame-ce 2.5.0: </span><code class="docutils literal notranslate"><span class="pre">blend</span></code> argument re-added for backcompat, but will
always raise a deprecation exception when used</p>
</div>
</dd></dl>

<dl class="py function definition">
<dt class="sig sig-object py title" id="pygame.draw.flood_fill">
<span class="sig-prename descclassname"><span class="pre">pygame.draw.</span></span><span class="sig-name descname"><span class="pre">flood_fill</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#pygame.draw.flood_fill" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">Fill an enclosed, same color area, on a surface.</span></div>
<div class="line"><span class="signature">flood_fill(surface, color, start_pos) -&gt; Rect</span></div>
</div>
<p>Replace the color of a cluster of connected same-color pixels, beginning
from the starting position, with a repeating pattern or solid single color.</p>
<dl class="field-list simple">
<dt class="field-odd">Parameters<span class="colon">:</span></dt>
<dd class="field-odd"><ul class="simple">
<li><p><strong>surface</strong> (<a class="reference internal" href="surface.html#pygame.Surface" title="pygame.Surface"><em>Surface</em></a>) -- surface to draw on</p></li>
<li><p><strong>color</strong> (<a class="reference internal" href="typing.html#pygame.typing.ColorLike" title="pygame.typing.ColorLike"><code class="xref py py-data docutils literal notranslate"><span class="pre">pygame.typing.ColorLike</span></code></a> or a pattern to fill with, as a Surface) -- color, or surface pattern, to draw with. The alpha value is optional if using a
tuple <code class="docutils literal notranslate"><span class="pre">(RGB[A])</span></code></p></li>
<li><p><strong>start_pos</strong> (<em>tuple</em><em>(</em><em>int</em><em> or </em><em>float</em><em>, </em><em>int</em><em> or </em><em>float</em><em>) or
</em><em>list</em><em>(</em><em>int</em><em> or </em><em>float</em><em>, </em><em>int</em><em> or </em><em>float</em><em>) or </em><a class="reference internal" href="math.html#pygame.math.Vector2" title="pygame.math.Vector2"><em>Vector2</em></a><em>(</em><em>int</em><em> or </em><em>float</em><em>, </em><em>int</em><em> or </em><em>float</em><em>)</em>) -- starting position as a sequence of 2 ints/floats,
e.g. <code class="docutils literal notranslate"><span class="pre">(x,</span> <span class="pre">y)</span></code></p></li>
</ul>
</dd>
<dt class="field-even">Returns<span class="colon">:</span></dt>
...
and its width and height will be 0</p>
</dd>
<dt class="field-odd">Return type<span class="colon">:</span></dt>
<dd class="field-odd"><p><a class="reference internal" href="rect.html#pygame.Rect" title="pygame.Rect">Rect</a></p>
</dd>
...
<span class="k">while</span> <span class="ow">not</span> <span class="n">done</span><span class="p">:</span>
    ...
    <span class="c1"># Draw on the screen a green antialiased line from (0, 25) to (50, 55)</span>
    <span class="c1"># 5 pixels wide. Uses (r, g, b) color - medium sea green.</span>
    <span class="n">pygame</span><span class="o">.</span><span class="n">draw</span><span class="o">.</span><span class="n">aaline</span><span class="p">(</span><span class="n">screen</span><span class="p">,</span> <span class="p">(</span><span class="mi">60</span><span class="p">,</span> <span class="mi">179</span><span class="p">,</span> <span class="mi">113</span><span class="p">),</span> <span class="p">[</span><span class="mi">0</span><span class="p">,</span> <span class="mi">25</span><span class="p">],</span> <span class="p">[</span><span class="mi">50</span><span class="p">,</span> <span class="mi">55</span><span class="p">],</span> <span class="mi">5</span><span class="p">)</span>
    ...
    <span class="c1"># Draw an antialiased circle with 3 pixels wide line</span>
    <span class="n">pygame</span><span class="o">.</span><span class="n">draw</span><span class="o">.</span><span class="n">aacircle</span><span class="p">(</span><span class="n">screen</span><span class="p">,</span> <span class="s2">&quot;green&quot;</span><span class="p">,</span> <span class="p">[</span><span class="mi">340</span><span class="p">,</span> <span class="mi">250</span><span class="p">],</span> <span class="mi">40</span><span class="p">,</span> <span class="mi">3</span><span class="p">)</span>

    <span class="c1"># Draw an antialiased top right circle quadrant with 4 pixels wide line</span>
    <span class="n">pygame</span><span class="o">.</span><span class="n">draw</span><span class="o">.</span><span class="n">aacircle</span><span class="p">(</span><span class="n">screen</span><span class="p">,</span> <span class="s2">&quot;red&quot;</span><span class="p">,</span> <span class="p">[</span><span class="mi">340</span><span class="p">,</span> <span class="mi">250</span><span class="p">],</span> <span class="mi">20</span><span class="p">,</span> <span class="mi">4</span><span class="p">,</span> <span class="n">draw_top_right</span><span class="o">=</span><span class="kc">True</span><span class="p">)</span>

    <span class="c1"># Draw an antialiased bottom left filled circle quadrant</span>
    <span class="n">pygame</span><span class="o">.</span><span class="n">draw</span><span class="o">.</span><span class="n">aacircle</span><span class="p">(</span><span class="n">screen</span><span class="p">,</span> <span class="s2">&quot;blue&quot;</span><span class="p">,</span> <span class="p">[</span><span class="mi">340</span><span class="p">,</span> <span class="mi">250</span><span class="p">],</span> <span class="mi">20</span><span class="p">,</span> <span class="n">draw_bottom_left</span><span class="o">=</span><span class="kc">True</span><span class="p">)</span>
