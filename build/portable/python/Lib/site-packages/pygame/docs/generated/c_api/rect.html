...
<html lang="en" data-content_root="../">
  <head>
    ...
    <title>Class Rect API exported by pygame.rect &#8212; pygame-ce v2.5.8 documentation</title>
...
<p>This extension module defines Python type <a class="tooltip reference internal" href="../ref/rect.html#pygame.Rect" title=""><code class="xref py py-class docutils literal notranslate"><span class="pre">pygame.Rect</span></code><span class="tooltip-content">pygame object for storing rectangular coordinates</span></a> &amp; <code class="xref py py-class docutils literal notranslate"><span class="pre">pygame.FRect</span></code>.</p>
...
<dl class="c type">
<dt class="sig sig-object c" id="c.pgFRectObject">
<span class="k"><span class="pre">type</span></span><span class="w"> </span><span class="sig-name descname"><span class="n"><span class="pre">pgFRectObject</span></span></span><a class="headerlink" href="#c.pgFRectObject" title="Link to this definition">¶</a><br /></dt>
<dd><dl class="c member">
<dt class="sig sig-object c" id="c.pgFRectObject.r">
<span class="n"><span class="pre">SDL_FRect</span></span><span class="w"> </span><span class="sig-name descname"><span class="n"><span class="pre">r</span></span></span><a class="headerlink" href="#c.pgFRectObject.r" title="Link to this definition">¶</a><br /></dt>
<dd></dd></dl>
...
<dl class="c var">
<dt class="sig sig-object c" id="c.pgFRect_Type">
<span class="n"><span class="pre">PyTypeObject</span></span><span class="w"> </span><span class="p"><span class="pre">*</span></span><span class="sig-name descname"><span class="n"><span class="pre">pgFRect_Type</span></span></span><a class="headerlink" href="#c.pgFRect_Type" title="Link to this definition">¶</a><br /></dt>
<dd><p>The Pygame rectangle object type pygame.FRect.</p>
</dd></dl>
...
<dl class="c function">
<dt class="sig sig-object c" id="c.pgFRect_AsRect">
<span class="n"><span class="pre">SDL_FRect</span></span><span class="w"> </span><span class="sig-name descname"><span class="n"><span class="pre">pgFRect_AsRect</span></span></span><span class="sig-paren">(</span><span class="n"><span class="pre">PyObject</span></span><span class="w"> </span><span class="p"><span class="pre">*</span></span><span class="n"><span class="pre">obj</span></span><span class="sig-paren">)</span><a class="headerlink" href="#c.pgFRect_AsRect" title="Link to this definition">¶</a><br /></dt>
<dd><p>A macro to access the SDL_FRect field of a <code class="xref py py-class docutils literal notranslate"><span class="pre">pygame.FRect</span></code> instance.</p>
</dd></dl>
...
<dl class="c function">
<dt class="sig sig-object c" id="c.pgFRect_New">
<span class="n"><span class="pre">PyObject</span></span><span class="w"> </span><span class="p"><span class="pre">*</span></span><span class="sig-name descname"><span class="n"><span class="pre">pgFRect_New</span></span></span><span class="sig-paren">(</span><span class="n"><span class="pre">SDL_FRect</span></span><span class="w"> </span><span class="p"><span class="pre">*</span></span><span class="n"><span class="pre">r</span></span><span class="sig-paren">)</span><a class="headerlink" href="#c.pgFRect_New" title="Link to this definition">¶</a><br /></dt>
<dd><p>Return a new <code class="xref py py-class docutils literal notranslate"><span class="pre">pygame.FRect</span></code> instance from the SDL_FRect <em>r</em>.
On failure, raise a Python exception and return <em>NULL</em>.</p>
</dd></dl>
...
<dl class="c function">
<dt class="sig sig-object c" id="c.pgFRect_New4">
<span class="n"><span class="pre">PyObject</span></span><span class="w"> </span><span class="p"><span class="pre">*</span></span><span class="sig-name descname"><span class="n"><span class="pre">pgFRect_New4</span></span></span><span class="sig-paren">(</span><span class="kt"><span class="pre">float</span></span><span class="w"> </span><span class="n"><span class="pre">x</span></span>, <span class="kt"><span class="pre">float</span></span><span class="w"> </span><span class="n"><span class="pre">y</span></span>, <span class="kt"><span class="pre">float</span></span><span class="w"> </span><span class="n"><span class="pre">w</span></span>, <span class="kt"><span class="pre">float</span></span><span class="w"> </span><span class="n"><span class="pre">h</span></span><span class="sig-paren">)</span><a class="headerlink" href="#c.pgFRect_New4" title="Link to this definition">¶</a><br /></dt>
<dd><p>Return a new pygame.FRect instance with position (<em>x</em>, <em>y</em>) and
size (<em>w</em>, <em>h</em>).
On failure raise a Python exception and return <em>NULL</em>.</p>
</dd></dl>
...
<dl class="c function">
<dt class="sig sig-object c" id="c.pgFRect_FromObject">
<span class="n"><span class="pre">SDL_FRect</span></span><span class="w"> </span><span class="p"><span class="pre">*</span></span><span class="sig-name descname"><span class="n"><span class="pre">pgFRect_FromObject</span></span></span><span class="sig-paren">(</span><span class="n"><span class="pre">PyObject</span></span><span class="w"> </span><span class="p"><span class="pre">*</span></span><span class="n"><span class="pre">obj</span></span>, <span class="n"><span class="pre">SDL_FRect</span></span><span class="w"> </span><span class="p"><span class="pre">*</span></span><span class="n"><span class="pre">temp</span></span><span class="sig-paren">)</span><a class="headerlink" href="#c.pgFRect_FromObject" title="Link to this definition">¶</a><br /></dt>
<dd><p>Translate a Python rectangle representation as a Pygame <code class="xref c c-type docutils literal notranslate"><span class="pre">SDL_FRect</span></code>.
A rectangle can be a length 4 sequence floats (x, y, w, h),
or a length 2 sequence of position (x, y) and size (w, h),
or a length 1 tuple containing a rectangle representation,
or have a method <em>rect</em> that returns a rectangle.
Pass a pointer to a locally declared <code class="xref c c-type docutils literal notranslate"><span class="pre">SDL_FRect</span></code> as <em>temp</em>.
Do not rely on this being filled in; use the function's return value instead.
On success, return a pointer to a <code class="xref c c-type docutils literal notranslate"><span class="pre">SDL_FRect</span></code> representation
of the rectangle, else return <em>NULL</em>.
No Python exceptions are raised.</p>
</dd></dl>
...
<dl class="c function">
<dt class="sig sig-object c" id="c.pgFRect_Normalize">
<span class="kt"><span class="pre">void</span></span><span class="w"> </span><span class="sig-name descname"><span class="n"><span class="pre">pgFRect_Normalize</span></span></span><span class="sig-paren">(</span><span class="n"><span class="pre">SDL_FRect</span></span><span class="w"> </span><span class="p"><span class="pre">*</span></span><span class="n"><span class="pre">rect</span></span><span class="sig-paren">)</span><a class="headerlink" href="#c.pgFRect_Normalize" title="Link to this definition">¶</a><br /></dt>
<dd><p>Normalize the given rect. A rect with a negative size (negative width and/or
height) will be adjusted to have a positive size.</p>
</dd></dl>
