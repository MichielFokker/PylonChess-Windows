...
<html lang="en" data-content_root="../">
  <head>
    ...
    <title>pygame.Surface &#8212; pygame-ce v2.5.8 documentation</title>
...
<div class="line"><span class="signature">Surface(size, flags=0, depth=0, masks=None) -&gt; Surface</span></div>
<div class="line"><span class="signature">Surface(size, flags=0, surface=...) -&gt; Surface</span></div>
</div>
...
<td>—</td>
<td>Draw another Surface onto this one.</td>
</tr>
...
<td>—</td>
<td>Draw many Surfaces onto this Surface at their corresponding location.</td>
</tr>
...
<td>—</td>
<td>Draw many Surfaces onto this Surface at their corresponding location and with the same special_flags.</td>
</tr>
...
<td>—</td>
<td>Change the pixel format of a Surface.</td>
</tr>
...
<td>—</td>
<td>Change the pixel format of a Surface including per pixel alphas.</td>
</tr>
...
<td>—</td>
<td>Shift the Surface pixels in place.</td>
</tr>
...
<td>—</td>
<td>Set the alpha value for the full Surface.</td>
</tr>
...
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="surface.html#pygame.Surface.get_frect">pygame.Surface.get_frect</a></div>
</td>
<td>—</td>
<td>Get the rectangular area of the Surface.</td>
</tr>
...
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="surface.html#pygame.Surface.premul_alpha_ip">pygame.Surface.premul_alpha_ip</a></div>
</td>
<td>—</td>
<td>Multiplies the RGB channels by the Surface alpha channel.</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="surface.html#pygame.Surface.width">pygame.Surface.width</a></div>
</td>
<td>—</td>
<td>Surface width in pixels (read-only).</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="surface.html#pygame.Surface.height">pygame.Surface.height</a></div>
</td>
<td>—</td>
<td>Surface height in pixels (read-only).</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="surface.html#pygame.Surface.size">pygame.Surface.size</a></div>
</td>
<td>—</td>
<td>Surface size in pixels (read-only).</td>
</tr>
...
formats.</p>
<p>Advanced users can combine a set of bitmasks with a depth value. The masks
...
<dd><div class="line-block">
<div class="line"><span class="summaryline">Draw another Surface onto this one.</span></div>
<div class="line"><span class="signature">blit(source, dest=(0, 0), area=None, special_flags=0) -&gt; Rect</span></div>
</div>
<p>Draws another Surface onto this Surface.</p>
<dl>
<dt><strong>Parameters</strong></dt><dd><ul class="simple">
<li><dl class="simple">
<dt><code class="docutils literal notranslate"><span class="pre">source</span></code></dt><dd><p>The <code class="docutils literal notranslate"><span class="pre">Surface</span></code> object to draw onto this <code class="docutils literal notranslate"><span class="pre">Surface</span></code>.
If it has transparency, transparent pixels will be ignored when blitting to an 8-bit <code class="docutils literal notranslate"><span class="pre">Surface</span></code>.</p>
</dd>
</dl>
</li>
<li><dl class="simple">
<dt><code class="docutils literal notranslate"><span class="pre">dest</span></code> <em>(optional)</em></dt><dd><p>The <code class="docutils literal notranslate"><span class="pre">source</span></code> draw position onto this <code class="docutils literal notranslate"><span class="pre">Surface</span></code>, defaults to (0, 0).
It can be a coordinate pair <code class="docutils literal notranslate"><span class="pre">(x,</span> <span class="pre">y)</span></code> or a <code class="docutils literal notranslate"><span class="pre">Rect</span></code> (using its top-left corner).
If a <code class="docutils literal notranslate"><span class="pre">Rect</span></code> is passed, its size will not affect the blit.</p>
</dd>
</dl>
</li>
<li><dl class="simple">
<dt><code class="docutils literal notranslate"><span class="pre">area</span></code> <em>(optional)</em></dt><dd><p>The rectangular portion of the <code class="docutils literal notranslate"><span class="pre">source</span></code> to draw.
It can be a <code class="docutils literal notranslate"><span class="pre">Rect</span></code> object representing that section. If <code class="docutils literal notranslate"><span class="pre">None</span></code> or not provided,
the entire source Surface will be drawn.
If the <code class="docutils literal notranslate"><span class="pre">Rect</span></code> has negative position, the final blit position will be
<code class="docutils literal notranslate"><span class="pre">dest</span></code> - <code class="docutils literal notranslate"><span class="pre">Rect.topleft</span></code>.</p>
</dd>
</dl>
</li>
<li><dl class="simple">
<dt><code class="docutils literal notranslate"><span class="pre">special_flags</span></code> <em>(optional)</em></dt><dd><p>Controls how the colors of the <code class="docutils literal notranslate"><span class="pre">source</span></code> are combined with this Surface.
If not provided it defaults to <code class="docutils literal notranslate"><span class="pre">BLENDMODE_NONE</span></code> (<code class="docutils literal notranslate"><span class="pre">0</span></code>).
See <a class="reference internal" href="special_flags_list.html"><span class="doc">special flags</span></a> for a list of possible values.</p>
</dd>
</dl>
</li>
</ul>
</dd>
<dt><strong>Return</strong></dt><dd><p>A <a class="tooltip reference internal" href="rect.html" title=""><span class="doc">pygame.Rect</span><span class="tooltip-content">pygame object for storing rectangular coordinates</span></a> object representing the affected area of this <code class="docutils literal notranslate"><span class="pre">Surface</span></code> that was modified
by the blit operation. This area includes only the pixels within this <code class="docutils literal notranslate"><span class="pre">Surface</span></code> or
its clipping area (see <a class="reference internal" href="#pygame.Surface.set_clip" title="pygame.Surface.set_clip"><code class="xref py py-meth docutils literal notranslate"><span class="pre">set_clip()</span></code></a>).
Generally you don't need to use this return value, as it was initially designed to
pass it to <a class="tooltip reference internal" href="display.html#pygame.display.update" title=""><code class="xref py py-meth docutils literal notranslate"><span class="pre">pygame.display.update()</span></code><span class="tooltip-content">Update all, or a portion, of the display. For non-OpenGL displays.</span></a> to optimize the updating of the display.
Since modern computers are fast enough to update the entire display at high speeds,
this return value is rarely used nowadays.</p>
</dd>
<dt><strong>Example Use</strong></dt><dd><div class="highlight-python notranslate"><div class="highlight"><pre><span></span><span class="c1"># create a Surface of size 50x50 and fill it with red color</span>
<span class="n">red_surf</span> <span class="o">=</span> <span class="n">pygame</span><span class="o">.</span><span class="n">Surface</span><span class="p">((</span><span class="mi">50</span><span class="p">,</span> <span class="mi">50</span><span class="p">))</span>
<span class="n">red_surf</span><span class="o">.</span><span class="n">fill</span><span class="p">(</span><span class="s2">&quot;red&quot;</span><span class="p">)</span>

<span class="c1"># draw the Surface on another Surface at position (0, 0)</span>
<span class="n">another_surface</span><span class="o">.</span><span class="n">blit</span><span class="p">(</span><span class="n">red_surf</span><span class="p">,</span> <span class="p">(</span><span class="mi">0</span><span class="p">,</span> <span class="mi">0</span><span class="p">))</span>
</pre></div>
</div>
</dd>
<dt><strong>Notes</strong></dt><dd><ul class="simple">
<li><p>When self-blitting and there is a colorkey or alpha transparency set, resulting colors
may appear slightly different compared to a non-self blit.</p></li>
<li><p>The blit is ignored if the <code class="docutils literal notranslate"><span class="pre">source</span></code> is positioned completely outside this <code class="docutils literal notranslate"><span class="pre">Surface</span></code>'s
clipping area. Otherwise only the overlapping area will be drawn.</p></li>
</ul>
</dd>
</dl>
<div class="versionchanged">
<p><span class="versionmodified changed">Changed in pygame-ce 2.5.1: </span>The dest argument is optional and defaults to (0, 0)</p>
</div>
</dd></dl>
...
<dd><div class="line-block">
<div class="line"><span class="summaryline">Draw many Surfaces onto this Surface at their corresponding location.</span></div>
<div class="line"><span class="signature">blits(blit_sequence, doreturn=1) -&gt; list[Rect] | None</span></div>
</div>
<p>The <code class="docutils literal notranslate"><span class="pre">blits</span></code> method efficiently draws a sequence of Surfaces onto this <code class="docutils literal notranslate"><span class="pre">Surface</span></code>.</p>
<p><strong>Parameters</strong></p>
<blockquote>
<div><dl class="simple">
<dt><code class="docutils literal notranslate"><span class="pre">blit_sequence</span></code></dt><dd><p>A sequence that contains each Surface to be drawn along with its associated blit
arguments. See the <strong>Sequence Item Formats</strong> section below for the possible formats.</p>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">doreturn</span></code> (optional)</dt><dd><p>The <code class="docutils literal notranslate"><span class="pre">doreturn</span></code> parameter controls the return value. When set to <code class="docutils literal notranslate"><span class="pre">True</span></code>, it returns
a list of rectangles representing the changed areas. When set to <code class="docutils literal notranslate"><span class="pre">False</span></code>, returns
...
<blockquote>
<div><p>A list of rectangles or <code class="docutils literal notranslate"><span class="pre">None</span></code>.</p>
</div></blockquote>
<p><strong>Sequence Item Formats</strong></p>
<blockquote>
<div><dl class="simple">
<dt><code class="docutils literal notranslate"><span class="pre">(source,</span> <span class="pre">dest)</span></code></dt><dd><ul class="simple">
<li><p><code class="docutils literal notranslate"><span class="pre">source</span></code>: Surface object to be drawn.</p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">dest</span></code>: Position where the source Surface should be blitted.</p></li>
</ul>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">(source,</span> <span class="pre">dest,</span> <span class="pre">area)</span></code></dt><dd><ul class="simple">
<li><p><code class="docutils literal notranslate"><span class="pre">area</span></code>: (optional) Specific area of the source Surface to be drawn.</p></li>
</ul>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">(source,</span> <span class="pre">dest,</span> <span class="pre">area,</span> <span class="pre">special_flags)</span></code></dt><dd><ul class="simple">
<li><p><code class="docutils literal notranslate"><span class="pre">special_flags</span></code>: (optional) Controls the blending mode for drawing colors.
See <a class="reference internal" href="special_flags_list.html"><span class="doc">special flags</span></a> for a list of possible values.</p></li>
</ul>
</dd>
</dl>
</div></blockquote>
...
<blockquote>
<div><ul class="simple">
<li><p><code class="docutils literal notranslate"><span class="pre">blits</span></code> is an advanced method. It is recommended to read the documentation
of <a class="reference internal" href="#pygame.Surface.blit" title="pygame.Surface.blit"><code class="xref py py-meth docutils literal notranslate"><span class="pre">blit()</span></code></a> first.</p></li>
<li><p>To draw a <code class="docutils literal notranslate"><span class="pre">Surface</span></code> with a special flag, you must specify an area as well, e.g.,
<code class="docutils literal notranslate"><span class="pre">(source,</span> <span class="pre">dest,</span> <span class="pre">None,</span> <span class="pre">special_flags)</span></code>.</p></li>
<li><p>Prefer using <a class="reference internal" href="#pygame.Surface.blits" title="pygame.Surface.blits"><code class="xref py py-meth docutils literal notranslate"><span class="pre">blits()</span></code></a> over <a class="reference internal" href="#pygame.Surface.blit" title="pygame.Surface.blit"><code class="xref py py-meth docutils literal notranslate"><span class="pre">blit()</span></code></a> when drawing multiple Surfaces
for better performance. Use <a class="reference internal" href="#pygame.Surface.blit" title="pygame.Surface.blit"><code class="xref py py-meth docutils literal notranslate"><span class="pre">blit()</span></code></a> if you need to draw a single Surface.</p></li>
<li><p>For drawing a sequence of (source, dest) pairs with whole source Surface
and a singular special_flag, use the <a class="reference internal" href="#pygame.Surface.fblits" title="pygame.Surface.fblits"><code class="xref py py-meth docutils literal notranslate"><span class="pre">fblits()</span></code></a> method.</p></li>
</ul>
</div></blockquote>
<div class="versionaddedold">
...
<span class="sig-name descname"><span class="pre">fblits</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#pygame.Surface.fblits" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">Draw many Surfaces onto this Surface at their corresponding location and with the same special_flags.</span></div>
<div class="line"><span class="signature">fblits(blit_sequence, special_flags=0, /) -&gt; None</span></div>
</div>
...
mode specified by special_flags.</p>
<dl class="field-list simple">
<dt class="field-odd">Parameters<span class="colon">:</span></dt>
<dd class="field-odd"><ul class="simple">
<li><p><strong>blit_sequence</strong> -- a sequence of (source, dest)</p></li>
<li><p><strong>special_flags</strong> -- the flag(s) representing the blend mode used for each Surface.
See <a class="reference internal" href="special_flags_list.html"><span class="doc">special flags</span></a> for a list of possible values.</p></li>
</ul>
</dd>
<dt class="field-even">Returns<span class="colon">:</span></dt>
<dd class="field-even"><p><code class="docutils literal notranslate"><span class="pre">None</span></code> (unlike <cite>blit()</cite> and <cite>blits()</cite>)</p>
</dd>
</dl>
...
<p><span class="versionmodified added">New in pygame-ce 2.1.4.</span></p>
</div>
</dd></dl>
...
<dd><div class="line-block">
<div class="line"><span class="summaryline">Change the pixel format of a Surface.</span></div>
...
<div class="versionchanged">
<p><span class="versionmodified changed">Changed in pygame-ce 2.5.0: </span>converting to a known format will succeed without
a window/display Surface.</p>
</div>
</dd></dl>
...
<dd><div class="line-block">
<div class="line"><span class="summaryline">Change the pixel format of a Surface including per pixel alphas.</span></div>
...
be optimized for fast alpha blitting to it.</p>
...
<div class="versionchanged">
<p><span class="versionmodified changed">Changed in pygame-ce 2.4.0: </span>'Surface' argument deprecated.</p>
</div>
</dd></dl>
...
attributes then it should override <code class="docutils literal notranslate"><span class="pre">copy()</span></code>. Shallow copy and deepcopy
are supported, Surface implements __copy__ and __deepcopy__ respectively.</p>
<p>If the Surface is a subsurface, the returned Surface will <em>not</em> retain
the parent and will be a regular Surface with its own pixel data.</p>
<div class="versionadded">
<p><span class="versionmodified added">New in pygame-ce 2.3.1: </span>Added support for deepcopy by implementing __deepcopy__, calls copy() internally.</p>
</div>
</dd></dl>
...
<p>The color argument should be compatible with <a class="reference internal" href="typing.html#pygame.typing.ColorLike" title="pygame.typing.ColorLike"><code class="xref py py-data docutils literal notranslate"><span class="pre">pygame.typing.ColorLike</span></code></a>.
If using <code class="docutils literal notranslate"><span class="pre">RGBA</span></code>, the Alpha (A part of <code class="docutils literal notranslate"><span class="pre">RGBA</span></code>) is ignored unless the Surface
uses per pixel alpha (Surface has the <code class="docutils literal notranslate"><span class="pre">SRCALPHA</span></code> flag).</p>
<p>The special_flags argument controls how the colors are combined. See <a class="reference internal" href="special_flags_list.html"><span class="doc">special flags</span></a>
for a list of possible values.</p>
<p>This will return the affected Surface area.</p>
<div class="admonition note">
<p class="admonition-title">Note</p>
<p>As of pygame-ce version 2.5.1, a long-standing bug has been fixed!
Now when passing in a <code class="docutils literal notranslate"><span class="pre">Rect</span></code> with negative <code class="docutils literal notranslate"><span class="pre">x</span></code> or negative <code class="docutils literal notranslate"><span class="pre">y</span></code> (or both),
the <code class="docutils literal notranslate"><span class="pre">Rect</span></code> filled will no longer be shifted to <code class="docutils literal notranslate"><span class="pre">(0,</span> <span class="pre">0)</span></code>, but instead only the
part of the <code class="docutils literal notranslate"><span class="pre">Rect</span></code> overlapping the window's <code class="docutils literal notranslate"><span class="pre">Rect</span></code> will be filled.</p>
</div>
</dd></dl>
...
<dd><div class="line-block">
<div class="line"><span class="summaryline">Shift the Surface pixels in place.</span></div>
<div class="line"><span class="signature">scroll(dx=0, dy=0, scroll_flag=0, /) -&gt; None</span></div>
</div>
<p>Move the Surface by dx pixels right and dy pixels down. dx and dy may be
negative for left and up scrolls respectively.</p>
<p>Scrolling is contained by the Surface clip area. It is safe to have dx
and dy values that exceed the Surface size.</p>
<dl class="simple">
<dt>The scroll flag can be:</dt><dd><ul class="simple">
<li><p><code class="docutils literal notranslate"><span class="pre">0</span></code> (default): the pixels are shifted but previous pixels are
not modified.</p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">pygame.SCROLL_ERASE</span></code>: the space created by the shifting pixels
is filled with black or transparency.</p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">pygame.SCROLL_REPEAT</span></code>: the pixels that disappear out of the
Surface or clip bounds are brought back on the opposite side
resulting in an infinitely scrolling and repeating Surface.</p></li>
</ul>
</dd>
</dl>
<div class="versionaddedold">
...
<div class="versionchanged">
<p><span class="versionmodified changed">Changed in pygame-ce 2.5.3: </span>Add repeating scroll and allow erasing pixels</p>
</div>
</dd></dl>
...
<div class="line"><span class="signature">set_colorkey(color, /) -&gt; None</span></div>
</div>
...
will be transparent. The color should be compatible with <a class="reference internal" href="typing.html#pygame.typing.ColorLike" title="pygame.typing.ColorLike"><code class="xref py py-data docutils literal notranslate"><span class="pre">pygame.typing.ColorLike</span></code></a>.
If <code class="docutils literal notranslate"><span class="pre">None</span></code> is passed, the colorkey will be unset.</p>
...
<div class="line"><span class="signature">get_colorkey() -&gt; tuple[int, int, int, int] | None</span></div>
</div>
...
<dd><div class="line-block">
<div class="line"><span class="summaryline">Set the alpha value for the full Surface.</span></div>
<div class="line"><span class="signature">set_alpha(value, flags=0, /) -&gt; None</span></div>
<div class="line"><span class="signature">set_alpha(value, /) -&gt; None</span></div>
</div>
...
kinds of transparency.</p>
<p>The optional flags argument can be set to <code class="docutils literal notranslate"><span class="pre">pygame.RLEACCEL</span></code> to provide
better performance on non accelerated displays. An <code class="docutils literal notranslate"><span class="pre">RLEACCEL</span></code> Surface
will be slower to modify, but quicker to blit as a source.</p>
<div class="versionchangedold">
...
<div class="line"><span class="signature">get_alpha() -&gt; int | None</span></div>
</div>
<p>Return the current alpha value for the Surface, which is an integer in the
range 0 (fully transparent) - 255 (fully opaque) set by <a class="reference internal" href="#pygame.Surface.set_alpha" title="pygame.Surface.set_alpha"><code class="xref py py-meth docutils literal notranslate"><span class="pre">set_alpha()</span></code></a>.
Until an alpha is set this method will return None.</p>
</dd></dl>
...
<div class="line"><span class="signature">get_locks() -&gt; tuple[Any, ...]</span></div>
</div>
...
<div class="line"><span class="signature">get_at(x_y, /) -&gt; Color</span></div>
</div>
...
<div class="versionchanged">
<p><span class="versionmodified changed">Changed in pygame-ce 2.3.1: </span>can now also accept both float coordinates and
Vector2s for pixels.</p>
</div>
<div class="versionchangedold">
<p><span class="versionmodified changed">Changed in pygame 1.9: </span>Returning a Color instead of tuple. Use <code class="docutils literal notranslate"><span class="pre">tuple(surf.get_at((x,y)))</span></code>
...
<div class="line"><span class="signature">set_at(x_y, color, /) -&gt; None</span></div>
</div>
<p>Set the color of a single pixel at the specified coordinates to be a
<a class="reference internal" href="typing.html#pygame.typing.ColorLike" title="pygame.typing.ColorLike"><code class="xref py py-data docutils literal notranslate"><span class="pre">pygame.typing.ColorLike</span></code></a> value. If the Surface does not have per pixel alphas,
the alpha value is ignored. Setting pixels outside the Surface area or outside
the Surface clipping will have no effect.</p>
<p>Getting and setting pixels one at a time is generally too slow to be used
...
<div class="line"><span class="signature">get_at_mapped(x_y, /) -&gt; int</span></div>
</div>
...
<div class="line"><span class="signature">get_palette() -&gt; list[Color]</span></div>
</div>
...
<div class="line"><span class="signature">get_palette_at(index, /) -&gt; Color</span></div>
</div>
...
<div class="line"><span class="signature">set_palette(palette, /) -&gt; None</span></div>
</div>
...
<div class="line"><span class="signature">set_palette_at(index, color, /) -&gt; None</span></div>
</div>
...
<div class="line"><span class="signature">map_rgb(color, /) -&gt; int</span></div>
</div>
<p>Convert a <a class="reference internal" href="typing.html#pygame.typing.ColorLike" title="pygame.typing.ColorLike"><code class="xref py py-data docutils literal notranslate"><span class="pre">pygame.typing.ColorLike</span></code></a> into the mapped integer value
...
but can be passed to most functions that require a Surface and a color.</p>
...
Surface. If the Surface has had <code class="docutils literal notranslate"><span class="pre">None</span></code> set for the clipping area, the
...
<div class="line"><span class="signature">subsurface(left_top, width_height, /) -&gt; Surface</span></div>
<div class="line"><span class="signature">subsurface(left, top, width, height, /) -&gt; Surface</span></div>
</div>
...
<p>Returns the top level parent Surface of a subsurface. If this is not
a subsurface then this Surface will be returned.</p>
</dd></dl>
...
<div class="line"><span class="signature">get_offset() -&gt; tuple[int, int]</span></div>
</div>
...
<div class="line"><span class="signature">get_abs_offset() -&gt; tuple[int, int]</span></div>
</div>
...
<div class="line"><span class="signature">get_size() -&gt; tuple[int, int]</span></div>
</div>
<p>Return the width and height of the Surface in pixels. Can also be accessed
with <a class="reference internal" href="#pygame.Surface.size" title="pygame.Surface.size"><code class="xref py py-attr docutils literal notranslate"><span class="pre">size</span></code></a></p>
</dd></dl>
...
<div class="line"><span class="signature">get_width() -&gt; int</span></div>
</div>
<p>Return the width of the Surface in pixels. Can also be accessed with <a class="reference internal" href="#pygame.Surface.width" title="pygame.Surface.width"><code class="xref py py-attr docutils literal notranslate"><span class="pre">width</span></code></a></p>
</dd></dl>
...
<p>Return the height of the Surface in pixels. Can also be accessed with <a class="reference internal" href="#pygame.Surface.height" title="pygame.Surface.height"><code class="xref py py-attr docutils literal notranslate"><span class="pre">height</span></code></a></p>
</dd></dl>
...
always start at (0, 0) with a width and height the same size as the Surface.</p>
...
such as <code class="docutils literal notranslate"><span class="pre">size</span></code> or <code class="docutils literal notranslate"><span class="pre">w</span></code> can also be applied to resize the Rect.</p>
</dd></dl>

<dl class="py method definition">
<dt class="sig sig-object py title" id="pygame.Surface.get_frect">
<span class="sig-name descname"><span class="pre">get_frect</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#pygame.Surface.get_frect" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">Get the rectangular area of the Surface.</span></div>
<div class="line"><span class="signature">get_frect(**kwargs) -&gt; FRect</span></div>
</div>
<p>This is the same as <a class="reference internal" href="#pygame.Surface.get_rect" title="pygame.Surface.get_rect"><code class="xref py py-meth docutils literal notranslate"><span class="pre">Surface.get_rect()</span></code></a> but returns an FRect. FRect is similar
to Rect, except it stores float values instead.</p>
<p>You can pass keyword argument values to this function. These named values
will be applied to the attributes of the FRect before it is returned. An
example would be <code class="docutils literal notranslate"><span class="pre">mysurf.get_frect(center=(100.5,</span> <span class="pre">100.5))</span></code> to create a
rectangle for the Surface centered at a given position. Size attributes
such as <code class="docutils literal notranslate"><span class="pre">size</span></code> or <code class="docutils literal notranslate"><span class="pre">w</span></code> can also be applied to resize the FRect.</p>
<div class="versionadded">
<p><span class="versionmodified added">New in pygame-ce 2.3.0.</span></p>
</div>
</dd></dl>
...
<div class="line"><span class="signature">get_masks() -&gt; tuple[int, int, int, int]</span></div>
</div>
...
<div class="line"><span class="signature">set_masks(color, /) -&gt; None</span></div>
</div>
...
<div class="line"><span class="signature">get_shifts() -&gt; tuple[int, int, int, int]</span></div>
</div>
...
<div class="line"><span class="signature">set_shifts(color, /) -&gt; None</span></div>
</div>
<p>This is not needed for normal pygame usage.</p>
<div class="admonition note">
<p class="admonition-title">Note</p>
...
<div class="line"><span class="signature">get_losses() -&gt; tuple[int, int, int, int]</span></div>
</div>
...
<p>Returns a copy of the initial Surface with the red, green and blue color
...
after blitting if the BLEND_PREMULTIPLED special flag is used.</p>
<p>It is worth noting that after calling this method, methods that return the
...
zeros in the color and alpha channels).</p>
<p>If you call this method, and then call it again, it will multiply the color
...
intended for pre-multiplied alpha blending.</p>
<p>Surfaces without an alpha channel cannot use this method and will return
...
accelerated by SIMD versions of the pre-multiplied blitter.</p>
<p>In general pre-multiplied alpha blitting is faster then 'straight alpha'
...
alpha colors.</p>
<p>There is a <a class="reference external" href="../tutorials/en/premultiplied-alpha.html">tutorial on premultiplied alpha blending here.</a></p>
<div class="versionadded">
<p><span class="versionmodified added">New in pygame-ce 2.1.4.</span></p>
</div>
</dd></dl>
...
<dl class="py method definition">
<dt class="sig sig-object py title" id="pygame.Surface.premul_alpha_ip">
<span class="sig-name descname"><span class="pre">premul_alpha_ip</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#pygame.Surface.premul_alpha_ip" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">Multiplies the RGB channels by the Surface alpha channel.</span></div>
<div class="line"><span class="signature">premul_alpha_ip() -&gt; Surface</span></div>
</div>
<p>Multiplies the RGB channels of the Surface by the alpha channel in place
and returns the Surface.</p>
<p>Surfaces without an alpha channel cannot use this method and will return
an error if you use it on them. It is best used on 32 bit Surfaces (the
default on most platforms) as the blitting on these Surfaces can be
accelerated by SIMD versions of the pre-multiplied blitter.</p>
<p>Refer to the <a class="reference internal" href="#pygame.Surface.premul_alpha" title="pygame.Surface.premul_alpha"><code class="xref py py-meth docutils literal notranslate"><span class="pre">premul_alpha()</span></code></a> method for more information.</p>
<div class="versionadded">
<p><span class="versionmodified added">New in pygame-ce 2.5.1.</span></p>
</div>
</dd></dl>

<dl class="py property definition">
<dt class="sig sig-object py title" id="pygame.Surface.width">
<em class="property"><span class="pre">property</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">width</span></span><em class="property"><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">int</span></em><a class="headerlink" href="#pygame.Surface.width" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">Surface width in pixels (read-only).</span></div>
<div class="line"><span class="signature">width -&gt; int</span></div>
</div>
<p>Read-only attribute. Same as <a class="reference internal" href="#pygame.Surface.get_width" title="pygame.Surface.get_width"><code class="xref py py-meth docutils literal notranslate"><span class="pre">get_width()</span></code></a></p>
<div class="versionadded">
...
<dl class="py property definition">
<dt class="sig sig-object py title" id="pygame.Surface.height">
<em class="property"><span class="pre">property</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">height</span></span><em class="property"><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">int</span></em><a class="headerlink" href="#pygame.Surface.height" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">Surface height in pixels (read-only).</span></div>
<div class="line"><span class="signature">height -&gt; int</span></div>
</div>
<p>Read-only attribute. Same as <a class="reference internal" href="#pygame.Surface.get_height" title="pygame.Surface.get_height"><code class="xref py py-meth docutils literal notranslate"><span class="pre">get_height()</span></code></a></p>
<div class="versionadded">
<p><span class="versionmodified added">New in pygame-ce 2.5.0.</span></p>
</div>
</dd></dl>
...
<dl class="py property definition">
<dt class="sig sig-object py title" id="pygame.Surface.size">
<em class="property"><span class="pre">property</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">size</span></span><em class="property"><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">tuple</span><span class="p"><span class="pre">[</span></span><span class="pre">int</span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="pre">int</span><span class="p"><span class="pre">]</span></span></em><a class="headerlink" href="#pygame.Surface.size" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">Surface size in pixels (read-only).</span></div>
<div class="line"><span class="signature">size -&gt; tuple[int, int]</span></div>
</div>
<p>Read-only attribute. Same as <a class="reference internal" href="#pygame.Surface.get_size" title="pygame.Surface.get_size"><code class="xref py py-meth docutils literal notranslate"><span class="pre">get_size()</span></code></a></p>
<div class="versionadded">
<p><span class="versionmodified added">New in pygame-ce 2.5.0.</span></p>
</div>
</dd></dl>
...
<em class="property"><span class="pre">property</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">_pixels_address</span></span><em class="property"><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">int</span></em><a class="headerlink" href="#pygame.Surface._pixels_address" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
