...
<html lang="en" data-content_root="../">
  <head>
    ...
    <title>pygame.mixer.music &#8212; pygame-ce v2.5.8 documentation</title>
...
MP3 in most cases.</p>
<p>For a complete list of supported file formats, see the <a class="tooltip reference internal" href="mixer.html#module-pygame.mixer" title=""><code class="xref py py-mod docutils literal notranslate"><span class="pre">pygame.mixer</span></code><span class="tooltip-content">pygame module for loading and playing sounds</span></a> doc page.</p>
...
<p><span class="versionmodified changed">Changed in pygame-ce 2.2.0: </span>Raises <code class="docutils literal notranslate"><span class="pre">FileNotFoundError</span></code> instead of <a class="tooltip reference internal" href="pygame.html#pygame.error" title=""><code class="xref py py-exc docutils literal notranslate"><span class="pre">pygame.error</span></code><span class="tooltip-content">standard pygame exception</span></a> if file cannot be found</p>
</div>
</dd></dl>
...
<div class="admonition note">
<p class="admonition-title">Note</p>
<p>See <a class="reference internal" href="mixer.html#pygame.mixer.Sound.set_volume" title="pygame.mixer.Sound.set_volume"><code class="xref py py-func docutils literal notranslate"><span class="pre">mixer.Sound.set_volume()</span></code></a> for more information regarding how the value is stored internally</p>
</div>
</dd></dl>
...
<div class="admonition note">
<p class="admonition-title">Note</p>
<p>See <a class="reference internal" href="mixer.html#pygame.mixer.Sound.set_volume" title="pygame.mixer.Sound.set_volume"><code class="xref py py-func docutils literal notranslate"><span class="pre">mixer.Sound.set_volume()</span></code></a> for more information regarding the returned value</p>
</div>
</dd></dl>
...
better positioning support than earlier ones. A <a class="tooltip reference internal" href="pygame.html#pygame.error" title=""><code class="xref py py-exc docutils literal notranslate"><span class="pre">pygame.error</span></code><span class="tooltip-content">standard pygame exception</span></a> is
raised if a particular format does not support positioning.</p>
<p>Function <a class="reference internal" href="#pygame.mixer.music.set_pos" title="pygame.mixer.music.set_pos"><code class="xref py py-func docutils literal notranslate"><span class="pre">set_pos()</span></code></a> calls underlying SDL_mixer function
...
<p>Returns -1 if <code class="docutils literal notranslate"><span class="pre">get_pos</span></code> failed due to music not playing.</p>
</dd></dl>
...
<span class="sig-prename descclassname"><span class="pre">pygame.mixer.music.</span></span><span class="sig-name descname"><span class="pre">get_metadata</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#pygame.mixer.music.get_metadata" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
