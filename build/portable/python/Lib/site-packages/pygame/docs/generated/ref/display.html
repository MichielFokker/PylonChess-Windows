...
<html lang="en" data-content_root="../">
  <head>
    ...
    <title>pygame.display &#8212; pygame-ce v2.5.8 documentation</title>
...
<td>—</td>
<td>Update all, or a portion, of the display. For non-OpenGL displays.</td>
</tr>
...
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="display.html#pygame.display.get_window_position">pygame.display.get_window_position</a></div>
</td>
<td>—</td>
<td>Return the position of the window or screen.</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="display.html#pygame.display.set_window_position">pygame.display.set_window_position</a></div>
</td>
<td>—</td>
<td>Set the current window position.</td>
</tr>
...
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="display.html#pygame.display.is_fullscreen">pygame.display.is_fullscreen</a></div>
</td>
<td>—</td>
<td>Returns True if the pygame window created by pygame.display.set_mode() is in full-screen mode.</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="display.html#pygame.display.is_vsync">pygame.display.is_vsync</a></div>
</td>
<td>—</td>
<td>Returns True if vertical synchronisation for pygame.display.flip() and pygame.display.update() is enabled.</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="display.html#pygame.display.get_current_refresh_rate">pygame.display.get_current_refresh_rate</a></div>
</td>
<td>—</td>
<td>Returns the screen refresh rate or 0 if unknown.</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="display.html#pygame.display.get_desktop_refresh_rates">pygame.display.get_desktop_refresh_rates</a></div>
</td>
<td>—</td>
<td>Returns the screen refresh rates for all displays (in windowed mode).</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="display.html#pygame.display.message_box">pygame.display.message_box</a></div>
</td>
<td>—</td>
<td>Create a native GUI message box.</td>
</tr>
</tbody>
</table>
...
<code class="docutils literal notranslate"><span class="pre">pygame.RESIZABLE</span></code> flag, <code class="docutils literal notranslate"><span class="pre">pygame.VIDEORESIZE</span></code> event(s) will be sent when the
...
that draw direct to the screen will get <code class="docutils literal notranslate"><span class="pre">pygame.VIDEOEXPOSE</span></code> events when
portions of the window must be redrawn.</p>
...
<span class="n">Unix</span>    <span class="p">:</span> <span class="n">x11</span><span class="p">,</span> <span class="n">dga</span><span class="p">,</span> <span class="n">fbcon</span><span class="p">,</span> <span class="n">directfb</span><span class="p">,</span> <span class="n">ggi</span><span class="p">,</span> <span class="n">vgl</span><span class="p">,</span> <span class="n">svgalib</span><span class="p">,</span> <span class="n">aalib</span><span class="p">,</span> <span class="n">wayland</span>
</pre></div>
</div>
<dl class="field-list simple">
<dt class="field-odd">Note<span class="colon">:</span></dt>
<dd class="field-odd"><p>On wayland desktops, pygame-ce may choose to use the X11 video driver to run on Xwayland.
...
by setting the <code class="docutils literal notranslate"><span class="pre">SDL_VIDEODRIVER</span></code> environment variable to <code class="docutils literal notranslate"><span class="pre">&quot;wayland&quot;</span></code></p>
</dd>
</dl>
...
<p><span class="versionmodified changed">Changed in pygame-ce 2.5.0: </span>the manylinux wheels distributed by us now support the <code class="docutils literal notranslate"><span class="pre">wayland</span></code> videodriver</p>
</div>
</dd></dl>
...
<p>This will create a window or display output and return a display Surface.
The arguments passed in are requests for a display type. The actual created
display will be the best possible match supported by the system.</p>
...
<p>If no size is passed or is set to <code class="docutils literal notranslate"><span class="pre">(0,</span> <span class="pre">0)</span></code>, the created Surface will have
the same size as the current screen resolution. If only the width or height
are set to <code class="docutils literal notranslate"><span class="pre">0</span></code>, the Surface will have the same width or height as the
screen resolution.</p>
<p>Since pygame 2, the depth argument is ignored, in favour of the best
and fastest one. It also raises a deprecation warning since pygame-ce
2.4.0 if the passed in depth is not 0 or the one pygame selects.</p>
...
<div class="versionaddedold">
<p><span class="versionmodified added">New in pygame 2.0.0: </span><code class="docutils literal notranslate"><span class="pre">vsync</span></code> parameter</p>
</div>
...
graphics drivers. Subsequent calls to <a class="tooltip reference internal" href="#pygame.display.flip" title=""><code class="xref py py-func docutils literal notranslate"><span class="pre">pygame.display.flip()</span></code><span class="tooltip-content">Update the full display Surface to the screen.</span></a> or
<a class="tooltip reference internal" href="#pygame.display.update" title=""><code class="xref py py-func docutils literal notranslate"><span class="pre">pygame.display.update()</span></code><span class="tooltip-content">Update all, or a portion, of the display. For non-OpenGL displays.</span></a> will block (i.e. <em>wait</em>) until the screen
has refreshed, in order to prevent &quot;screen tearing&quot;
&lt;<a class="reference external" href="https://en.wikipedia.org/wiki/Screen_tearing">https://en.wikipedia.org/wiki/Screen_tearing</a>&gt;.</p>
<p>Be careful when using this feature together with <code class="docutils literal notranslate"><span class="pre">pygame.time.Clock</span></code> or
<a class="tooltip reference internal" href="time.html#pygame.time.delay" title=""><code class="xref py py-func docutils literal notranslate"><span class="pre">pygame.time.delay()</span></code><span class="tooltip-content">Pause the program for an amount of time.</span></a>, as multiple forms of waiting and frame rate
limiting may interact to cause skipped frames.</p>
<p>The request only works when graphics acceleration is available on the
system. The exact behaviour depends on the hardware and driver
configuration. When  <code class="docutils literal notranslate"><span class="pre">vsync</span></code> is requested, but unavailable,
<code class="docutils literal notranslate"><span class="pre">set_mode()</span></code> may raise an exception.</p>
<p>Setting the <code class="docutils literal notranslate"><span class="pre">vsync</span></code> parameter to <code class="docutils literal notranslate"><span class="pre">-1</span></code> in conjunction with  <code class="docutils literal notranslate"><span class="pre">OPENGL</span></code>
will request the OpenGL-specific feature &quot;adaptive vsync&quot; &lt;<a class="reference external" href="https://www.khronos.org/opengl/wiki/Swap_Interval#Adaptive_Vsync">https://www.khronos.org/opengl/wiki/Swap_Interval#Adaptive_Vsync</a>&gt;.</p>
<p>Here is an example usage of a call
...
<span class="k">try</span><span class="p">:</span>
    ...
    <span class="n">vsync_success</span><span class="o">=</span><span class="kc">True</span>
<span class="k">except</span> <span class="n">pygame</span><span class="o">.</span><span class="n">error</span><span class="p">:</span>
    <span class="n">window_surface</span> <span class="o">=</span> <span class="n">pygame</span><span class="o">.</span><span class="n">display</span><span class="o">.</span><span class="n">set_mode</span><span class="p">((</span><span class="mi">1920</span><span class="p">,</span> <span class="mi">1080</span><span class="p">),</span> <span class="n">flags</span><span class="p">)</span>
    <span class="n">vsync_success</span><span class="o">=</span><span class="kc">False</span>
</pre></div>
</div>
<div class="versionaddedold">
<p><span class="versionmodified added">New in pygame 2.0.0: </span><code class="docutils literal notranslate"><span class="pre">vsync</span></code> parameter</p>
...
<div class="versionchanged">
<p><span class="versionmodified changed">Changed in pygame-ce 2.2.0: </span>passing <code class="docutils literal notranslate"><span class="pre">vsync</span></code> can raise an exception</p>
</div>
<div class="versionchanged">
<p><span class="versionmodified changed">Changed in pygame-ce 2.2.0: </span>explicit request for &quot;adaptive vsync&quot;</p>
</div>
<div class="versionchanged">
<p><span class="versionmodified changed">Changed in pygame-ce 2.2.0: </span><code class="docutils literal notranslate"><span class="pre">vsync=1</span></code> does not require <code class="docutils literal notranslate"><span class="pre">SCALED</span></code> or <code class="docutils literal notranslate"><span class="pre">OPENGL</span></code></p>
</div>
<div class="deprecated">
<p><span class="versionmodified deprecated">Deprecated since pygame-ce 2.4.0: </span>The depth argument is ignored, and will be set to the optimal value</p>
</div>
<div class="versionchanged">
<p><span class="versionmodified changed">Changed in pygame-ce 2.5.0: </span>No longer emits warning when running on xwayland, see <a class="tooltip reference internal" href="#pygame.display.init" title=""><code class="xref py py-func docutils literal notranslate"><span class="pre">pygame.display.init()</span></code><span class="tooltip-content">Initialize the display module.</span></a> for details on running on wayland directly</p>
</div>
<p>Basic example:</p>
...
<div class="versionchanged">
<p><span class="versionmodified changed">Changed in pygame-ce 2.1.3: </span>pygame now ensures that subsequent calls to this function clears the
...
<div class="line"><span class="signature">get_surface() -&gt; Surface | None</span></div>
</div>
...
<p>This will update the contents of the entire display.</p>
...
<dd><div class="line-block">
<div class="line"><span class="summaryline">Update all, or a portion, of the display. For non-OpenGL displays.</span></div>
<div class="line"><span class="signature">update() -&gt; None</span></div>
<div class="line"><span class="signature">update(rectangle, /) -&gt; None</span></div>
<div class="line"><span class="signature">update(rectangles, /) -&gt; None</span></div>
<div class="line"><span class="signature">update(x, y, w, h, /) -&gt; None</span></div>
<div class="line"><span class="signature">update(xy, wh, /) -&gt; None</span></div>
</div>
<p>For non OpenGL display Surfaces, this function is very similar to
<code class="docutils literal notranslate"><span class="pre">pygame.display.flip()</span></code> with an optional parameter that allows only
...
<code class="docutils literal notranslate"><span class="pre">pygame.display.flip()</span></code>.</p>
<div class="admonition note">
<p class="admonition-title">Note</p>
<p>calling <code class="docutils literal notranslate"><span class="pre">display.update(None)</span></code> means no part of the window is
updated. Whereas <code class="docutils literal notranslate"><span class="pre">display.update()</span></code> means the whole window is
updated.</p>
</div>
<p>You can pass the function a single rectangle, or an iterable of rectangles.
...
to update.</p>
<p>If passing an iterable of rectangles it is safe to include None
values in the list, which will be skipped.</p>
...
exception.</p>
<div class="versionchanged">
<p><span class="versionmodified changed">Changed in pygame-ce 2.5.1: </span>Added support for passing an iterable, previously only sequence was allowed</p>
</div>
</dd></dl>
...
<div class="line"><span class="signature">get_driver() -&gt; str</span></div>
</div>
...
<code class="docutils literal notranslate"><span class="pre">pygame.display.init()</span></code> to see some of the common options.</p>
</dd></dl>
...
<div class="line"><span class="signature">Info() -&gt; _VidInfo</span></div>
</div>
...
<div class="highlight-text notranslate"><div class="highlight"><pre><span></span>hw:         1 if the display is hardware accelerated
...
<div class="versionchanged">
<p><span class="versionmodified changed">Changed in pygame-ce 2.4.0: </span><code class="docutils literal notranslate"><span class="pre">pixel_format</span></code> attribute added.</p>
</div>
</dd></dl>
...
<div class="line"><span class="signature">get_wm_info() -&gt; dict[str, int]</span></div>
</div>
...
<div class="line"><span class="signature">get_desktop_sizes() -&gt; list[tuple[int, int]]</span></div>
</div>
...
<div class="line"><span class="signature">list_modes(depth=0, flags=FULLSCREEN, display=0) -&gt; list[tuple[int, int]]</span></div>
</div>
...
<div class="line"><span class="signature">mode_ok(size, flags=0, depth=0, display=0) -&gt; int</span></div>
</div>
...
<div class="line"><span class="signature">gl_get_attribute(flag, /) -&gt; int</span></div>
</div>
...
Set <code class="docutils literal notranslate"><span class="pre">GL_MULTISAMPLESAMPLES</span></code> to a value
...
See <a class="reference external" href="https://github.com/pygame-community/pygame-ce/issues/1221">issue #1221</a>.</p>
</div>
</dd></dl>
...
<div class="line"><span class="signature">set_gamma(red, green=..., blue=..., /) -&gt; bool</span></div>
</div>
...
<div class="deprecated">
<p><span class="versionmodified deprecated">Deprecated since pygame-ce 2.1.4.</span></p>
</div>
</dd></dl>
...
<div class="line"><span class="signature">get_caption() -&gt; tuple[str, str]</span></div>
</div>
<p>Returns the title and icontitle of the display window. In pygame 2.x
...
<div class="line"><span class="signature">get_window_size() -&gt; tuple[int, int]</span></div>
</div>
...
<dl class="py function definition">
<dt class="sig sig-object py title" id="pygame.display.get_window_position">
<span class="sig-prename descclassname"><span class="pre">pygame.display.</span></span><span class="sig-name descname"><span class="pre">get_window_position</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#pygame.display.get_window_position" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">Return the position of the window or screen.</span></div>
<div class="line"><span class="signature">get_window_position() -&gt; tuple[int, int]</span></div>
</div>
<p>Returns the position of the window initialized with <a class="tooltip reference internal" href="#pygame.display.set_mode" title=""><code class="xref py py-func docutils literal notranslate"><span class="pre">pygame.display.set_mode()</span></code><span class="tooltip-content">Initialize a window or screen for display.</span></a>.
The position will change when the user moves the window or when the
position is set manually with <a class="tooltip reference internal" href="#pygame.display.set_window_position" title=""><code class="xref py py-func docutils literal notranslate"><span class="pre">pygame.display.set_window_position()</span></code><span class="tooltip-content">Set the current window position.</span></a>.
...
<dl class="py function definition">
<dt class="sig sig-object py title" id="pygame.display.set_window_position">
<span class="sig-prename descclassname"><span class="pre">pygame.display.</span></span><span class="sig-name descname"><span class="pre">set_window_position</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#pygame.display.set_window_position" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">Set the current window position.</span></div>
<div class="line"><span class="signature">set_window_position(position) -&gt; None</span></div>
</div>
<p>Sets the position of the window initialized with <a class="tooltip reference internal" href="#pygame.display.set_mode" title=""><code class="xref py py-func docutils literal notranslate"><span class="pre">pygame.display.set_mode()</span></code><span class="tooltip-content">Initialize a window or screen for display.</span></a>.
...
<a class="tooltip reference internal" href="#pygame.display.get_window_position" title=""><code class="xref py py-func docutils literal notranslate"><span class="pre">pygame.display.get_window_position()</span></code><span class="tooltip-content">Return the position of the window or screen.</span></a>.</p>
<div class="admonition note">
<p class="admonition-title">Note</p>
<p>This function is not supported on some video drivers (like wayland)
...
<p>Return whether screensaver is allowed to run whilst the app is running. Default
is <code class="docutils literal notranslate"><span class="pre">False</span></code>. By default pygame does not allow the screensaver during game
play.</p>
<div class="admonition note">
<p class="admonition-title">Note</p>
...
<div class="line"><span class="signature">set_allow_screensaver(value=True) -&gt; None</span></div>
</div>
...
it supports changing the screensaver state.</p>
</div>
<div class="versionaddedold">
<p><span class="versionmodified added">New in pygame 2.0.0.</span></p>
</div>
...
<dl class="py function definition">
<dt class="sig sig-object py title" id="pygame.display.is_fullscreen">
<span class="sig-prename descclassname"><span class="pre">pygame.display.</span></span><span class="sig-name descname"><span class="pre">is_fullscreen</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#pygame.display.is_fullscreen" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">Returns True if the pygame window created by pygame.display.set_mode() is in full-screen mode.</span></div>
<div class="line"><span class="signature">is_fullscreen() -&gt; bool</span></div>
</div>
<p>Edge cases:
If the window is in windowed mode, but maximized, this will return <cite>False</cite>.
If the window is in &quot;borderless fullscreen&quot; mode, this will return <cite>True</cite>.</p>
<div class="versionadded">
<p><span class="versionmodified added">New in pygame-ce 2.2.0.</span></p>
</div>
</dd></dl>

<dl class="py function definition">
<dt class="sig sig-object py title" id="pygame.display.is_vsync">
<span class="sig-prename descclassname"><span class="pre">pygame.display.</span></span><span class="sig-name descname"><span class="pre">is_vsync</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#pygame.display.is_vsync" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">Returns True if vertical synchronisation for pygame.display.flip() and pygame.display.update() is enabled.</span></div>
<div class="line"><span class="signature">is_vsync() -&gt; bool</span></div>
</div>
<div class="versionadded">
<p><span class="versionmodified added">New in pygame-ce 2.2.0.</span></p>
</div>
...
<dl class="py function definition">
<dt class="sig sig-object py title" id="pygame.display.get_current_refresh_rate">
<span class="sig-prename descclassname"><span class="pre">pygame.display.</span></span><span class="sig-name descname"><span class="pre">get_current_refresh_rate</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#pygame.display.get_current_refresh_rate" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">Returns the screen refresh rate or 0 if unknown.</span></div>
<div class="line"><span class="signature">get_current_refresh_rate() -&gt; int</span></div>
</div>
<p>The screen refresh rate for the current window. In windowed mode, this
should be equal to the refresh rate of the desktop the window is on.</p>
<p>If no window is open, an exception is raised.</p>
<p>When a constant refresh rate cannot be determined, 0 is returned.</p>
<div class="versionadded">
<p><span class="versionmodified added">New in pygame-ce 2.2.0.</span></p>
</div>
</dd></dl>
...
<dl class="py function definition">
<dt class="sig sig-object py title" id="pygame.display.get_desktop_refresh_rates">
<span class="sig-prename descclassname"><span class="pre">pygame.display.</span></span><span class="sig-name descname"><span class="pre">get_desktop_refresh_rates</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#pygame.display.get_desktop_refresh_rates" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">Returns the screen refresh rates for all displays (in windowed mode).</span></div>
<div class="line"><span class="signature">get_desktop_refresh_rates() -&gt; list[int]</span></div>
</div>
<p>If the current window is in full-screen mode, the actual refresh rate for
that window can differ.</p>
<p>This is safe to call when no window is open (i.e. before any calls to
<a class="tooltip reference internal" href="#pygame.display.set_mode" title=""><code class="xref py py-func docutils literal notranslate"><span class="pre">pygame.display.set_mode()</span></code><span class="tooltip-content">Initialize a window or screen for display.</span></a></p>
<p>When a constant refresh rate cannot be determined, 0 is returned for that
desktop.</p>
<div class="versionadded">
<p><span class="versionmodified added">New in pygame-ce 2.2.0.</span></p>
</div>
...
<dl class="py function definition">
<dt class="sig sig-object py title" id="pygame.display.message_box">
<span class="sig-prename descclassname"><span class="pre">pygame.display.</span></span><span class="sig-name descname"><span class="pre">message_box</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#pygame.display.message_box" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">Create a native GUI message box.</span></div>
<div class="line"><span class="signature">message_box(title, message=None, message_type='info', parent_window=None, buttons=('OK', ), return_button=0, escape_button=None) -&gt; int</span></div>
</div>
<dl class="field-list simple">
<dt class="field-odd">Parameters<span class="colon">:</span></dt>
<dd class="field-odd"><ul class="simple">
<li><p><strong>title</strong> (<em>str</em>) -- A title string.</p></li>
<li><p><strong>message</strong> (<em>str</em>) -- A message string. If this parameter is set to <code class="docutils literal notranslate"><span class="pre">None</span></code>, the message will be the title.</p></li>
<li><p><strong>message_type</strong> (<em>str</em>) -- Set the type of message_box, could be <code class="docutils literal notranslate"><span class="pre">&quot;info&quot;</span></code>, <code class="docutils literal notranslate"><span class="pre">&quot;warn&quot;</span></code> or <code class="docutils literal notranslate"><span class="pre">&quot;error&quot;</span></code>.</p></li>
<li><p><strong>parent_window</strong> (<a class="tooltip reference internal" href="window.html#pygame.Window" title=""><em>pygame.Window</em><span class="tooltip-content">Pygame object that represents a window.</span></a>) -- The parent window of the message box.</p></li>
<li><p><strong>buttons</strong> (<em>tuple</em>) -- An optional sequence of button name strings to show to the user.</p></li>
<li><p><strong>return_button</strong> (<em>int</em>) -- Button index to use if the return key is hit, <code class="docutils literal notranslate"><span class="pre">0</span></code> by default.</p></li>
<li><p><strong>escape_button</strong> (<em>int</em>) -- Button index to use if the escape key is hit, <code class="docutils literal notranslate"><span class="pre">None</span></code> for no button linked by default.</p></li>
</ul>
</dd>
<dt class="field-even">Returns<span class="colon">:</span></dt>
<dd class="field-even"><p>The index of the button that was pushed.</p>
</dd>
</dl>
<p>This function should be called on the thread that <code class="docutils literal notranslate"><span class="pre">set_mode()</span></code> is called.
It will block execution of that thread until the user clicks a button or
closes the message_box.</p>
<p>This function may be called at any time, even before <code class="docutils literal notranslate"><span class="pre">pygame.init()</span></code>.</p>
<p>Negative values of <code class="docutils literal notranslate"><span class="pre">return_button</span></code> and <code class="docutils literal notranslate"><span class="pre">escape_button</span></code> are allowed
just like standard Python list indexing.</p>
<div class="versionadded">
