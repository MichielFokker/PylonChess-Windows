...
<html lang="en" data-content_root="../../">
  <head>
    ...
    <title>A Newbie Guide to pygame &#8212; pygame-ce v2.5.8 documentation</title>
    ...
    <link rel="next" title="Pygame Tutorials - What is Premultiplied Alpha?" href="premultiplied-alpha.html" />
    <link rel="prev" title="Pygame Tutorials - Help! How Do I Move An Image?" href="move-it.html" /> 
  </head><body>  
...
<p><a class="reference external" href="https://pyga.me/">Pygame</a> is a python wrapper for <a class="reference external" href="http://libsdl.org">SDL</a>, written by Pete Shinners.  What this
...
<p>That being said there are still a few rare times when this old technique is still useful
for squeezing out a few extra FPS. For example, if you only need to update half of the display
surface and have a stationary image in the other half. Here is the rough process for how it works:</p>
...
<p>Even though this technique is not really useful for making performant 2D games with
...
scratch.</p>
<p><strong>Premultiplied Alpha</strong></p>
<p>Using this alpha blending mode can boost your blitting performance slightly, it even
has its own <cite>tutorial page &lt;tutorials/en/premultiplied-alpha&gt;.</cite></p>
</section>
...
<p>There's a lot of confusion around these two terms, and much of it comes
from the terminology used.</p>
<p>Per pixel alpha is the best type of alpha to use, it will give you nice
...
images with an alpha channel and pygame can load them.</p>
...
and so don't obscure the background.  Simply call <a class="reference internal" href="../../ref/surface.html#pygame.Surface.set_colorkey" title="pygame.Surface.set_colorkey"><code class="xref py py-meth docutils literal notranslate"><span class="pre">Surface.set_colorkey()</span></code></a>,
...
actually slower.</p>
<p>Surface 'Alpha' is also available it applies to the whole surface. Surface alpha
causes each pixel in the source image to be only <em>partially</em> opaque.
...
<div class="literal-block-wrapper docutils container" id="game-loop-py">
<div class="code-block-caption"><span class="caption-text">Standard Pygame game loop</span><a class="headerlink" href="#game-loop-py" title="Link to this code">¶</a></div>
...
<span class="linenos"> 5</span> <span class="n">screen</span> <span class="o">=</span> <span class="n">pygame</span><span class="o">.</span><span class="n">display</span><span class="o">.</span><span class="n">set_mode</span><span class="p">((</span><span class="mi">1280</span><span class="p">,</span><span class="mi">720</span><span class="p">))</span>
<span class="linenos"> 6</span>
<span class="linenos"> 7</span> <span class="n">clock</span> <span class="o">=</span> <span class="n">pygame</span><span class="o">.</span><span class="n">time</span><span class="o">.</span><span class="n">Clock</span><span class="p">()</span>
<span class="linenos"> 8</span>
<span class="linenos"> 9</span> <span class="n">running</span> <span class="o">=</span> <span class="kc">True</span>
<span class="linenos">10</span>
<span class="linenos">11</span> <span class="k">while</span> <span class="n">running</span><span class="p">:</span>
<span class="linenos">12</span>     <span class="c1"># Process player inputs.</span>
<span class="linenos">13</span>     <span class="k">for</span> <span class="n">event</span> <span class="ow">in</span> <span class="n">pygame</span><span class="o">.</span><span class="n">event</span><span class="o">.</span><span class="n">get</span><span class="p">():</span>
<span class="linenos">14</span>         <span class="k">if</span> <span class="n">event</span><span class="o">.</span><span class="n">type</span> <span class="o">==</span> <span class="n">pygame</span><span class="o">.</span><span class="n">QUIT</span><span class="p">:</span>
<span class="linenos">15</span>             <span class="n">running</span> <span class="o">=</span> <span class="kc">False</span>
<span class="linenos">16</span>
<span class="linenos">17</span>     <span class="c1"># Do logical updates here.</span>
<span class="linenos">18</span>     <span class="c1"># ...</span>
<span class="linenos">19</span>
<span class="linenos">20</span>     <span class="n">screen</span><span class="o">.</span><span class="n">fill</span><span class="p">(</span><span class="s2">&quot;purple&quot;</span><span class="p">)</span>  <span class="c1"># Fill the display with a solid color</span>
<span class="linenos">21</span>
<span class="linenos">22</span>     <span class="c1"># Render the graphics here.</span>
<span class="linenos">23</span>     <span class="c1"># ...</span>
<span class="linenos">24</span>
<span class="linenos">25</span>     <span class="n">pygame</span><span class="o">.</span><span class="n">display</span><span class="o">.</span><span class="n">flip</span><span class="p">()</span>  <span class="c1"># Refresh on-screen display</span>
<span class="linenos">26</span>     <span class="n">clock</span><span class="o">.</span><span class="n">tick</span><span class="p">(</span><span class="mi">60</span><span class="p">)</span>         <span class="c1"># wait until next frame (at 60 FPS)</span>
<span class="linenos">27</span>
<span class="linenos">28</span> <span class="n">pygame</span><span class="o">.</span><span class="n">quit</span><span class="p">()</span>
</pre></div>
</div>
</div>
...
<p><em>This guide was substantially updated in 2022 and updated again in 2023.</em></p>
</section>
</section>
</section>
...
<br /><br />
<hr />
<a href="https://github.com/pygame-community/pygame-ce/edit/main/docs/reST/tutorials\en\newbie-guide.rst" rel="nofollow">Edit on GitHub</a>
      ...
      <ul>
        ...
        <li class="right" >
          <a href="../../py-modindex.html" title="Python Module Index"
             >modules</a> |</li>
        <li class="right" >
          <a href="premultiplied-alpha.html" title="Pygame Tutorials - What is Premultiplied Alpha?"
             accesskey="N">next</a> |</li>
        <li class="right" >
          <a href="move-it.html" title="Pygame Tutorials - Help! How Do I Move An Image?"
