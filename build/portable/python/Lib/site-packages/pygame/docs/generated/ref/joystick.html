...
<html lang="en" data-content_root="../">
  <head>
    ...
    <title>pygame.joystick &#8212; pygame-ce v2.5.8 documentation</title>
...
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="joystick.html#pygame.joystick.Joystick.set_led">pygame.joystick.Joystick.set_led</a></div>
</td>
<td>—</td>
<td>Set the LED color of the joystick</td>
</tr>
</tbody>
</table>
...
<p><span class="versionmodified changed">Changed in pygame-ce 2.1.4: </span>This class is also available through the <code class="docutils literal notranslate"><span class="pre">pygame.Joystick</span></code>
alias.</p>
</div>
...
<a class="reference internal" href="#pygame.joystick.Joystick.get_instance_id" title="pygame.joystick.Joystick.get_instance_id"><code class="xref py py-meth docutils literal notranslate"><span class="pre">get_instance_id()</span></code></a> instead.</p>
</div>
</dd></dl>
...
joystick does not support it.</p>
<div class="versionaddedold">
...
<dl class="py method definition">
<dt class="sig sig-object py title" id="pygame.joystick.Joystick.set_led">
<span class="sig-name descname"><span class="pre">set_led</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#pygame.joystick.Joystick.set_led" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">Set the LED color of the joystick</span></div>
<div class="line"><span class="signature">set_led(color_arg) -&gt; bool</span></div>
</div>
<p>Set the color of the LED on the joystick. The argument is a
<code class="docutils literal notranslate"><span class="pre">pygame.Color</span></code>-compatible value (alpha being ignored). The
...
<span class="k">def</span><span class="w"> </span><span class="nf">indent</span><span class="p">(</span><span class="n">text</span><span class="p">,</span> <span class="n">indentation_level</span><span class="o">=</span><span class="mi">0</span><span class="p">):</span>
    <span class="k">return</span> <span class="p">(</span><span class="s2">&quot;    &quot;</span> <span class="o">*</span> <span class="n">indentation_level</span><span class="p">)</span> <span class="o">+</span> <span class="n">text</span>


<span class="k">def</span><span class="w"> </span><span class="nf">main</span><span class="p">():</span>
    <span class="c1"># Set the size of the screen (width, height), and name the window.</span>
    <span class="n">size</span> <span class="o">=</span> <span class="p">(</span><span class="mi">500</span><span class="p">,</span> <span class="mi">700</span><span class="p">)</span>
    ...
    <span class="n">clock</span> <span class="o">=</span> <span class="n">pygame</span><span class="o">.</span><span class="n">Clock</span><span class="p">()</span>
    ...
    <span class="n">wraplength</span> <span class="o">=</span> <span class="n">size</span><span class="p">[</span><span class="mi">0</span><span class="p">]</span> <span class="o">-</span> <span class="mi">20</span>

    <span class="c1"># This dict can be left as-is, since pygame-ce will generate a</span>
    ...
    <span class="k">while</span> <span class="ow">not</span> <span class="n">done</span><span class="p">:</span>
        ...
        <span class="k">for</span> <span class="n">event</span> <span class="ow">in</span> <span class="n">pygame</span><span class="o">.</span><span class="n">event</span><span class="o">.</span><span class="n">get</span><span class="p">():</span>
            ...
            <span class="k">if</span> <span class="n">event</span><span class="o">.</span><span class="n">type</span> <span class="o">==</span> <span class="n">pygame</span><span class="o">.</span><span class="n">JOYDEVICEADDED</span><span class="p">:</span>
                ...
                <span class="nb">print</span><span class="p">(</span><span class="sa">f</span><span class="s2">&quot;Joystick </span><span class="si">{</span><span class="n">joy</span><span class="o">.</span><span class="n">get_instance_id</span><span class="p">()</span><span class="si">}</span><span class="s2"> connected&quot;</span><span class="p">)</span>
            ...
            <span class="k">if</span> <span class="n">event</span><span class="o">.</span><span class="n">type</span> <span class="o">==</span> <span class="n">pygame</span><span class="o">.</span><span class="n">JOYDEVICEREMOVED</span><span class="p">:</span>
                <span class="k">if</span> <span class="n">event</span><span class="o">.</span><span class="n">instance_id</span> <span class="ow">in</span> <span class="n">joysticks</span><span class="p">:</span>
                ...
                <span class="k">else</span><span class="p">:</span>
                    <span class="nb">print</span><span class="p">(</span>
                        <span class="sa">f</span><span class="s2">&quot;Tried to disconnect Joystick </span><span class="si">{</span><span class="n">event</span><span class="o">.</span><span class="n">instance_id</span><span class="si">}</span><span class="s2">, &quot;</span>
                        <span class="s2">&quot;but couldn&#39;t find it in the joystick list&quot;</span>
                    <span class="p">)</span>
        ...
        <span class="n">lines</span><span class="o">.</span><span class="n">append</span><span class="p">(</span><span class="n">indent</span><span class="p">(</span><span class="sa">f</span><span class="s2">&quot;Number of joysticks: </span><span class="si">{</span><span class="n">joystick_count</span><span class="si">}</span><span class="s2">&quot;</span><span class="p">,</span> <span class="n">indentation</span><span class="p">))</span>
        ...
        <span class="k">for</span> <span class="n">joystick</span> <span class="ow">in</span> <span class="n">joysticks</span><span class="o">.</span><span class="n">values</span><span class="p">():</span>
            ...
            <span class="n">lines</span><span class="o">.</span><span class="n">append</span><span class="p">(</span><span class="n">indent</span><span class="p">(</span><span class="sa">f</span><span class="s2">&quot;Joystick </span><span class="si">{</span><span class="n">jid</span><span class="si">}</span><span class="s2">&quot;</span><span class="p">,</span> <span class="n">indentation</span><span class="p">))</span>
            <span class="n">indentation</span> <span class="o">+=</span> <span class="mi">1</span>
            ...
            <span class="n">lines</span><span class="o">.</span><span class="n">append</span><span class="p">(</span><span class="n">indent</span><span class="p">(</span><span class="sa">f</span><span class="s2">&quot;Joystick name: </span><span class="si">{</span><span class="n">name</span><span class="si">}</span><span class="s2">&quot;</span><span class="p">,</span> <span class="n">indentation</span><span class="p">))</span>
            ...
            <span class="n">lines</span><span class="o">.</span><span class="n">append</span><span class="p">(</span><span class="n">indent</span><span class="p">(</span><span class="sa">f</span><span class="s2">&quot;GUID: </span><span class="si">{</span><span class="n">guid</span><span class="si">}</span><span class="s2">&quot;</span><span class="p">,</span> <span class="n">indentation</span><span class="p">))</span>
            ...
            <span class="n">lines</span><span class="o">.</span><span class="n">append</span><span class="p">(</span><span class="n">indent</span><span class="p">(</span><span class="sa">f</span><span class="s2">&quot;Joystick&#39;s power level: </span><span class="si">{</span><span class="n">power_level</span><span class="si">}</span><span class="s2">&quot;</span><span class="p">,</span> <span class="n">indentation</span><span class="p">))</span>
            ...
            <span class="n">lines</span><span class="o">.</span><span class="n">append</span><span class="p">(</span><span class="n">indent</span><span class="p">(</span><span class="sa">f</span><span class="s2">&quot;Number of axes: </span><span class="si">{</span><span class="n">axes</span><span class="si">}</span><span class="s2">&quot;</span><span class="p">,</span> <span class="n">indentation</span><span class="p">))</span>
            <span class="n">indentation</span> <span class="o">+=</span> <span class="mi">1</span>
            ...
            <span class="k">for</span> <span class="n">i</span> <span class="ow">in</span> <span class="nb">range</span><span class="p">(</span><span class="n">axes</span><span class="p">):</span>
                ...
                <span class="n">lines</span><span class="o">.</span><span class="n">append</span><span class="p">(</span><span class="n">indent</span><span class="p">(</span><span class="sa">f</span><span class="s2">&quot;Axis </span><span class="si">{</span><span class="n">i</span><span class="si">}</span><span class="s2"> value: </span><span class="si">{</span><span class="n">axis</span><span class="si">:</span><span class="s2">&gt;6.3f</span><span class="si">}</span><span class="s2">&quot;</span><span class="p">,</span> <span class="n">indentation</span><span class="p">))</span>
            <span class="n">indentation</span> <span class="o">-=</span> <span class="mi">1</span>
            ...
            <span class="n">lines</span><span class="o">.</span><span class="n">append</span><span class="p">(</span><span class="n">indent</span><span class="p">(</span><span class="sa">f</span><span class="s2">&quot;Number of buttons: </span><span class="si">{</span><span class="n">buttons</span><span class="si">}</span><span class="s2">&quot;</span><span class="p">,</span> <span class="n">indentation</span><span class="p">))</span>
            <span class="n">indentation</span> <span class="o">+=</span> <span class="mi">1</span>
            ...
            <span class="k">for</span> <span class="n">i</span> <span class="ow">in</span> <span class="nb">range</span><span class="p">(</span><span class="n">buttons</span><span class="p">):</span>
                ...
                <span class="n">lines</span><span class="o">.</span><span class="n">append</span><span class="p">(</span><span class="n">indent</span><span class="p">(</span><span class="sa">f</span><span class="s2">&quot;Button </span><span class="si">{</span><span class="n">i</span><span class="si">:</span><span class="s2">&gt;2</span><span class="si">}</span><span class="s2"> value: </span><span class="si">{</span><span class="n">button</span><span class="si">}</span><span class="s2">&quot;</span><span class="p">,</span> <span class="n">indentation</span><span class="p">))</span>
            <span class="n">indentation</span> <span class="o">-=</span> <span class="mi">1</span>
            ...
            <span class="n">lines</span><span class="o">.</span><span class="n">append</span><span class="p">(</span><span class="n">indent</span><span class="p">(</span><span class="sa">f</span><span class="s2">&quot;Number of hats: </span><span class="si">{</span><span class="n">hats</span><span class="si">}</span><span class="s2">&quot;</span><span class="p">,</span> <span class="n">indentation</span><span class="p">))</span>
            <span class="n">indentation</span> <span class="o">+=</span> <span class="mi">1</span>
            ...
            <span class="k">for</span> <span class="n">i</span> <span class="ow">in</span> <span class="nb">range</span><span class="p">(</span><span class="n">hats</span><span class="p">):</span>
                ...
                <span class="n">lines</span><span class="o">.</span><span class="n">append</span><span class="p">(</span><span class="n">indent</span><span class="p">(</span><span class="sa">f</span><span class="s2">&quot;Hat </span><span class="si">{</span><span class="n">i</span><span class="si">}</span><span class="s2"> value: </span><span class="si">{</span><span class="nb">str</span><span class="p">(</span><span class="n">hat</span><span class="p">)</span><span class="si">}</span><span class="s2">&quot;</span><span class="p">,</span> <span class="n">indentation</span><span class="p">))</span>
            <span class="n">indentation</span> <span class="o">-=</span> <span class="mi">2</span>

        <span class="c1"># draw the accumulated text</span>
        <span class="n">screen</span><span class="o">.</span><span class="n">blit</span><span class="p">(</span>
            <span class="n">font</span><span class="o">.</span><span class="n">render</span><span class="p">(</span><span class="s2">&quot;</span><span class="se">\n</span><span class="s2">&quot;</span><span class="o">.</span><span class="n">join</span><span class="p">(</span><span class="n">lines</span><span class="p">),</span> <span class="kc">True</span><span class="p">,</span> <span class="s2">&quot;black&quot;</span><span class="p">,</span> <span class="s2">&quot;white&quot;</span><span class="p">,</span> <span class="n">wraplength</span><span class="p">),</span> <span class="p">(</span><span class="mi">10</span><span class="p">,</span> <span class="mi">10</span><span class="p">)</span>
        <span class="p">)</span>
...
After SDL 2.24.0, The controller is recognized as &quot;Nintendo Switch Joy-Con (L)&quot;.</p>
<ul>
<li><p><strong>Buttons</strong>:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span>                <span class="n">After</span> <span class="n">SDL</span> <span class="mf">2.24.0</span>         <span class="n">Before</span> <span class="n">SDL</span> <span class="mf">2.24.0</span>
<span class="n">D</span><span class="o">-</span><span class="n">pad</span> <span class="n">Up</span>            <span class="n">Button</span> <span class="mi">2</span>                  <span class="n">Button</span> <span class="mi">3</span>
<span class="n">D</span><span class="o">-</span><span class="n">pad</span> <span class="n">Down</span>          <span class="n">Button</span> <span class="mi">1</span>                  <span class="n">Button</span> <span class="mi">0</span>
<span class="n">D</span><span class="o">-</span><span class="n">pad</span> <span class="n">Left</span>          <span class="n">Button</span> <span class="mi">3</span>                  <span class="n">Button</span> <span class="mi">2</span>
<span class="n">D</span><span class="o">-</span><span class="n">pad</span> <span class="n">Right</span>         <span class="n">Button</span> <span class="mi">0</span>                  <span class="n">Button</span> <span class="mi">1</span>
<span class="n">SL</span>                  <span class="n">Button</span> <span class="mi">9</span>                  <span class="n">Button</span> <span class="mi">4</span>
<span class="n">SR</span>                  <span class="n">Button</span> <span class="mi">10</span>                 <span class="n">Button</span> <span class="mi">5</span>
<span class="o">-</span>                   <span class="n">Button</span> <span class="mi">6</span>                  <span class="n">Button</span> <span class="mi">8</span>
<span class="n">Stick</span> <span class="n">In</span>            <span class="n">Button</span> <span class="mi">7</span>                  <span class="n">Button</span> <span class="mi">10</span>
<span class="n">Capture</span>             <span class="n">Button</span> <span class="mi">5</span>                  <span class="n">Button</span> <span class="mi">13</span>
<span class="n">L</span>                   <span class="n">Button</span> <span class="mi">17</span>                 <span class="n">Button</span> <span class="mi">14</span>
<span class="n">ZL</span>                  <span class="n">Button</span> <span class="mi">19</span>                 <span class="n">Button</span> <span class="mi">15</span>
</pre></div>
</div>
</li>
</ul>
<p>Reference : D-pad Up points toward SL and SR buttons.</p>
<ul>
<li><p><strong>Hat/JoyStick</strong>:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">Down</span> <span class="o">-&gt;</span> <span class="n">Up</span>      <span class="o">-</span>    <span class="n">Axis</span> <span class="mi">1</span>                    <span class="n">Axis</span> <span class="n">Y</span>
<span class="n">Left</span> <span class="o">-&gt;</span> <span class="n">Right</span>   <span class="o">-</span>    <span class="n">Axis</span> <span class="mi">0</span>                    <span class="n">Axis</span> <span class="n">X</span>
</pre></div>
</div>
</li>
</ul>
...
The controller is recognized as &quot;Wireless Gamepad&quot;.
After SDL 2.24.0, The controller is recognized as &quot;Nintendo Switch Joy-Con (R)&quot;.</p>
<ul>
<li><p><strong>Buttons</strong>:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span>              <span class="n">After</span> <span class="n">SDL</span> <span class="mf">2.24.0</span>         <span class="n">Before</span> <span class="n">SDL</span> <span class="mf">2.24.0</span>
<span class="n">A</span> <span class="n">Button</span>          <span class="n">Button</span> <span class="mi">1</span>                 <span class="n">Button</span> <span class="mi">0</span>
<span class="n">B</span> <span class="n">Button</span>          <span class="n">Button</span> <span class="mi">3</span>                 <span class="n">Button</span> <span class="mi">2</span>
<span class="n">X</span> <span class="n">Button</span>          <span class="n">Button</span> <span class="mi">0</span>                 <span class="n">Button</span> <span class="mi">1</span>
<span class="n">Y</span> <span class="n">Button</span>          <span class="n">Button</span> <span class="mi">2</span>                 <span class="n">Button</span> <span class="mi">3</span>
<span class="n">SL</span>                <span class="n">Button</span> <span class="mi">9</span>                 <span class="n">Button</span> <span class="mi">4</span>
<span class="n">SR</span>                <span class="n">Button</span> <span class="mi">10</span>                <span class="n">Button</span> <span class="mi">5</span>
<span class="o">+</span>                 <span class="n">Button</span> <span class="mi">6</span>                 <span class="n">Button</span> <span class="mi">9</span>
<span class="n">Stick</span> <span class="n">In</span>          <span class="n">Button</span> <span class="mi">7</span>                 <span class="n">Button</span> <span class="mi">11</span>
<span class="n">Home</span>              <span class="n">Button</span> <span class="mi">5</span>                 <span class="n">Button</span> <span class="mi">12</span>
<span class="n">R</span>                 <span class="n">Button</span> <span class="mi">16</span>                <span class="n">Button</span> <span class="mi">14</span>
<span class="n">ZR</span>                <span class="n">Button</span> <span class="mi">18</span>                <span class="n">Button</span> <span class="mi">15</span>
</pre></div>
</div>
</li>
<li><p><strong>Hat/JoyStick</strong>:</p>
...
<section id="nintendo-switch-left-right-joy-con-after-sdl-2-24-0">
<h2>Nintendo Switch Left/Right Joy-Con (after SDL <strong>2.24.0</strong>)<a class="headerlink" href="#nintendo-switch-left-right-joy-con-after-sdl-2-24-0" title="Link to this heading">¶</a></h2>
<p>This device is created, if Nintendo Switch Joy-con Left and Nintendo Switch Joy-con Right are connected (these two devices are removed).
The Nintendo Switch Left/Right Joy-Con has 6 axes, 20 buttons, and 0 hats. The values for the 6 axes never change.
The controller is recognized as &quot;Nintendo Switch Joy-Con (L/R)&quot;.</p>
<ul>
...
<li><p><strong>Buttons</strong>:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span>A Button        - Button 0
B Button        - Button 1
X Button        - Button 2
Y Button        - Button 3
- Button        - Button 4
